...
$MethodInfo _ParserAdapter_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(ParserAdapter::*)()>(&ParserAdapter::init$)), "org.xml.sax.SAXException"},
	{"<init>", "(Lorg/xml/sax/Parser;)V", nullptr, $PUBLIC, $method(static_cast<void(ParserAdapter::*)($Parser*)>(&ParserAdapter::init$))},
	{"characters", "([CII)V", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException"},
	{"checkNotParsing", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(ParserAdapter::*)($String*,$String*)>(&ParserAdapter::checkNotParsing)), "org.xml.sax.SAXNotSupportedException"},
	...
	{"makeException", "(Ljava/lang/String;)Lorg/xml/sax/SAXParseException;", nullptr, $PRIVATE, $method(static_cast<$SAXParseException*(ParserAdapter::*)($String*)>(&ParserAdapter::makeException))},
	...
	{"processName", "(Ljava/lang/String;ZZ)[Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$StringArray*(ParserAdapter::*)($String*,bool,bool)>(&ParserAdapter::processName)), "org.xml.sax.SAXException"},
	{"processingInstruction", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException"},
	{"reportError", "(Ljava/lang/String;)V", nullptr, 0, nullptr, "org.xml.sax.SAXException"},
	...
	{"setup", "(Lorg/xml/sax/Parser;)V", nullptr, $PRIVATE, $method(static_cast<void(ParserAdapter::*)($Parser*)>(&ParserAdapter::setup))},
	{"setupParser", "()V", nullptr, $PRIVATE, $method(static_cast<void(ParserAdapter::*)()>(&ParserAdapter::setupParser))},
