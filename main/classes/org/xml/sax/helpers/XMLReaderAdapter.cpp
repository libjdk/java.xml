...
$MethodInfo _XMLReaderAdapter_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(XMLReaderAdapter::*)()>(&XMLReaderAdapter::init$)), "org.xml.sax.SAXException"},
	{"<init>", "(Lorg/xml/sax/XMLReader;)V", nullptr, $PUBLIC, $method(static_cast<void(XMLReaderAdapter::*)($XMLReader*)>(&XMLReaderAdapter::init$))},
	...
	{"setup", "(Lorg/xml/sax/XMLReader;)V", nullptr, $PRIVATE, $method(static_cast<void(XMLReaderAdapter::*)($XMLReader*)>(&XMLReaderAdapter::setup))},
	{"setupXMLReader", "()V", nullptr, $PRIVATE, $method(static_cast<void(XMLReaderAdapter::*)()>(&XMLReaderAdapter::setupXMLReader)), "org.xml.sax.SAXException"},
