...
$MethodInfo _lr_parser_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(lr_parser::*)()>(&lr_parser::init$))},
	{"<init>", "(Lcom/sun/java_cup/internal/runtime/Scanner;)V", nullptr, $PUBLIC, $method(static_cast<void(lr_parser::*)($Scanner*)>(&lr_parser::init$))},
	{"EOF_sym", "()I", nullptr, $PUBLIC | $ABSTRACT},
	{"action_table", "()[[S", nullptr, $PUBLIC | $ABSTRACT},
	{"advance_lookahead", "()Z", nullptr, $PROTECTED},
	{"cur_err_token", "()Lcom/sun/java_cup/internal/runtime/Symbol;", nullptr, $PROTECTED},
	{"debug_message", "(Ljava/lang/String;)V", nullptr, $PUBLIC},
	{"debug_parse", "()Lcom/sun/java_cup/internal/runtime/Symbol;", nullptr, $PUBLIC, nullptr, "java.lang.Exception"},
	{"debug_reduce", "(III)V", nullptr, $PUBLIC},
	{"debug_shift", "(Lcom/sun/java_cup/internal/runtime/Symbol;)V", nullptr, $PUBLIC},
	{"debug_stack", "()V", nullptr, $PUBLIC},
	{"do_action", "(ILcom/sun/java_cup/internal/runtime/lr_parser;Ljava/util/Stack;I)Lcom/sun/java_cup/internal/runtime/Symbol;", "(ILcom/sun/java_cup/internal/runtime/lr_parser;Ljava/util/Stack<Lcom/sun/java_cup/internal/runtime/Symbol;>;I)Lcom/sun/java_cup/internal/runtime/Symbol;", $PUBLIC | $ABSTRACT, nullptr, "java.lang.Exception"},
	{"done_parsing", "()V", nullptr, $PUBLIC},
	{"dump_stack", "()V", nullptr, $PUBLIC},
	{"error_recovery", "(Z)Z", nullptr, $PROTECTED, nullptr, "java.lang.Exception"},
	{"error_sym", "()I", nullptr, $PUBLIC | $ABSTRACT},
	{"error_sync_size", "()I", nullptr, $PROTECTED},
	{"find_recovery_config", "(Z)Z", nullptr, $PROTECTED},
	{"getScanner", "()Lcom/sun/java_cup/internal/runtime/Scanner;", nullptr, $PUBLIC},
	{"get_action", "(II)S", nullptr, $PROTECTED | $FINAL, $method(static_cast<int16_t(lr_parser::*)(int32_t,int32_t)>(&lr_parser::get_action))},
	{"get_reduce", "(II)S", nullptr, $PROTECTED | $FINAL, $method(static_cast<int16_t(lr_parser::*)(int32_t,int32_t)>(&lr_parser::get_reduce))},
	{"init_actions", "()V", nullptr, $PROTECTED | $ABSTRACT, nullptr, "java.lang.Exception"},
	{"parse", "()Lcom/sun/java_cup/internal/runtime/Symbol;", nullptr, $PUBLIC, nullptr, "java.lang.Exception"},
	{"parse_lookahead", "(Z)V", nullptr, $PROTECTED, nullptr, "java.lang.Exception"},
	{"production_table", "()[[S", nullptr, $PUBLIC | $ABSTRACT},
	{"read_lookahead", "()V", nullptr, $PROTECTED, nullptr, "java.lang.Exception"},
	{"reduce_table", "()[[S", nullptr, $PUBLIC | $ABSTRACT},
	{"report_error", "(Ljava/lang/String;Ljava/lang/Object;)V", nullptr, $PUBLIC},
	{"report_fatal_error", "(Ljava/lang/String;Ljava/lang/Object;)V", nullptr, $PUBLIC, nullptr, "java.lang.Exception"},
	{"restart_lookahead", "()V", nullptr, $PROTECTED, nullptr, "java.lang.Exception"},
	{"scan", "()Lcom/sun/java_cup/internal/runtime/Symbol;", nullptr, $PUBLIC, nullptr, "java.lang.Exception"},
	{"setScanner", "(Lcom/sun/java_cup/internal/runtime/Scanner;)V", nullptr, $PUBLIC},
	{"shift_under_error", "()Z", nullptr, $PROTECTED},
	{"start_production", "()I", nullptr, $PUBLIC | $ABSTRACT},
	{"start_state", "()I", nullptr, $PUBLIC | $ABSTRACT},
	{"syntax_error", "(Lcom/sun/java_cup/internal/runtime/Symbol;)V", nullptr, $PUBLIC},
	{"try_parse_ahead", "(Z)Z", nullptr, $PROTECTED, nullptr, "java.lang.Exception"},
	{"unpackFromStrings", "([Ljava/lang/String;)[[S", nullptr, $PROTECTED | $STATIC, $method(static_cast<$shortArray2*(*)($StringArray*)>(&lr_parser::unpackFromStrings))},
	{"unrecovered_syntax_error", "(Lcom/sun/java_cup/internal/runtime/Symbol;)V", nullptr, $PUBLIC, nullptr, "java.lang.Exception"},
	{"user_init", "()V", nullptr, $PUBLIC, nullptr, "java.lang.Exception"},
	{}
};
