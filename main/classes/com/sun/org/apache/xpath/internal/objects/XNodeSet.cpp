...
$MethodInfo _XNodeSet_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PROTECTED, $method(static_cast<void(XNodeSet::*)()>(&XNodeSet::init$))},
	{"<init>", "(Lcom/sun/org/apache/xml/internal/dtm/DTMIterator;)V", nullptr, $PUBLIC, $method(static_cast<void(XNodeSet::*)($DTMIterator*)>(&XNodeSet::init$))},
	{"<init>", "(Lcom/sun/org/apache/xpath/internal/objects/XNodeSet;)V", nullptr, $PUBLIC, $method(static_cast<void(XNodeSet::*)(XNodeSet*)>(&XNodeSet::init$))},
	{"<init>", "(Lcom/sun/org/apache/xml/internal/dtm/DTMManager;)V", nullptr, $PUBLIC, $method(static_cast<void(XNodeSet::*)($DTMManager*)>(&XNodeSet::init$))},
	{"<init>", "(ILcom/sun/org/apache/xml/internal/dtm/DTMManager;)V", nullptr, $PUBLIC, $method(static_cast<void(XNodeSet::*)(int32_t,$DTMManager*)>(&XNodeSet::init$))},
	{"appendToFsb", "(Lcom/sun/org/apache/xml/internal/utils/FastStringBuffer;)V", nullptr, $PUBLIC},
	{"bool", "()Z", nullptr, $PUBLIC},
	{"boolWithSideEffects", "()Z", nullptr, $PUBLIC},
	{"compare", "(Lcom/sun/org/apache/xpath/internal/objects/XObject;Lcom/sun/org/apache/xpath/internal/objects/Comparator;)Z", nullptr, $PUBLIC, nullptr, "javax.xml.transform.TransformerException"},
	...
	{"getNumberFromNode", "(I)D", nullptr, $PUBLIC},
	{"getStringFromNode", "(I)Lcom/sun/org/apache/xml/internal/utils/XMLString;", nullptr, $PUBLIC},
	...
	{"iter", "()Lcom/sun/org/apache/xml/internal/dtm/DTMIterator;", nullptr, $PUBLIC},
	{"iterRaw", "()Lcom/sun/org/apache/xml/internal/dtm/DTMIterator;", nullptr, $PUBLIC},
	...
	{"mutableNodeset", "()Lcom/sun/org/apache/xpath/internal/NodeSetDTM;", nullptr, $PUBLIC},
	...
	{"numWithSideEffects", "()D", nullptr, $PUBLIC},
	{"object", "()Ljava/lang/Object;", nullptr, $PUBLIC},
	{"release", "(Lcom/sun/org/apache/xml/internal/dtm/DTMIterator;)V", nullptr, $PUBLIC},
