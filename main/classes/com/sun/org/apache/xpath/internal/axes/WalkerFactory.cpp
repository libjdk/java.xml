...
$MethodInfo _WalkerFactory_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(WalkerFactory::*)()>(&WalkerFactory::init$))},
	{"analyze", "(Lcom/sun/org/apache/xpath/internal/compiler/Compiler;II)I", nullptr, $PRIVATE | $STATIC, $method(static_cast<int32_t(*)($Compiler*,int32_t,int32_t)>(&WalkerFactory::analyze)), "javax.xml.transform.TransformerException"},
	{"analyzePredicate", "(Lcom/sun/org/apache/xpath/internal/compiler/Compiler;II)Z", nullptr, $STATIC, $method(static_cast<bool(*)($Compiler*,int32_t,int32_t)>(&WalkerFactory::analyzePredicate)), "javax.xml.transform.TransformerException"},
	{"canCrissCross", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::canCrissCross))},
	{"canSkipSubtrees", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::canSkipSubtrees))},
	{"createDefaultStepPattern", "(Lcom/sun/org/apache/xpath/internal/compiler/Compiler;ILcom/sun/org/apache/xpath/internal/axes/MatchPatternIterator;ILcom/sun/org/apache/xpath/internal/patterns/StepPattern;Lcom/sun/org/apache/xpath/internal/patterns/StepPattern;)Lcom/sun/org/apache/xpath/internal/patterns/StepPattern;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$StepPattern*(*)($Compiler*,int32_t,$MatchPatternIterator*,int32_t,$StepPattern*,$StepPattern*)>(&WalkerFactory::createDefaultStepPattern)), "javax.xml.transform.TransformerException"},
	{"createDefaultWalker", "(Lcom/sun/org/apache/xpath/internal/compiler/Compiler;ILcom/sun/org/apache/xpath/internal/axes/WalkingIterator;I)Lcom/sun/org/apache/xpath/internal/axes/AxesWalker;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$AxesWalker*(*)($Compiler*,int32_t,$WalkingIterator*,int32_t)>(&WalkerFactory::createDefaultWalker))},
	{"diagnoseIterator", "(Ljava/lang/String;ILcom/sun/org/apache/xpath/internal/compiler/Compiler;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($String*,int32_t,$Compiler*)>(&WalkerFactory::diagnoseIterator))},
	{"functionProximateOrContainsProximate", "(Lcom/sun/org/apache/xpath/internal/compiler/Compiler;I)Z", nullptr, $STATIC, $method(static_cast<bool(*)($Compiler*,int32_t)>(&WalkerFactory::functionProximateOrContainsProximate))},
	{"getAnalysisBitFromAxes", "(I)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&WalkerFactory::getAnalysisBitFromAxes))},
	{"getAnalysisString", "(I)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int32_t)>(&WalkerFactory::getAnalysisString))},
	{"getAxisFromStep", "(Lcom/sun/org/apache/xpath/internal/compiler/Compiler;I)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)($Compiler*,int32_t)>(&WalkerFactory::getAxisFromStep)), "javax.xml.transform.TransformerException"},
	{"getStepCount", "(I)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&WalkerFactory::getStepCount))},
	{"hasPredicate", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::hasPredicate))},
	{"isAbsolute", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::isAbsolute))},
	{"isDownwardAxisOfMany", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::isDownwardAxisOfMany))},
	{"isNaturalDocOrder", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::isNaturalDocOrder))},
	{"isNaturalDocOrder", "(Lcom/sun/org/apache/xpath/internal/compiler/Compiler;III)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)($Compiler*,int32_t,int32_t,int32_t)>(&WalkerFactory::isNaturalDocOrder)), "javax.xml.transform.TransformerException"},
	{"isOneStep", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::isOneStep))},
	{"isOptimizableForDescendantIterator", "(Lcom/sun/org/apache/xpath/internal/compiler/Compiler;II)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)($Compiler*,int32_t,int32_t)>(&WalkerFactory::isOptimizableForDescendantIterator)), "javax.xml.transform.TransformerException"},
	{"isProximateInnerExpr", "(Lcom/sun/org/apache/xpath/internal/compiler/Compiler;I)Z", nullptr, $STATIC, $method(static_cast<bool(*)($Compiler*,int32_t)>(&WalkerFactory::isProximateInnerExpr))},
	{"isSet", "(II)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t,int32_t)>(&WalkerFactory::isSet))},
	{"isWild", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::isWild))},
	{"loadOneWalker", "(Lcom/sun/org/apache/xpath/internal/axes/WalkingIterator;Lcom/sun/org/apache/xpath/internal/compiler/Compiler;I)Lcom/sun/org/apache/xpath/internal/axes/AxesWalker;", nullptr, $STATIC, $method(static_cast<$AxesWalker*(*)($WalkingIterator*,$Compiler*,int32_t)>(&WalkerFactory::loadOneWalker)), "javax.xml.transform.TransformerException"},
	{"loadSteps", "(Lcom/sun/org/apache/xpath/internal/axes/MatchPatternIterator;Lcom/sun/org/apache/xpath/internal/compiler/Compiler;II)Lcom/sun/org/apache/xpath/internal/patterns/StepPattern;", nullptr, $STATIC, $method(static_cast<$StepPattern*(*)($MatchPatternIterator*,$Compiler*,int32_t,int32_t)>(&WalkerFactory::loadSteps)), "javax.xml.transform.TransformerException"},
	{"loadWalkers", "(Lcom/sun/org/apache/xpath/internal/axes/WalkingIterator;Lcom/sun/org/apache/xpath/internal/compiler/Compiler;II)Lcom/sun/org/apache/xpath/internal/axes/AxesWalker;", nullptr, $STATIC, $method(static_cast<$AxesWalker*(*)($WalkingIterator*,$Compiler*,int32_t,int32_t)>(&WalkerFactory::loadWalkers)), "javax.xml.transform.TransformerException"},
	{"mightBeProximate", "(Lcom/sun/org/apache/xpath/internal/compiler/Compiler;II)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)($Compiler*,int32_t,int32_t)>(&WalkerFactory::mightBeProximate)), "javax.xml.transform.TransformerException"},
	{"newDTMIterator", "(Lcom/sun/org/apache/xpath/internal/compiler/Compiler;IZ)Lcom/sun/org/apache/xml/internal/dtm/DTMIterator;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$DTMIterator*(*)($Compiler*,int32_t,bool)>(&WalkerFactory::newDTMIterator)), "javax.xml.transform.TransformerException"},
	{"walksAncestors", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksAncestors))},
	{"walksAttributes", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksAttributes))},
	{"walksChildren", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksChildren))},
	{"walksChildrenAndExtraAndSelfOnly", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksChildrenAndExtraAndSelfOnly))},
	{"walksChildrenOnly", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksChildrenOnly))},
	{"walksDescendants", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksDescendants))},
	{"walksDescendantsAndExtraAndSelfOnly", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksDescendantsAndExtraAndSelfOnly))},
	{"walksDownExtraOnly", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksDownExtraOnly))},
	{"walksDownOnly", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksDownOnly))},
	{"walksExtraNodes", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksExtraNodes))},
	{"walksExtraNodesOnly", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksExtraNodesOnly))},
	{"walksFilteredList", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksFilteredList))},
	{"walksFollowingOnlyMaybeAbsolute", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksFollowingOnlyMaybeAbsolute))},
	{"walksInDocOrder", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksInDocOrder))},
	{"walksNamespaces", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksNamespaces))},
	{"walksSelfOnly", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksSelfOnly))},
	{"walksSideways", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksSideways))},
	{"walksSubtree", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksSubtree))},
	{"walksSubtreeOnly", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksSubtreeOnly))},
	{"walksSubtreeOnlyFromRootOrContext", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksSubtreeOnlyFromRootOrContext))},
	{"walksSubtreeOnlyMaybeAbsolute", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksSubtreeOnlyMaybeAbsolute))},
	{"walksUp", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksUp))},
	{"walksUpOnly", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&WalkerFactory::walksUpOnly))},
	{}
};
