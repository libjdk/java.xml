...
$MethodInfo _WalkingIterator_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xpath/internal/compiler/Compiler;IIZ)V", nullptr, 0, $method(static_cast<void(WalkingIterator::*)($Compiler*,int32_t,int32_t,bool)>(&WalkingIterator::init$)), "javax.xml.transform.TransformerException"},
	{"<init>", "(Lcom/sun/org/apache/xml/internal/utils/PrefixResolver;)V", nullptr, $PUBLIC, $method(static_cast<void(WalkingIterator::*)($PrefixResolver*)>(&WalkingIterator::init$))},
	...
	{"getFirstWalker", "()Lcom/sun/org/apache/xpath/internal/axes/AxesWalker;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$AxesWalker*(WalkingIterator::*)()>(&WalkingIterator::getFirstWalker))},
	{"getLastUsedWalker", "()Lcom/sun/org/apache/xpath/internal/axes/AxesWalker;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$AxesWalker*(WalkingIterator::*)()>(&WalkingIterator::getLastUsedWalker))},
	{"nextNode", "()I", nullptr, $PUBLIC},
	{"reset", "()V", nullptr, $PUBLIC},
	{"setExpression", "(Lcom/sun/org/apache/xpath/internal/Expression;)V", nullptr, $PUBLIC},
	{"setFirstWalker", "(Lcom/sun/org/apache/xpath/internal/axes/AxesWalker;)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(WalkingIterator::*)($AxesWalker*)>(&WalkingIterator::setFirstWalker))},
	{"setLastUsedWalker", "(Lcom/sun/org/apache/xpath/internal/axes/AxesWalker;)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(WalkingIterator::*)($AxesWalker*)>(&WalkingIterator::setLastUsedWalker))},
