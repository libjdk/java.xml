...
$MethodInfo _XRTreeFrag_MethodInfo_[] = {
	{"<init>", "(ILcom/sun/org/apache/xpath/internal/XPathContext;Lcom/sun/org/apache/xpath/internal/ExpressionNode;)V", nullptr, $PUBLIC, $method(static_cast<void(XRTreeFrag::*)(int32_t,$XPathContext*,$ExpressionNode*)>(&XRTreeFrag::init$))},
	{"<init>", "(ILcom/sun/org/apache/xpath/internal/XPathContext;)V", nullptr, $PUBLIC, $method(static_cast<void(XRTreeFrag::*)(int32_t,$XPathContext*)>(&XRTreeFrag::init$))},
	{"<init>", "(Lcom/sun/org/apache/xpath/internal/Expression;)V", nullptr, $PUBLIC, $method(static_cast<void(XRTreeFrag::*)($Expression*)>(&XRTreeFrag::init$))},
	...
	{"convertToNodeset", "()Lorg/w3c/dom/NodeList;", nullptr, $PUBLIC},
	...
	{"initDTM", "(ILcom/sun/org/apache/xpath/internal/XPathContext;)V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(XRTreeFrag::*)(int32_t,$XPathContext*)>(&XRTreeFrag::initDTM))},
