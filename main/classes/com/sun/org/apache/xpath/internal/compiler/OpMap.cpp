...
$MethodInfo _OpMap_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(OpMap::*)()>(&OpMap::init$))},
	{"error", "(Ljava/lang/String;[Ljava/lang/Object;)V", nullptr, $PUBLIC, nullptr, "javax.xml.transform.TransformerException"},
	{"getArgLength", "(I)I", nullptr, $PUBLIC},
	{"getArgLengthOfStep", "(I)I", nullptr, $PUBLIC},
	{"getFirstChildPos", "(I)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&OpMap::getFirstChildPos))},
	{"getFirstChildPosOfStep", "(I)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&OpMap::getFirstChildPosOfStep))},
	{"getFirstPredicateOpPos", "(I)I", nullptr, $PUBLIC, nullptr, "javax.xml.transform.TransformerException"},
	{"getNextOpPos", "(I)I", nullptr, $PUBLIC},
	{"getNextOpPos", "([II)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)($ints*,int32_t)>(&OpMap::getNextOpPos))},
	{"getNextStepPos", "(I)I", nullptr, $PUBLIC},
	{"getOp", "(I)I", nullptr, $PUBLIC},
	{"getOpMap", "()Lcom/sun/org/apache/xpath/internal/compiler/OpMapVector;", nullptr, $PUBLIC},
	{"getPatternString", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getStepLocalName", "(I)Ljava/lang/String;", nullptr, $PUBLIC},
	{"getStepNS", "(I)Ljava/lang/String;", nullptr, $PUBLIC},
	{"getStepTestType", "(I)I", nullptr, $PUBLIC},
	{"getToken", "(I)Ljava/lang/Object;", nullptr, $PUBLIC},
	{"getTokenQueue", "()Lcom/sun/org/apache/xml/internal/utils/ObjectVector;", nullptr, $PUBLIC},
	{"getTokenQueueSize", "()I", nullptr, $PUBLIC},
	{"setOp", "(II)V", nullptr, $PUBLIC},
	{"shrink", "()V", nullptr, 0},
