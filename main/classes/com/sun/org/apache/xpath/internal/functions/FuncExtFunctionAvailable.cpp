...
$MethodInfo _FuncExtFunctionAvailable_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(FuncExtFunctionAvailable::*)()>(&FuncExtFunctionAvailable::init$))},
	...
	{"setFunctionTable", "(Lcom/sun/org/apache/xpath/internal/compiler/FunctionTable;)V", nullptr, $PUBLIC},
	{}
};
