...
$MethodInfo _DTMDefaultBase_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xml/internal/dtm/DTMManager;Ljavax/xml/transform/Source;ILcom/sun/org/apache/xml/internal/dtm/DTMWSFilter;Lcom/sun/org/apache/xml/internal/utils/XMLStringFactory;Z)V", nullptr, $PUBLIC, $method(static_cast<void(DTMDefaultBase::*)($DTMManager*,$Source*,int32_t,$DTMWSFilter*,$XMLStringFactory*,bool)>(&DTMDefaultBase::init$))},
	{"<init>", "(Lcom/sun/org/apache/xml/internal/dtm/DTMManager;Ljavax/xml/transform/Source;ILcom/sun/org/apache/xml/internal/dtm/DTMWSFilter;Lcom/sun/org/apache/xml/internal/utils/XMLStringFactory;ZIZZ)V", nullptr, $PUBLIC, $method(static_cast<void(DTMDefaultBase::*)($DTMManager*,$Source*,int32_t,$DTMWSFilter*,$XMLStringFactory*,bool,int32_t,bool,bool)>(&DTMDefaultBase::init$))},
	{"_exptype", "(I)I", nullptr, $PROTECTED},
	{"_firstch", "(I)I", nullptr, $PROTECTED},
	{"_level", "(I)I", nullptr, $PROTECTED},
	{"_nextsib", "(I)I", nullptr, $PROTECTED},
	{"_parent", "(I)I", nullptr, $PROTECTED},
	{"_prevsib", "(I)I", nullptr, $PROTECTED},
	{"_type", "(I)S", nullptr, $PROTECTED},
	{"appendChild", "(IZZ)V", nullptr, $PUBLIC},
	{"appendTextChild", "(Ljava/lang/String;)V", nullptr, $PUBLIC},
	{"declareNamespaceInContext", "(II)V", nullptr, $PROTECTED},
	{"documentRegistration", "()V", nullptr, $PUBLIC},
	{"documentRelease", "()V", nullptr, $PUBLIC},
	{"dumpDTM", "(Ljava/io/OutputStream;)V", nullptr, $PUBLIC},
	{"dumpNode", "(I)Ljava/lang/String;", nullptr, $PUBLIC},
	{"ensureSizeOfIndex", "(II)V", nullptr, $PROTECTED},
	{"error", "(Ljava/lang/String;)V", nullptr, $PROTECTED},
	{"findElementFromIndex", "(III)I", nullptr, 0},
	{"findGTE", "([IIII)I", nullptr, $PROTECTED},
	{"findInSortedSuballocatedIntVector", "(Lcom/sun/org/apache/xml/internal/utils/SuballocatedIntVector;I)I", nullptr, $PROTECTED},
	{"findNamespaceContext", "(I)Lcom/sun/org/apache/xml/internal/utils/SuballocatedIntVector;", nullptr, $PROTECTED},
	{"getDTMIDs", "()Lcom/sun/org/apache/xml/internal/utils/SuballocatedIntVector;", nullptr, $PUBLIC},
	...
	{"getManager", "()Lcom/sun/org/apache/xml/internal/dtm/DTMManager;", nullptr, $PUBLIC},
	...
	{"getNextNodeIdentity", "(I)I", nullptr, $PROTECTED | $ABSTRACT},
	...
	{"getNumberOfNodes", "()I", nullptr, $PROTECTED | $ABSTRACT},
	...
	{"getTypedAttribute", "(II)I", nullptr, $PROTECTED},
	{"getTypedFirstChild", "(II)I", nullptr, $PUBLIC},
	{"getTypedNextSibling", "(II)I", nullptr, $PUBLIC},
	{"hasChildNodes", "(I)Z", nullptr, $PUBLIC},
	{"indexNode", "(II)V", nullptr, $PROTECTED},
	...
	{"makeNodeHandle", "(I)I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(DTMDefaultBase::*)(int32_t)>(&DTMDefaultBase::makeNodeHandle))},
	{"makeNodeIdentity", "(I)I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(DTMDefaultBase::*)(int32_t)>(&DTMDefaultBase::makeNodeIdentity))},
	{"migrateTo", "(Lcom/sun/org/apache/xml/internal/dtm/DTMManager;)V", nullptr, $PUBLIC},
	{"nextNode", "()Z", nullptr, $PROTECTED | $ABSTRACT},
	{"popShouldStripWhitespace", "()V", nullptr, $PROTECTED},
	{"pushShouldStripWhitespace", "(Z)V", nullptr, $PROTECTED},
	{"setDocumentBaseURI", "(Ljava/lang/String;)V", nullptr, $PUBLIC},
	{"setFeature", "(Ljava/lang/String;Z)V", nullptr, $PUBLIC},
	{"setShouldStripWhitespace", "(Z)V", nullptr, $PROTECTED},
