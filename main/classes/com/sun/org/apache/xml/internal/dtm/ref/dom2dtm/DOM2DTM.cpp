...
$MethodInfo _DOM2DTM_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/xml/internal/dtm/DTMManager;Ljavax/xml/transform/dom/DOMSource;ILcom/sun/org/apache/xml/internal/dtm/DTMWSFilter;Lcom/sun/org/apache/xml/internal/utils/XMLStringFactory;Z)V", nullptr, $PUBLIC, $method(static_cast<void(DOM2DTM::*)($DTMManager*,$DOMSource*,int32_t,$DTMWSFilter*,$XMLStringFactory*,bool)>(&DOM2DTM::init$))},
	{"addNode", "(Lorg/w3c/dom/Node;III)I", nullptr, $PROTECTED},
	{"dispatchCharactersEvents", "(ILorg/xml/sax/ContentHandler;Z)V", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException"},
	{"dispatchNodeData", "(Lorg/w3c/dom/Node;Lorg/xml/sax/ContentHandler;I)V", nullptr, $PROTECTED | $STATIC, $method(static_cast<void(*)($Node*,$ContentHandler*,int32_t)>(&DOM2DTM::dispatchNodeData)), "org.xml.sax.SAXException"},
	...
	{"getHandleFromNode", "(Lorg/w3c/dom/Node;)I", nullptr, $PRIVATE, $method(static_cast<int32_t(DOM2DTM::*)($Node*)>(&DOM2DTM::getHandleFromNode))},
	{"getHandleOfNode", "(Lorg/w3c/dom/Node;)I", nullptr, $PUBLIC},
	...
	{"getNextNodeIdentity", "(I)I", nullptr, $PROTECTED},
	{"getNode", "(I)Lorg/w3c/dom/Node;", nullptr, $PUBLIC},
	{"getNodeData", "(Lorg/w3c/dom/Node;Lcom/sun/org/apache/xml/internal/utils/FastStringBuffer;)V", nullptr, $PROTECTED | $STATIC, $method(static_cast<void(*)($Node*,$FastStringBuffer*)>(&DOM2DTM::getNodeData))},
	...
	{"getNumberOfNodes", "()I", nullptr, $PUBLIC},
	...
	{"isSpace", "(C)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)(char16_t)>(&DOM2DTM::isSpace))},
	{"isWhitespace", "(I)Z", nullptr, $PUBLIC},
	{"logicalNextDOMTextNode", "(Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;", nullptr, $PRIVATE, $method(static_cast<$Node*(DOM2DTM::*)($Node*)>(&DOM2DTM::logicalNextDOMTextNode))},
	{"lookupNode", "(I)Lorg/w3c/dom/Node;", nullptr, $PROTECTED},
	{"needsTwoThreads", "()Z", nullptr, $PUBLIC},
	{"nextNode", "()Z", nullptr, $PROTECTED},
