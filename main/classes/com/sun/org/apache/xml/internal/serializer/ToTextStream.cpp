...
$MethodInfo _ToTextStream_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(ToTextStream::*)()>(&ToTextStream::init$))},
	{"<init>", "(Ljavax/xml/transform/ErrorListener;)V", nullptr, $PUBLIC, $method(static_cast<void(ToTextStream::*)($ErrorListener*)>(&ToTextStream::init$))},
	...
	{"writeNormalizedChars", "([CIIZ)V", nullptr, 0, $method(static_cast<void(ToTextStream::*)($chars*,int32_t,int32_t,bool)>(&ToTextStream::writeNormalizedChars)), "java.io.IOException,org.xml.sax.SAXException"},
	{}
};
