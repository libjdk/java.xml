...
$MethodInfo _SerializerTraceWriter_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/io/Writer;Lcom/sun/org/apache/xml/internal/serializer/SerializerTrace;)V", nullptr, $PUBLIC, $method(static_cast<void(SerializerTraceWriter::*)($Writer*,$SerializerTrace*)>(&SerializerTraceWriter::init$))},
	{"close", "()V", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"flush", "()V", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"flushBuffer", "()V", nullptr, $PRIVATE, $method(static_cast<void(SerializerTraceWriter::*)()>(&SerializerTraceWriter::flushBuffer)), "java.io.IOException"},
	{"getOutputStream", "()Ljava/io/OutputStream;", nullptr, $PUBLIC},
	{"getWriter", "()Ljava/io/Writer;", nullptr, $PUBLIC},
	{"setBufferSize", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(SerializerTraceWriter::*)(int32_t)>(&SerializerTraceWriter::setBufferSize))},
