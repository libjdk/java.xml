...
$MethodInfo _Serializer_MethodInfo_[] = {
	...
	{"asDOMSerializer", "()Lcom/sun/org/apache/xml/internal/serialize/DOMSerializer;", nullptr, $PUBLIC | $ABSTRACT, nullptr, "java.io.IOException"},
	{"asDocumentHandler", "()Lorg/xml/sax/DocumentHandler;", nullptr, $PUBLIC | $ABSTRACT, nullptr, "java.io.IOException"},
	{"setOutputByteStream", "(Ljava/io/OutputStream;)V", nullptr, $PUBLIC | $ABSTRACT},
	{"setOutputCharStream", "(Ljava/io/Writer;)V", nullptr, $PUBLIC | $ABSTRACT},
	{"setOutputFormat", "(Lcom/sun/org/apache/xml/internal/serialize/OutputFormat;)V", nullptr, $PUBLIC | $ABSTRACT},
	{}
};
