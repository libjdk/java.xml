...
$MethodInfo _SAX2DTM2$TypedPrecedingSiblingIterator_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/xml/internal/dtm/ref/sax2dtm/SAX2DTM2;I)V", nullptr, $PUBLIC, $method(static_cast<void(SAX2DTM2$TypedPrecedingSiblingIterator::*)($SAX2DTM2*,int32_t)>(&SAX2DTM2$TypedPrecedingSiblingIterator::init$))},
