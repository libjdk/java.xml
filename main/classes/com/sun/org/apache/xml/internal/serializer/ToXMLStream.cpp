...
$MethodInfo _ToXMLStream_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(ToXMLStream::*)()>(&ToXMLStream::init$))},
	{"<init>", "(Ljavax/xml/transform/ErrorListener;)V", nullptr, $PUBLIC, $method(static_cast<void(ToXMLStream::*)($ErrorListener*)>(&ToXMLStream::init$))},
	{"CopyFrom", "(Lcom/sun/org/apache/xml/internal/serializer/ToXMLStream;)V", nullptr, $PUBLIC, $method(static_cast<void(ToXMLStream::*)(ToXMLStream*)>(&ToXMLStream::CopyFrom))},
	...
	{"endPreserving", "()V", nullptr, $PUBLIC, $method(static_cast<void(ToXMLStream::*)()>(&ToXMLStream::endPreserving)), "org.xml.sax.SAXException"},
	{"entityReference", "(Ljava/lang/String;)V", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException"},
	{"getXMLVersion", "()Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(ToXMLStream::*)()>(&ToXMLStream::getXMLVersion))},
	...
	{"pushNamespace", "(Ljava/lang/String;Ljava/lang/String;)Z", nullptr, $PROTECTED, $method(static_cast<bool(ToXMLStream::*)($String*,$String*)>(&ToXMLStream::pushNamespace))},
	{"reset", "()Z", nullptr, $PUBLIC},
	{"resetToXMLStream", "()V", nullptr, $PRIVATE, $method(static_cast<void(ToXMLStream::*)()>(&ToXMLStream::resetToXMLStream))},
	{"startDocumentInternal", "()V", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException"},
	{"startPreserving", "()V", nullptr, $PUBLIC, $method(static_cast<void(ToXMLStream::*)()>(&ToXMLStream::startPreserving)), "org.xml.sax.SAXException"},
	{}
};
