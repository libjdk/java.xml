...
$MethodInfo _IncrementalSAXSource_Filter_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(IncrementalSAXSource_Filter::*)()>(&IncrementalSAXSource_Filter::init$))},
	{"<init>", "(Lcom/sun/org/apache/xml/internal/dtm/ref/CoroutineManager;I)V", nullptr, $PUBLIC, $method(static_cast<void(IncrementalSAXSource_Filter::*)($CoroutineManager*,int32_t)>(&IncrementalSAXSource_Filter::init$))},
	{"characters", "([CII)V", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException"},
	{"co_entry_pause", "()V", nullptr, $PRIVATE, $method(static_cast<void(IncrementalSAXSource_Filter::*)()>(&IncrementalSAXSource_Filter::co_entry_pause)), "org.xml.sax.SAXException"},
	{"co_yield", "(Z)V", nullptr, $PRIVATE, $method(static_cast<void(IncrementalSAXSource_Filter::*)(bool)>(&IncrementalSAXSource_Filter::co_yield$)), "org.xml.sax.SAXException"},
	{"comment", "([CII)V", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException"},
	{"count_and_yield", "(Z)V", nullptr, $PROTECTED, $method(static_cast<void(IncrementalSAXSource_Filter::*)(bool)>(&IncrementalSAXSource_Filter::count_and_yield)), "org.xml.sax.SAXException"},
	{"createIncrementalSAXSource", "(Lcom/sun/org/apache/xml/internal/dtm/ref/CoroutineManager;I)Lcom/sun/org/apache/xml/internal/dtm/ref/IncrementalSAXSource;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$IncrementalSAXSource*(*)($CoroutineManager*,int32_t)>(&IncrementalSAXSource_Filter::createIncrementalSAXSource))},
	...
	{"getControllerCoroutineID", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(IncrementalSAXSource_Filter::*)()>(&IncrementalSAXSource_Filter::getControllerCoroutineID))},
	{"getCoroutineManager", "()Lcom/sun/org/apache/xml/internal/dtm/ref/CoroutineManager;", nullptr, $PUBLIC, $method(static_cast<$CoroutineManager*(IncrementalSAXSource_Filter::*)()>(&IncrementalSAXSource_Filter::getCoroutineManager))},
	{"getSourceCoroutineID", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(IncrementalSAXSource_Filter::*)()>(&IncrementalSAXSource_Filter::getSourceCoroutineID))},
	{"ignorableWhitespace", "([CII)V", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException"},
	{"init", "(Lcom/sun/org/apache/xml/internal/dtm/ref/CoroutineManager;II)V", nullptr, $PUBLIC, $method(static_cast<void(IncrementalSAXSource_Filter::*)($CoroutineManager*,int32_t,int32_t)>(&IncrementalSAXSource_Filter::init))},
	...
	{"setErrHandler", "(Lorg/xml/sax/ErrorHandler;)V", nullptr, $PUBLIC, $method(static_cast<void(IncrementalSAXSource_Filter::*)($ErrorHandler*)>(&IncrementalSAXSource_Filter::setErrHandler))},
	{"setLexicalHandler", "(Lorg/xml/sax/ext/LexicalHandler;)V", nullptr, $PUBLIC},
	{"setReturnFrequency", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(IncrementalSAXSource_Filter::*)(int32_t)>(&IncrementalSAXSource_Filter::setReturnFrequency))},
	{"setXMLReader", "(Lorg/xml/sax/XMLReader;)V", nullptr, $PUBLIC, $method(static_cast<void(IncrementalSAXSource_Filter::*)($XMLReader*)>(&IncrementalSAXSource_Filter::setXMLReader))},
