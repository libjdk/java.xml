...
$MethodInfo _XMLSerializer_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(XMLSerializer::*)()>(&XMLSerializer::init$))},
	{"<init>", "(Lcom/sun/org/apache/xml/internal/serialize/OutputFormat;)V", nullptr, $PUBLIC, $method(static_cast<void(XMLSerializer::*)($OutputFormat*)>(&XMLSerializer::init$))},
	{"<init>", "(Ljava/io/Writer;Lcom/sun/org/apache/xml/internal/serialize/OutputFormat;)V", nullptr, $PUBLIC, $method(static_cast<void(XMLSerializer::*)($Writer*,$OutputFormat*)>(&XMLSerializer::init$))},
	{"<init>", "(Ljava/io/OutputStream;Lcom/sun/org/apache/xml/internal/serialize/OutputFormat;)V", nullptr, $PUBLIC, $method(static_cast<void(XMLSerializer::*)($OutputStream*,$OutputFormat*)>(&XMLSerializer::init$))},
	...
	{"endElementIO", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"extractNamespaces", "(Lorg/xml/sax/Attributes;)Lorg/xml/sax/Attributes;", nullptr, $PRIVATE, $method(static_cast<$Attributes*(XMLSerializer::*)($Attributes*)>(&XMLSerializer::extractNamespaces)), "org.xml.sax.SAXException"},
	{"getEntityRef", "(I)Ljava/lang/String;", nullptr, $PROTECTED},
	{"printAttribute", "(Ljava/lang/String;Ljava/lang/String;ZLorg/w3c/dom/Attr;)V", nullptr, $PRIVATE, $method(static_cast<void(XMLSerializer::*)($String*,$String*,bool,$Attr*)>(&XMLSerializer::printAttribute)), "java.io.IOException"},
	{"printEscaped", "(Ljava/lang/String;)V", nullptr, $PROTECTED, nullptr, "java.io.IOException"},
	{"printNamespaceAttr", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(XMLSerializer::*)($String*,$String*)>(&XMLSerializer::printNamespaceAttr)), "java.io.IOException"},
	...
	{"printXMLChar", "(I)V", nullptr, $PROTECTED, nullptr, "java.io.IOException"},
