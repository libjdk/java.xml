...
$MethodInfo _DOM3TreeWalker_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;Lorg/w3c/dom/DOMErrorHandler;Lorg/w3c/dom/ls/LSSerializerFilter;Ljava/lang/String;)V", nullptr, 0, $method(static_cast<void(DOM3TreeWalker::*)($SerializationHandler*,$DOMErrorHandler*,$LSSerializerFilter*,$String*)>(&DOM3TreeWalker::init$))},
	{"applyFilter", "(Lorg/w3c/dom/Node;I)Z", nullptr, $PROTECTED, $method(static_cast<bool(DOM3TreeWalker::*)($Node*,int32_t)>(&DOM3TreeWalker::applyFilter))},
	{"checkUnboundPrefixInEntRef", "(Lorg/w3c/dom/Node;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($Node*)>(&DOM3TreeWalker::checkUnboundPrefixInEntRef))},
	{"dispatachChars", "(Lorg/w3c/dom/Node;)V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(DOM3TreeWalker::*)($Node*)>(&DOM3TreeWalker::dispatachChars)), "org.xml.sax.SAXException"},
	{"endNode", "(Lorg/w3c/dom/Node;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($Node*)>(&DOM3TreeWalker::endNode)), "org.xml.sax.SAXException"},
	{"fixupElementNS", "(Lorg/w3c/dom/Node;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($Node*)>(&DOM3TreeWalker::fixupElementNS)), "org.xml.sax.SAXException"},
	{"initProperties", "(Ljava/util/Properties;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($Properties*)>(&DOM3TreeWalker::initProperties))},
	{"isAttributeWellFormed", "(Lorg/w3c/dom/Node;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($Node*)>(&DOM3TreeWalker::isAttributeWellFormed))},
	{"isCDATASectionWellFormed", "(Lorg/w3c/dom/CDATASection;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($CDATASection*)>(&DOM3TreeWalker::isCDATASectionWellFormed))},
	{"isCommentWellFormed", "(Ljava/lang/String;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($String*)>(&DOM3TreeWalker::isCommentWellFormed))},
	{"isElementWellFormed", "(Lorg/w3c/dom/Node;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($Node*)>(&DOM3TreeWalker::isElementWellFormed))},
	{"isEntityReferneceWellFormed", "(Lorg/w3c/dom/EntityReference;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($EntityReference*)>(&DOM3TreeWalker::isEntityReferneceWellFormed))},
	{"isPIWellFormed", "(Lorg/w3c/dom/ProcessingInstruction;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($ProcessingInstruction*)>(&DOM3TreeWalker::isPIWellFormed))},
	{"isTextWellFormed", "(Lorg/w3c/dom/Text;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($Text*)>(&DOM3TreeWalker::isTextWellFormed))},
	{"isValidQName", "(Ljava/lang/String;Ljava/lang/String;Z)Z", nullptr, $PROTECTED, $method(static_cast<bool(DOM3TreeWalker::*)($String*,$String*,bool)>(&DOM3TreeWalker::isValidQName))},
	{"isWFXMLChar", "(Ljava/lang/String;Ljava/lang/Character;)Z", nullptr, $PROTECTED, $method(static_cast<bool(DOM3TreeWalker::*)($String*,$Character*)>(&DOM3TreeWalker::isWFXMLChar))},
	{"isWFXMLChar", "(Ljava/lang/String;)Ljava/lang/Character;", nullptr, $PROTECTED, $method(static_cast<$Character*(DOM3TreeWalker::*)($String*)>(&DOM3TreeWalker::isWFXMLChar))},
	{"isXMLName", "(Ljava/lang/String;Z)Z", nullptr, $PROTECTED, $method(static_cast<bool(DOM3TreeWalker::*)($String*,bool)>(&DOM3TreeWalker::isXMLName))},
	{"recordLocalNSDecl", "(Lorg/w3c/dom/Node;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($Node*)>(&DOM3TreeWalker::recordLocalNSDecl))},
	{"serializeAttList", "(Lorg/w3c/dom/Element;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($Element*)>(&DOM3TreeWalker::serializeAttList)), "org.xml.sax.SAXException"},
	{"serializeCDATASection", "(Lorg/w3c/dom/CDATASection;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($CDATASection*)>(&DOM3TreeWalker::serializeCDATASection)), "org.xml.sax.SAXException"},
	{"serializeComment", "(Lorg/w3c/dom/Comment;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($Comment*)>(&DOM3TreeWalker::serializeComment)), "org.xml.sax.SAXException"},
	{"serializeDocType", "(Lorg/w3c/dom/DocumentType;Z)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($DocumentType*,bool)>(&DOM3TreeWalker::serializeDocType)), "org.xml.sax.SAXException"},
	{"serializeElement", "(Lorg/w3c/dom/Element;Z)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($Element*,bool)>(&DOM3TreeWalker::serializeElement)), "org.xml.sax.SAXException"},
	{"serializeEntityReference", "(Lorg/w3c/dom/EntityReference;Z)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($EntityReference*,bool)>(&DOM3TreeWalker::serializeEntityReference)), "org.xml.sax.SAXException"},
	{"serializePI", "(Lorg/w3c/dom/ProcessingInstruction;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($ProcessingInstruction*)>(&DOM3TreeWalker::serializePI)), "org.xml.sax.SAXException"},
	{"serializeText", "(Lorg/w3c/dom/Text;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($Text*)>(&DOM3TreeWalker::serializeText)), "org.xml.sax.SAXException"},
	{"startNode", "(Lorg/w3c/dom/Node;)V", nullptr, $PROTECTED, $method(static_cast<void(DOM3TreeWalker::*)($Node*)>(&DOM3TreeWalker::startNode)), "org.xml.sax.SAXException"},
	{"traverse", "(Lorg/w3c/dom/Node;)V", nullptr, $PUBLIC, $method(static_cast<void(DOM3TreeWalker::*)($Node*)>(&DOM3TreeWalker::traverse)), "org.xml.sax.SAXException"},
	{"traverse", "(Lorg/w3c/dom/Node;Lorg/w3c/dom/Node;)V", nullptr, $PUBLIC, $method(static_cast<void(DOM3TreeWalker::*)($Node*,$Node*)>(&DOM3TreeWalker::traverse)), "org.xml.sax.SAXException"},
	{}
};
