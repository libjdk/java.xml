...
$MethodInfo _FastStringBuffer_MethodInfo_[] = {
	{"<init>", "(III)V", nullptr, $PUBLIC, $method(static_cast<void(FastStringBuffer::*)(int32_t,int32_t,int32_t)>(&FastStringBuffer::init$))},
	{"<init>", "(II)V", nullptr, $PUBLIC, $method(static_cast<void(FastStringBuffer::*)(int32_t,int32_t)>(&FastStringBuffer::init$))},
	{"<init>", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(FastStringBuffer::*)(int32_t)>(&FastStringBuffer::init$))},
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(FastStringBuffer::*)()>(&FastStringBuffer::init$))},
	{"<init>", "(Lcom/sun/org/apache/xml/internal/utils/FastStringBuffer;)V", nullptr, $PRIVATE, $method(static_cast<void(FastStringBuffer::*)(FastStringBuffer*)>(&FastStringBuffer::init$))},
	{"append", "(C)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(FastStringBuffer::*)(char16_t)>(&FastStringBuffer::append))},
	{"append", "(Ljava/lang/String;)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(FastStringBuffer::*)($String*)>(&FastStringBuffer::append))},
	{"append", "(Ljava/lang/StringBuffer;)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(FastStringBuffer::*)($StringBuffer*)>(&FastStringBuffer::append))},
	{"append", "([CII)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(FastStringBuffer::*)($chars*,int32_t,int32_t)>(&FastStringBuffer::append))},
	{"append", "(Lcom/sun/org/apache/xml/internal/utils/FastStringBuffer;)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(FastStringBuffer::*)(FastStringBuffer*)>(&FastStringBuffer::append))},
	{"charAt", "(I)C", nullptr, $PUBLIC},
	{"getChars", "(II[CI)V", nullptr, $PRIVATE, $method(static_cast<void(FastStringBuffer::*)(int32_t,int32_t,$chars*,int32_t)>(&FastStringBuffer::getChars))},
	{"getOneChunkString", "(III)Ljava/lang/String;", nullptr, $PROTECTED},
	{"getString", "(II)Ljava/lang/String;", nullptr, $PUBLIC},
	{"getString", "(Ljava/lang/StringBuffer;II)Ljava/lang/StringBuffer;", nullptr, 0},
	{"getString", "(Ljava/lang/StringBuffer;III)Ljava/lang/StringBuffer;", nullptr, 0},
	{"isWhitespace", "(II)Z", nullptr, $PUBLIC},
	{"length", "()I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(FastStringBuffer::*)()>(&FastStringBuffer::length))},
	{"reset", "()V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(FastStringBuffer::*)()>(&FastStringBuffer::reset))},
	{"sendNormalizedSAXcharacters", "(Lorg/xml/sax/ContentHandler;II)I", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException"},
	{"sendNormalizedSAXcharacters", "([CIILorg/xml/sax/ContentHandler;I)I", nullptr, $STATIC, $method(static_cast<int32_t(*)($chars*,int32_t,int32_t,$ContentHandler*,int32_t)>(&FastStringBuffer::sendNormalizedSAXcharacters)), "org.xml.sax.SAXException"},
	{"sendNormalizedSAXcharacters", "([CIILorg/xml/sax/ContentHandler;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($chars*,int32_t,int32_t,$ContentHandler*)>(&FastStringBuffer::sendNormalizedSAXcharacters)), "org.xml.sax.SAXException"},
	{"sendSAXComment", "(Lorg/xml/sax/ext/LexicalHandler;II)V", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException"},
	{"sendSAXcharacters", "(Lorg/xml/sax/ContentHandler;II)V", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException"},
	{"setLength", "(I)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(FastStringBuffer::*)(int32_t)>(&FastStringBuffer::setLength))},
	{"setLength", "(ILcom/sun/org/apache/xml/internal/utils/FastStringBuffer;)V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(FastStringBuffer::*)(int32_t,FastStringBuffer*)>(&FastStringBuffer::setLength))},
	{"size", "()I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(FastStringBuffer::*)()>(&FastStringBuffer::size))},
