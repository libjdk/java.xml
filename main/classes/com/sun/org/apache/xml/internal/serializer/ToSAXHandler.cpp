...
$MethodInfo _ToSAXHandler_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(ToSAXHandler::*)()>(&ToSAXHandler::init$))},
	{"<init>", "(Lorg/xml/sax/ContentHandler;Lorg/xml/sax/ext/LexicalHandler;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(ToSAXHandler::*)($ContentHandler*,$LexicalHandler*,$String*)>(&ToSAXHandler::init$))},
	{"<init>", "(Lorg/xml/sax/ContentHandler;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(ToSAXHandler::*)($ContentHandler*,$String*)>(&ToSAXHandler::init$))},
	...
	{"getShouldOutputNSAttr", "()Z", nullptr, 0},
	...
	{"resetToSAXHandler", "()V", nullptr, $PRIVATE, $method(static_cast<void(ToSAXHandler::*)()>(&ToSAXHandler::resetToSAXHandler))},
	...
	{"setLexHandler", "(Lorg/xml/sax/ext/LexicalHandler;)V", nullptr, $PUBLIC},
	{"setShouldOutputNSAttr", "(Z)V", nullptr, $PUBLIC},
	{"setTransformState", "(Lcom/sun/org/apache/xml/internal/serializer/TransformStateSetter;)V", nullptr, $PUBLIC},
