...
$MethodInfo _ToHTMLStream_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(ToHTMLStream::*)()>(&ToHTMLStream::init$))},
	{"<init>", "(Ljavax/xml/transform/ErrorListener;)V", nullptr, $PUBLIC, $method(static_cast<void(ToHTMLStream::*)($ErrorListener*)>(&ToHTMLStream::init$))},
	...
	{"cdata", "([CII)V", nullptr, $PUBLIC | $FINAL, nullptr, "org.xml.sax.SAXException"},
	{"characters", "([CII)V", nullptr, $PUBLIC | $FINAL, nullptr, "org.xml.sax.SAXException"},
	...
	{"endDocument", "()V", nullptr, $PUBLIC | $FINAL, nullptr, "org.xml.sax.SAXException"},
	{"endElement", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC | $FINAL, nullptr, "org.xml.sax.SAXException"},
	{"endElement", "(Ljava/lang/String;)V", nullptr, $PUBLIC | $FINAL, nullptr, "org.xml.sax.SAXException"},
	{"entityReference", "(Ljava/lang/String;)V", nullptr, $PUBLIC | $FINAL, nullptr, "org.xml.sax.SAXException"},
	...
	{"getElemDesc", "(Ljava/lang/String;)Lcom/sun/org/apache/xml/internal/serializer/ElemDesc;", nullptr, $PUBLIC | $STATIC | $FINAL, $method(static_cast<$ElemDesc*(*)($String*)>(&ToHTMLStream::getElemDesc))},
	{"getElemDesc2", "(Ljava/lang/String;)Lcom/sun/org/apache/xml/internal/serializer/ElemDesc;", nullptr, $PRIVATE, $method(static_cast<$ElemDesc*(ToHTMLStream::*)($String*)>(&ToHTMLStream::getElemDesc2))},
	{"getOmitMetaTag", "()Z", nullptr, $PRIVATE | $FINAL, $method(static_cast<bool(ToHTMLStream::*)()>(&ToHTMLStream::getOmitMetaTag))},
	{"getSpecialEscapeURLs", "()Z", nullptr, $PRIVATE | $FINAL, $method(static_cast<bool(ToHTMLStream::*)()>(&ToHTMLStream::getSpecialEscapeURLs))},
	{"initTagReference", "(Lcom/sun/org/apache/xml/internal/serializer/ToHTMLStream$Trie;)V", nullptr, $STATIC, $method(static_cast<void(*)($ToHTMLStream$Trie*)>(&ToHTMLStream::initTagReference))},
	{"initToHTMLStream", "()V", nullptr, $PRIVATE, $method(static_cast<void(ToHTMLStream::*)()>(&ToHTMLStream::initToHTMLStream))},
	{"internalEntityDecl", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException"},
	{"isASCIIDigit", "(C)Z", nullptr, $PRIVATE, $method(static_cast<bool(ToHTMLStream::*)(char16_t)>(&ToHTMLStream::isASCIIDigit))},
	{"isHHSign", "(Ljava/lang/String;)Z", nullptr, $PRIVATE, $method(static_cast<bool(ToHTMLStream::*)($String*)>(&ToHTMLStream::isHHSign))},
	{"makeHHString", "(I)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)(int32_t)>(&ToHTMLStream::makeHHString))},
	{"namespaceAfterStartElement", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException"},
	{"processAttribute", "(Ljava/io/Writer;Ljava/lang/String;Ljava/lang/String;Lcom/sun/org/apache/xml/internal/serializer/ElemDesc;)V", nullptr, $PROTECTED, $method(static_cast<void(ToHTMLStream::*)($Writer*,$String*,$String*,$ElemDesc*)>(&ToHTMLStream::processAttribute)), "java.io.IOException,org.xml.sax.SAXException"},
	...
	{"setOmitMetaTag", "(Z)V", nullptr, $PUBLIC, $method(static_cast<void(ToHTMLStream::*)(bool)>(&ToHTMLStream::setOmitMetaTag))},
	{"setOutputFormat", "(Ljava/util/Properties;)V", nullptr, $PUBLIC},
	{"setSpecialEscapeURLs", "(Z)V", nullptr, $PUBLIC, $method(static_cast<void(ToHTMLStream::*)(bool)>(&ToHTMLStream::setSpecialEscapeURLs))},
	...
	{"writeAttrURI", "(Ljava/io/Writer;Ljava/lang/String;Z)V", nullptr, $PUBLIC, $method(static_cast<void(ToHTMLStream::*)($Writer*,$String*,bool)>(&ToHTMLStream::writeAttrURI)), "java.io.IOException"},
	{}
};
