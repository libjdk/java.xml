...
$MethodInfo _DTMDefaultBaseIterators$FollowingIterator_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/xml/internal/dtm/ref/DTMDefaultBaseIterators;)V", nullptr, $PUBLIC, $method(static_cast<void(DTMDefaultBaseIterators$FollowingIterator::*)($DTMDefaultBaseIterators*)>(&DTMDefaultBaseIterators$FollowingIterator::init$))},
