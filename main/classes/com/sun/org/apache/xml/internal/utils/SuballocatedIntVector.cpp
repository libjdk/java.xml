...
$MethodInfo _SuballocatedIntVector_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(SuballocatedIntVector::*)()>(&SuballocatedIntVector::init$))},
	{"<init>", "(II)V", nullptr, $PUBLIC, $method(static_cast<void(SuballocatedIntVector::*)(int32_t,int32_t)>(&SuballocatedIntVector::init$))},
	{"<init>", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(SuballocatedIntVector::*)(int32_t)>(&SuballocatedIntVector::init$))},
	{"addElement", "(I)V", nullptr, $PUBLIC},
	{"addElements", "(II)V", nullptr, $PRIVATE, $method(static_cast<void(SuballocatedIntVector::*)(int32_t,int32_t)>(&SuballocatedIntVector::addElements))},
	{"addElements", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(SuballocatedIntVector::*)(int32_t)>(&SuballocatedIntVector::addElements))},
	{"contains", "(I)Z", nullptr, $PRIVATE, $method(static_cast<bool(SuballocatedIntVector::*)(int32_t)>(&SuballocatedIntVector::contains))},
	{"elementAt", "(I)I", nullptr, $PUBLIC},
	{"getMap", "()[[I", nullptr, $PUBLIC | $FINAL, $method(static_cast<$intArray2*(SuballocatedIntVector::*)()>(&SuballocatedIntVector::getMap))},
	{"getMap0", "()[I", nullptr, $PUBLIC | $FINAL, $method(static_cast<$ints*(SuballocatedIntVector::*)()>(&SuballocatedIntVector::getMap0))},
	{"indexOf", "(II)I", nullptr, $PUBLIC},
	{"indexOf", "(I)I", nullptr, $PUBLIC},
	{"insertElementAt", "(II)V", nullptr, $PRIVATE, $method(static_cast<void(SuballocatedIntVector::*)(int32_t,int32_t)>(&SuballocatedIntVector::insertElementAt))},
	{"lastIndexOf", "(I)I", nullptr, $PRIVATE, $method(static_cast<int32_t(SuballocatedIntVector::*)(int32_t)>(&SuballocatedIntVector::lastIndexOf))},
	{"removeAllElements", "()V", nullptr, $PUBLIC},
	{"removeElement", "(I)Z", nullptr, $PRIVATE, $method(static_cast<bool(SuballocatedIntVector::*)(int32_t)>(&SuballocatedIntVector::removeElement))},
	{"removeElementAt", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(SuballocatedIntVector::*)(int32_t)>(&SuballocatedIntVector::removeElementAt))},
