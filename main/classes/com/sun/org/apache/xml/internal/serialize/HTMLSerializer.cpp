...
$MethodInfo _HTMLSerializer_MethodInfo_[] = {
	{"<init>", "(ZLcom/sun/org/apache/xml/internal/serialize/OutputFormat;)V", nullptr, $PROTECTED, $method(static_cast<void(HTMLSerializer::*)(bool,$OutputFormat*)>(&HTMLSerializer::init$))},
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(HTMLSerializer::*)()>(&HTMLSerializer::init$))},
	{"<init>", "(Lcom/sun/org/apache/xml/internal/serialize/OutputFormat;)V", nullptr, $PUBLIC, $method(static_cast<void(HTMLSerializer::*)($OutputFormat*)>(&HTMLSerializer::init$))},
	{"<init>", "(Ljava/io/Writer;Lcom/sun/org/apache/xml/internal/serialize/OutputFormat;)V", nullptr, $PUBLIC, $method(static_cast<void(HTMLSerializer::*)($Writer*,$OutputFormat*)>(&HTMLSerializer::init$))},
	{"<init>", "(Ljava/io/OutputStream;Lcom/sun/org/apache/xml/internal/serialize/OutputFormat;)V", nullptr, $PUBLIC, $method(static_cast<void(HTMLSerializer::*)($OutputStream*,$OutputFormat*)>(&HTMLSerializer::init$))},
	...
	{"escapeURI", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PROTECTED},
	...
	{"setXHTMLNamespace", "(Ljava/lang/String;)V", nullptr, $PUBLIC},
