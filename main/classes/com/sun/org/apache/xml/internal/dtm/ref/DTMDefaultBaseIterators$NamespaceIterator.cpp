...
$MethodInfo _DTMDefaultBaseIterators$NamespaceIterator_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/xml/internal/dtm/ref/DTMDefaultBaseIterators;)V", nullptr, $PUBLIC, $method(static_cast<void(DTMDefaultBaseIterators$NamespaceIterator::*)($DTMDefaultBaseIterators*)>(&DTMDefaultBaseIterators$NamespaceIterator::init$))},
