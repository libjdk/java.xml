...
$MethodInfo _CharInfo_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(CharInfo::*)($String*,$String*)>(&CharInfo::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/String;Z)V", nullptr, $PRIVATE, $method(static_cast<void(CharInfo::*)($String*,$String*,bool)>(&CharInfo::init$))},
	{"arrayIndex", "(I)I", nullptr, $PRIVATE | $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&CharInfo::arrayIndex))},
	{"bit", "(I)I", nullptr, $PRIVATE | $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&CharInfo::bit))},
	{"createEmptySetOfIntegers", "(I)[I", nullptr, $PRIVATE, $method(static_cast<$ints*(CharInfo::*)(int32_t)>(&CharInfo::createEmptySetOfIntegers))},
	{"defineChar2StringMapping", "(Ljava/lang/String;C)V", nullptr, $PRIVATE, $method(static_cast<void(CharInfo::*)($String*,char16_t)>(&CharInfo::defineChar2StringMapping))},
	{"defineEntity", "(Ljava/lang/String;C)V", nullptr, $PRIVATE, $method(static_cast<void(CharInfo::*)($String*,char16_t)>(&CharInfo::defineEntity))},
	{"extraEntity", "(I)Z", nullptr, $PRIVATE, $method(static_cast<bool(CharInfo::*)(int32_t)>(&CharInfo::extraEntity))},
	{"get", "(I)Z", nullptr, $PRIVATE | $FINAL, $method(static_cast<bool(CharInfo::*)(int32_t)>(&CharInfo::get))},
	{"getCharInfo", "(Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xml/internal/serializer/CharInfo;", nullptr, $STATIC, $method(static_cast<CharInfo*(*)($String*,$String*)>(&CharInfo::getCharInfo))},
	{"getCharInfoInternal", "(Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xml/internal/serializer/CharInfo;", nullptr, $STATIC, $method(static_cast<CharInfo*(*)($String*,$String*)>(&CharInfo::getCharInfoInternal))},
	{"getOutputStringForChar", "(C)Ljava/lang/String;", nullptr, 0, $method(static_cast<$String*(CharInfo::*)(char16_t)>(&CharInfo::getOutputStringForChar))},
	{"isSpecialAttrChar", "(I)Z", nullptr, $FINAL, $method(static_cast<bool(CharInfo::*)(int32_t)>(&CharInfo::isSpecialAttrChar))},
	{"isSpecialTextChar", "(I)Z", nullptr, $FINAL, $method(static_cast<bool(CharInfo::*)(int32_t)>(&CharInfo::isSpecialTextChar))},
	{"isTextASCIIClean", "(I)Z", nullptr, $FINAL, $method(static_cast<bool(CharInfo::*)(int32_t)>(&CharInfo::isTextASCIIClean))},
	{"set", "(I)V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(CharInfo::*)(int32_t)>(&CharInfo::set))},
	{"setASCIIclean", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(CharInfo::*)(int32_t)>(&CharInfo::setASCIIclean))},
	{"setASCIIdirty", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(CharInfo::*)(int32_t)>(&CharInfo::setASCIIdirty))},
	{}
};
