...
$MethodInfo _SAX2DTM2_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/xml/internal/dtm/DTMManager;Ljavax/xml/transform/Source;ILcom/sun/org/apache/xml/internal/dtm/DTMWSFilter;Lcom/sun/org/apache/xml/internal/utils/XMLStringFactory;Z)V", nullptr, $PUBLIC, $method(static_cast<void(SAX2DTM2::*)($DTMManager*,$Source*,int32_t,$DTMWSFilter*,$XMLStringFactory*,bool)>(&SAX2DTM2::init$))},
	{"<init>", "(Lcom/sun/org/apache/xml/internal/dtm/DTMManager;Ljavax/xml/transform/Source;ILcom/sun/org/apache/xml/internal/dtm/DTMWSFilter;Lcom/sun/org/apache/xml/internal/utils/XMLStringFactory;ZIZZZ)V", nullptr, $PUBLIC, $method(static_cast<void(SAX2DTM2::*)($DTMManager*,$Source*,int32_t,$DTMWSFilter*,$XMLStringFactory*,bool,int32_t,bool,bool,bool)>(&SAX2DTM2::init$))},
	{"_exptype", "(I)I", nullptr, $PUBLIC | $FINAL},
	{"_exptype2", "(I)I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(SAX2DTM2::*)(int32_t)>(&SAX2DTM2::_exptype2))},
	{"_exptype2Type", "(I)I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(SAX2DTM2::*)(int32_t)>(&SAX2DTM2::_exptype2Type))},
	{"_firstch2", "(I)I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(SAX2DTM2::*)(int32_t)>(&SAX2DTM2::_firstch2))},
	{"_nextsib2", "(I)I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(SAX2DTM2::*)(int32_t)>(&SAX2DTM2::_nextsib2))},
	{"_parent2", "(I)I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(SAX2DTM2::*)(int32_t)>(&SAX2DTM2::_parent2))},
	{"_type2", "(I)I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(SAX2DTM2::*)(int32_t)>(&SAX2DTM2::_type2))},
	{"addNode", "(IIIIIZ)I", nullptr, $PROTECTED | $FINAL},
	{"charactersFlush", "()V", nullptr, $PROTECTED | $FINAL},
	{"comment", "([CII)V", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException"},
	{"copyAttribute", "(IILcom/sun/org/apache/xml/internal/serializer/SerializationHandler;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(SAX2DTM2::*)(int32_t,int32_t,$SerializationHandler*)>(&SAX2DTM2::copyAttribute)), "org.xml.sax.SAXException"},
	{"copyAttributes", "(ILcom/sun/org/apache/xml/internal/serializer/SerializationHandler;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(SAX2DTM2::*)(int32_t,$SerializationHandler*)>(&SAX2DTM2::copyAttributes)), "org.xml.sax.SAXException"},
	{"copyElement", "(IILcom/sun/org/apache/xml/internal/serializer/SerializationHandler;)Ljava/lang/String;", nullptr, $PROTECTED | $FINAL, $method(static_cast<$String*(SAX2DTM2::*)(int32_t,int32_t,$SerializationHandler*)>(&SAX2DTM2::copyElement)), "org.xml.sax.SAXException"},
	{"copyNS", "(ILcom/sun/org/apache/xml/internal/serializer/SerializationHandler;Z)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(SAX2DTM2::*)(int32_t,$SerializationHandler*,bool)>(&SAX2DTM2::copyNS)), "org.xml.sax.SAXException"},
	{"copyTextNode", "(ILcom/sun/org/apache/xml/internal/serializer/SerializationHandler;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(SAX2DTM2::*)(int32_t,$SerializationHandler*)>(&SAX2DTM2::copyTextNode)), "org.xml.sax.SAXException"},
	{"dispatchCharactersEvents", "(ILorg/xml/sax/ContentHandler;Z)V", nullptr, $PUBLIC | $FINAL, nullptr, "org.xml.sax.SAXException"},
	...
	{"getExpandedTypeID2", "(I)I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(SAX2DTM2::*)(int32_t)>(&SAX2DTM2::getExpandedTypeID2))},
	{"getFirstAttribute", "(I)I", nullptr, $PUBLIC | $FINAL},
	{"getFirstAttributeIdentity", "(I)I", nullptr, $PROTECTED},
	{"getIdForNamespace", "(Ljava/lang/String;)I", nullptr, $PUBLIC},
	{"getLocalName", "(I)Ljava/lang/String;", nullptr, $PUBLIC},
	{"getNextAttributeIdentity", "(I)I", nullptr, $PROTECTED},
	{"getNextNamespaceNode2", "(I)I", nullptr, $PROTECTED | $FINAL, $method(static_cast<int32_t(SAX2DTM2::*)(int32_t)>(&SAX2DTM2::getNextNamespaceNode2))},
	...
	{"getStringValueX", "(I)Ljava/lang/String;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$String*(SAX2DTM2::*)(int32_t)>(&SAX2DTM2::getStringValueX))},
	{"getTypedAttribute", "(II)I", nullptr, $PROTECTED | $FINAL},
