...
$MethodInfo _DefaultErrorHandler_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/io/PrintStream;)V", nullptr, $PUBLIC, $method(static_cast<void(DefaultErrorHandler::*)($PrintStream*)>(&DefaultErrorHandler::init$))},
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(DefaultErrorHandler::*)()>(&DefaultErrorHandler::init$))},
	{"<init>", "(Z)V", nullptr, $PUBLIC, $method(static_cast<void(DefaultErrorHandler::*)(bool)>(&DefaultErrorHandler::init$))},
	{"ensureLocationSet", "(Ljavax/xml/transform/TransformerException;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($TransformerException*)>(&DefaultErrorHandler::ensureLocationSet))},
	...
	{"printLocation", "(Ljava/io/PrintStream;Ljavax/xml/transform/TransformerException;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($PrintStream*,$TransformerException*)>(&DefaultErrorHandler::printLocation))},
	{"printLocation", "(Ljava/io/PrintStream;Lorg/xml/sax/SAXParseException;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($PrintStream*,$SAXParseException*)>(&DefaultErrorHandler::printLocation))},
	{"printLocation", "(Ljava/io/PrintWriter;Ljava/lang/Throwable;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($PrintWriter*,$Throwable*)>(&DefaultErrorHandler::printLocation))},
