...
$MethodInfo _LSSerializerImpl_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(LSSerializerImpl::*)()>(&LSSerializerImpl::init$))},
	...
	{"getErrorHandler", "()Lorg/w3c/dom/DOMErrorHandler;", nullptr, $PUBLIC, $method(static_cast<$DOMErrorHandler*(LSSerializerImpl::*)()>(&LSSerializerImpl::getErrorHandler))},
	{"getFilter", "()Lorg/w3c/dom/ls/LSSerializerFilter;", nullptr, $PUBLIC},
	{"getInputEncoding", "(Lorg/w3c/dom/Node;)Ljava/lang/String;", nullptr, $PROTECTED, $method(static_cast<$String*(LSSerializerImpl::*)($Node*)>(&LSSerializerImpl::getInputEncoding))},
	...
	{"getXMLEncoding", "(Lorg/w3c/dom/Node;)Ljava/lang/String;", nullptr, $PROTECTED, $method(static_cast<$String*(LSSerializerImpl::*)($Node*)>(&LSSerializerImpl::getXMLEncoding))},
	{"getXMLVersion", "(Lorg/w3c/dom/Node;)Ljava/lang/String;", nullptr, $PROTECTED, $method(static_cast<$String*(LSSerializerImpl::*)($Node*)>(&LSSerializerImpl::getXMLVersion))},
	{"initializeSerializerProps", "()V", nullptr, $PUBLIC, $method(static_cast<void(LSSerializerImpl::*)()>(&LSSerializerImpl::initializeSerializerProps))},
