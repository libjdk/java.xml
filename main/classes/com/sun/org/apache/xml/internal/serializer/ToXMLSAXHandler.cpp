...
$MethodInfo _ToXMLSAXHandler_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(ToXMLSAXHandler::*)()>(&ToXMLSAXHandler::init$))},
	{"<init>", "(Lorg/xml/sax/ContentHandler;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(ToXMLSAXHandler::*)($ContentHandler*,$String*)>(&ToXMLSAXHandler::init$))},
	{"<init>", "(Lorg/xml/sax/ContentHandler;Lorg/xml/sax/ext/LexicalHandler;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(ToXMLSAXHandler::*)($ContentHandler*,$LexicalHandler*,$String*)>(&ToXMLSAXHandler::init$))},
	...
	{"closeCDATA", "()V", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException"},
	...
	{"ensurePrefixIsDeclared", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(ToXMLSAXHandler::*)($String*,$String*)>(&ToXMLSAXHandler::ensurePrefixIsDeclared)), "org.xml.sax.SAXException"},
	...
	{"indent", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(ToXMLSAXHandler::*)(int32_t)>(&ToXMLSAXHandler::indent)), "org.xml.sax.SAXException"},
	...
	{"popNamespace", "(Ljava/lang/String;)Z", nullptr, $PROTECTED, $method(static_cast<bool(ToXMLSAXHandler::*)($String*)>(&ToXMLSAXHandler::popNamespace))},
	...
	{"resetToXMLSAXHandler", "()V", nullptr, $PRIVATE, $method(static_cast<void(ToXMLSAXHandler::*)()>(&ToXMLSAXHandler::resetToXMLSAXHandler))},
