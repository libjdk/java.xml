...
$MethodInfo _HTMLdtd_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(HTMLdtd::*)()>(&HTMLdtd::init$))},
	{"charFromName", "(Ljava/lang/String;)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)($String*)>(&HTMLdtd::charFromName))},
	{"defineBoolean", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($String*,$String*)>(&HTMLdtd::defineBoolean))},
	{"defineBoolean", "(Ljava/lang/String;[Ljava/lang/String;)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($String*,$StringArray*)>(&HTMLdtd::defineBoolean))},
	{"defineElement", "(Ljava/lang/String;I)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($String*,int32_t)>(&HTMLdtd::defineElement))},
	{"defineEntity", "(Ljava/lang/String;C)V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)($String*,char16_t)>(&HTMLdtd::defineEntity))},
	{"fromChar", "(I)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int32_t)>(&HTMLdtd::fromChar))},
	{"initialize", "()V", nullptr, $PRIVATE | $STATIC, $method(static_cast<void(*)()>(&HTMLdtd::initialize))},
	{"isBoolean", "(Ljava/lang/String;Ljava/lang/String;)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)($String*,$String*)>(&HTMLdtd::isBoolean))},
	{"isClosing", "(Ljava/lang/String;Ljava/lang/String;)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)($String*,$String*)>(&HTMLdtd::isClosing))},
	{"isElement", "(Ljava/lang/String;I)Z", nullptr, $PRIVATE | $STATIC, $method(static_cast<bool(*)($String*,int32_t)>(&HTMLdtd::isElement))},
	{"isElementContent", "(Ljava/lang/String;)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)($String*)>(&HTMLdtd::isElementContent))},
	{"isEmptyTag", "(Ljava/lang/String;)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)($String*)>(&HTMLdtd::isEmptyTag))},
	{"isOnlyOpening", "(Ljava/lang/String;)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)($String*)>(&HTMLdtd::isOnlyOpening))},
	{"isOptionalClosing", "(Ljava/lang/String;)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)($String*)>(&HTMLdtd::isOptionalClosing))},
	{"isPreserveSpace", "(Ljava/lang/String;)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)($String*)>(&HTMLdtd::isPreserveSpace))},
	{"isURI", "(Ljava/lang/String;Ljava/lang/String;)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)($String*,$String*)>(&HTMLdtd::isURI))},
	{}
};
