...
$MethodInfo _ExsltMath_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(ExsltMath::*)()>(&ExsltMath::init$))},
	{"abs", "(D)D", nullptr, $PUBLIC | $STATIC, $method(static_cast<double(*)(double)>(&ExsltMath::abs))},
	{"acos", "(D)D", nullptr, $PUBLIC | $STATIC, $method(static_cast<double(*)(double)>(&ExsltMath::acos))},
	{"asin", "(D)D", nullptr, $PUBLIC | $STATIC, $method(static_cast<double(*)(double)>(&ExsltMath::asin))},
	{"atan", "(D)D", nullptr, $PUBLIC | $STATIC, $method(static_cast<double(*)(double)>(&ExsltMath::atan))},
	{"atan2", "(DD)D", nullptr, $PUBLIC | $STATIC, $method(static_cast<double(*)(double,double)>(&ExsltMath::atan2))},
	{"constant", "(Ljava/lang/String;D)D", nullptr, $PUBLIC | $STATIC, $method(static_cast<double(*)($String*,double)>(&ExsltMath::constant))},
	{"cos", "(D)D", nullptr, $PUBLIC | $STATIC, $method(static_cast<double(*)(double)>(&ExsltMath::cos))},
	{"exp", "(D)D", nullptr, $PUBLIC | $STATIC, $method(static_cast<double(*)(double)>(&ExsltMath::exp))},
	{"highest", "(Lorg/w3c/dom/NodeList;)Lorg/w3c/dom/NodeList;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$NodeList*(*)($NodeList*)>(&ExsltMath::highest))},
	{"log", "(D)D", nullptr, $PUBLIC | $STATIC, $method(static_cast<double(*)(double)>(&ExsltMath::log))},
	{"lowest", "(Lorg/w3c/dom/NodeList;)Lorg/w3c/dom/NodeList;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$NodeList*(*)($NodeList*)>(&ExsltMath::lowest))},
	{"max", "(Lorg/w3c/dom/NodeList;)D", nullptr, $PUBLIC | $STATIC, $method(static_cast<double(*)($NodeList*)>(&ExsltMath::max))},
	{"min", "(Lorg/w3c/dom/NodeList;)D", nullptr, $PUBLIC | $STATIC, $method(static_cast<double(*)($NodeList*)>(&ExsltMath::min))},
	{"power", "(DD)D", nullptr, $PUBLIC | $STATIC, $method(static_cast<double(*)(double,double)>(&ExsltMath::power))},
	{"random", "()D", nullptr, $PUBLIC | $STATIC, $method(static_cast<double(*)()>(&ExsltMath::random))},
	{"sin", "(D)D", nullptr, $PUBLIC | $STATIC, $method(static_cast<double(*)(double)>(&ExsltMath::sin))},
	{"sqrt", "(D)D", nullptr, $PUBLIC | $STATIC, $method(static_cast<double(*)(double)>(&ExsltMath::sqrt))},
	{"tan", "(D)D", nullptr, $PUBLIC | $STATIC, $method(static_cast<double(*)(double)>(&ExsltMath::tan))},
	{}
};
