...
$MethodInfo _Pattern_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(Pattern::*)()>(&Pattern::init$))},
	{"backPatchFalseList", "(Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"backPatchTrueList", "(Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"desynthesize", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"evaluateAtCompileTime", "()Ljava/lang/Object;", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"getFalseList", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/FlowList;", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"getPriority", "()D", nullptr, $PUBLIC | $ABSTRACT},
	{"getTrueList", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/FlowList;", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"getType", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"hasLastCall", "()Z", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"hasPositionCall", "()Z", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"lookupPrimop", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SymbolTable;Ljava/lang/String;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodType;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodType;", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"startIterator", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"synthesize", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	...
	{"translateDesynthesized", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
