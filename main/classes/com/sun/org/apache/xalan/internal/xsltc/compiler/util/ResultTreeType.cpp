...
$MethodInfo _ResultTreeType_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PROTECTED, $method(static_cast<void(ResultTreeType::*)()>(&ResultTreeType::init$))},
	{"<init>", "(Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(ResultTreeType::*)($String*)>(&ResultTreeType::init$))},
	...
	{"getMethodName", "()Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(ResultTreeType::*)()>(&ResultTreeType::getMethodName))},
	{"identicalTo", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;)Z", nullptr, $PUBLIC},
	{"implementedAsMethod", "()Z", nullptr, $PUBLIC},
