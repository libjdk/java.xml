...
$MethodInfo _Sort_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(Sort::*)()>(&Sort::init$))},
	{"addVariable", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/VariableRefBase;)V", nullptr, $PUBLIC},
	{"compileExtract", "(Ljava/util/List;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/NodeSortRecordGenerator;Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Ljava/lang/String;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;", "(Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Sort;>;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/NodeSortRecordGenerator;Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Ljava/lang/String;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;", $PRIVATE | $STATIC, $method(static_cast<$MethodGenerator*(*)($List*,$NodeSortRecordGenerator*,$ConstantPoolGen*,$String*)>(&Sort::compileExtract))},
	{"compileInit", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/NodeSortRecordGenerator;Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Ljava/lang/String;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$MethodGenerator*(*)($NodeSortRecordGenerator*,$ConstantPoolGen*,$String*)>(&Sort::compileInit))},
	{"compileSortRecord", "(Ljava/util/List;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)Ljava/lang/String;", "(Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Sort;>;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)Ljava/lang/String;", $PRIVATE | $STATIC, $method(static_cast<$String*(*)($List*,$ClassGenerator*,$MethodGenerator*)>(&Sort::compileSortRecord))},
	{"compileSortRecordFactory", "(Ljava/util/List;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", "(Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Sort;>;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", $PUBLIC | $STATIC, $method(static_cast<void(*)($List*,$ClassGenerator*,$MethodGenerator*)>(&Sort::compileSortRecordFactory))},
	{"compileSortRecordFactory", "(Ljava/util/List;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;Ljava/lang/String;)Ljava/lang/String;", "(Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Sort;>;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;Ljava/lang/String;)Ljava/lang/String;", $PUBLIC | $STATIC, $method(static_cast<$String*(*)($List*,$ClassGenerator*,$MethodGenerator*,$String*)>(&Sort::compileSortRecordFactory))},
	{"getInnerClassName", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getParentClosure", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Closure;", nullptr, $PUBLIC},
	{"inInnerClass", "()Z", nullptr, $PUBLIC},
	{"parseContents", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Parser;)V", nullptr, $PUBLIC},
	{"setInnerClassName", "(Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(Sort::*)($String*)>(&Sort::setInnerClassName))},
	...
	{"translateCaseOrder", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PUBLIC, $method(static_cast<void(Sort::*)($ClassGenerator*,$MethodGenerator*)>(&Sort::translateCaseOrder))},
	{"translateLang", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PUBLIC, $method(static_cast<void(Sort::*)($ClassGenerator*,$MethodGenerator*)>(&Sort::translateLang))},
	{"translateSelect", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PUBLIC, $method(static_cast<void(Sort::*)($ClassGenerator*,$MethodGenerator*)>(&Sort::translateSelect))},
	{"translateSortIterator", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;Ljava/util/List;)V", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Sort;>;)V", $PUBLIC | $STATIC, $method(static_cast<void(*)($ClassGenerator*,$MethodGenerator*,$Expression*,$List*)>(&Sort::translateSortIterator))},
	{"translateSortOrder", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PUBLIC, $method(static_cast<void(Sort::*)($ClassGenerator*,$MethodGenerator*)>(&Sort::translateSortOrder))},
	{"translateSortType", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PUBLIC, $method(static_cast<void(Sort::*)($ClassGenerator*,$MethodGenerator*)>(&Sort::translateSortType))},
...
void Sort::parseContents($Parser* parser) {
	...
	if ($nc(val)->length() == 0) {
		try {
			$var($1Type, type, $nc(this->_select)->typeCheck($(parser->getSymbolTable())));
...
$1Type* Sort::typeCheck($SymbolTable* stable) {
	$var($1Type, tselect, $nc(this->_select)->typeCheck(stable));
	if (!($instanceOf($StringType, tselect))) {
		$init($1Type);
		$set(this, _select, $new($CastExpr, this->_select, $1Type::String));
	}
...
void Sort::translateSortIterator($ClassGenerator* classGen, $MethodGenerator* methodGen, $Expression* nodeSet, $List* sortObjects) {
	...
	if (nodeSet == nullptr) {
		...
		il->append(static_cast<$Instruction*>($$new($INVOKEINTERFACE, children, 2)));
	} else {
		$nc(nodeSet)->translate(classGen, methodGen);
	}
	$nc(nodesTemp)->setStart($($nc(il)->append(static_cast<$Instruction*>($$new($ASTORE, nodesTemp->getIndex())))));
	compileSortRecordFactory(sortObjects, classGen, methodGen);
	$nc(sortRecordFactoryTemp)->setStart($($nc(il)->append(static_cast<$Instruction*>($$new($ASTORE, sortRecordFactoryTemp->getIndex())))));
	$nc(il)->append(static_cast<$Instruction*>($$new($NEW, cpg->addClass($Constants::SORT_ITERATOR))));
	il->append(static_cast<$Instruction*>($Constants::DUP));
	nodesTemp->setEnd($(il->append(static_cast<$Instruction*>($$new($ALOAD, nodesTemp->getIndex())))));
	sortRecordFactoryTemp->setEnd($(il->append(static_cast<$Instruction*>($$new($ALOAD, sortRecordFactoryTemp->getIndex())))));
...
void Sort::compileSortRecordFactory($List* sortObjects, $ClassGenerator* classGen, $MethodGenerator* methodGen) {
	...
	$nc(sortOrderTemp)->setStart($(il->append(static_cast<$Instruction*>($$new($ASTORE, sortOrderTemp->getIndex())))));
	...
	$nc(sortTypeTemp)->setStart($(il->append(static_cast<$Instruction*>($$new($ASTORE, sortTypeTemp->getIndex())))));
	...
	$nc(sortLangTemp)->setStart($(il->append(static_cast<$Instruction*>($$new($ASTORE, sortLangTemp->getIndex())))));
	...
	$nc(sortCaseOrderTemp)->setStart($(il->append(static_cast<$Instruction*>($$new($ASTORE, sortCaseOrderTemp->getIndex())))));
	il->append(static_cast<$Instruction*>($$new($NEW, $nc(cpg)->addClass(sortRecordFactoryClass))));
	il->append(static_cast<$Instruction*>($Constants::DUP));
	il->append($(methodGen->loadDOM()));
	il->append(static_cast<$CompoundInstruction*>($$new($PUSH, cpg, sortRecordClass)));
	il->append($(classGen->loadTranslet()));
	sortOrderTemp->setEnd($(il->append(static_cast<$Instruction*>($$new($ALOAD, sortOrderTemp->getIndex())))));
	sortTypeTemp->setEnd($(il->append(static_cast<$Instruction*>($$new($ALOAD, sortTypeTemp->getIndex())))));
	sortLangTemp->setEnd($(il->append(static_cast<$Instruction*>($$new($ALOAD, sortLangTemp->getIndex())))));
	sortCaseOrderTemp->setEnd($(il->append(static_cast<$Instruction*>($$new($ALOAD, sortCaseOrderTemp->getIndex())))));
	il->append(static_cast<$Instruction*>($$new($INVOKESPECIAL, $nc(cpg)->addMethodref(sortRecordFactoryClass, "<init>"_s, $$str({"("_s, $Constants::DOM_INTF_SIG, $Constants::STRING_SIG, $Constants::TRANSLET_INTF_SIG, "["_s, $Constants::STRING_SIG, "["_s, $Constants::STRING_SIG, "["_s, $Constants::STRING_SIG, "["_s, $Constants::STRING_SIG, ")V"_s})))));
	...
	for (int32_t j = 0; j < nsorts; ++j) {
		...
		for (int32_t i = 0; i < length; ++i) {
			...
			il->append(static_cast<$Instruction*>($$new($PUTFIELD, $nc(cpg)->addFieldref(var$0, var$1, $($nc($(var->getType()))->toSignature())))));
			dups->add(varRef);
		}
	}
}
...
$String* Sort::compileSortRecordFactory($List* sortObjects, $ClassGenerator* classGen, $MethodGenerator* methodGen, $String* sortRecordClass) {
	...
	$init($Type);
	$var($MethodGenerator, constructor, $new($MethodGenerator, $Constants::ACC_PUBLIC, $Type::VOID, argTypes, argNames, "<init>"_s, className, il, cpg));
	...
	il->append(static_cast<$Instruction*>($$new($ALOAD, 4)));
	il->append(static_cast<$Instruction*>($$new($ALOAD, 5)));
	il->append(static_cast<$Instruction*>($$new($ALOAD, 6)));
	il->append(static_cast<$Instruction*>($$new($ALOAD, 7)));
	il->append(static_cast<$Instruction*>($$new($INVOKESPECIAL, $nc(cpg)->addMethodref($Constants::NODE_SORT_FACTORY, "<init>"_s, $$str({"("_s, $Constants::DOM_INTF_SIG, $Constants::STRING_SIG, $Constants::TRANSLET_INTF_SIG, "["_s, $Constants::STRING_SIG, "["_s, $Constants::STRING_SIG, "["_s, $Constants::STRING_SIG, "["_s, $Constants::STRING_SIG, ")V"_s})))));
	...
	il->append(static_cast<$Instruction*>($Constants::ALOAD_0));
	il->append(static_cast<$Instruction*>($Constants::ILOAD_1));
	il->append(static_cast<$Instruction*>($Constants::ILOAD_2));
	il->append(static_cast<$Instruction*>($$new($INVOKESPECIAL, $nc(cpg)->addMethodref($Constants::NODE_SORT_FACTORY, "makeNodeSortRecord"_s, $$str({"(II)"_s, $Constants::NODE_SORT_RECORD_SIG})))));
	il->append(static_cast<$Instruction*>($Constants::DUP));
	il->append(static_cast<$Instruction*>($$new($CHECKCAST, $nc(cpg)->addClass(sortRecordClass))));
	...
	for (int32_t i = 0; i < ndups; ++i) {
		...
		il->append(static_cast<$Instruction*>($$new($GETFIELD, $nc(cpg)->addFieldref(var$3, var$4, $($nc(varType)->toSignature())))));
		$var($String, var$5, sortRecordClass);
		$var($String, var$6, var->getEscapedName());
		il->append(static_cast<$Instruction*>($$new($PUTFIELD, $nc(cpg)->addFieldref(var$5, var$6, $($nc(varType)->toSignature())))));
	}
	il->append(static_cast<$Instruction*>($Constants::POP));
	il->append(static_cast<$Instruction*>($Constants::ARETURN));
...
$MethodGenerator* Sort::compileInit($NodeSortRecordGenerator* sortRecord, $ConstantPoolGen* cpg, $String* className) {
	...
	$init($Constants);
	il->append(static_cast<$Instruction*>($Constants::ALOAD_0));
	il->append(static_cast<$Instruction*>($$new($INVOKESPECIAL, $nc(cpg)->addMethodref($Constants::NODE_SORT_RECORD, "<init>"_s, "()V"_s))));
	il->append(static_cast<$Instruction*>($Constants::RETURN));
	return init;
}
...
$MethodGenerator* Sort::compileExtract($List* sortObjects, $NodeSortRecordGenerator* sortRecord, $ConstantPoolGen* cpg, $String* className) {
	...
	if (levels > 1) {
		il->append(static_cast<$Instruction*>($$new($ILOAD, extractMethod->getLocalIndex("level"_s))));
		$assign(tblswitch, il->append(static_cast<$Instruction*>($$new($NOP))));
	}
