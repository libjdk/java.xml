...
$MethodInfo Stylesheet$$Lambda$lambda$processModes$0::methodInfos[3] = {
	{"<init>", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Stylesheet;)V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet$$Lambda$lambda$processModes$0::*)(Stylesheet*)>(&Stylesheet$$Lambda$lambda$processModes$0::init$))},
...
$MethodInfo Stylesheet$$Lambda$lambda$compileModes$1$1::methodInfos[3] = {
	{"<init>", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;)V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet$$Lambda$lambda$compileModes$1$1::*)($ClassGenerator*)>(&Stylesheet$$Lambda$lambda$compileModes$1$1::init$))},
	{"accept", "(Ljava/lang/Object;)V", nullptr, $PUBLIC},
	{}
};
...
$MethodInfo _Stylesheet_MethodInfo_[] = {
	...
	{"addDOMField", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;)V", nullptr, $PRIVATE, $method(static_cast<void(Stylesheet::*)($ClassGenerator*)>(&Stylesheet::addDOMField))},
	{"addIncludedStylesheet", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Stylesheet;)V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)(Stylesheet*)>(&Stylesheet::addIncludedStylesheet))},
	{"addParam", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Param;)I", nullptr, $PUBLIC, $method(static_cast<int32_t(Stylesheet::*)($Param*)>(&Stylesheet::addParam))},
	{"addPrefixMapping", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PROTECTED},
	{"addStaticField", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(Stylesheet::*)($ClassGenerator*,$String*,$String*)>(&Stylesheet::addStaticField))},
	{"addTemplate", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Template;)V", nullptr, $PROTECTED, $method(static_cast<void(Stylesheet::*)($Template*)>(&Stylesheet::addTemplate))},
	{"addVariable", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Variable;)I", nullptr, $PUBLIC, $method(static_cast<int32_t(Stylesheet::*)($Variable*)>(&Stylesheet::addVariable))},
	{"callsNodeset", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Stylesheet::*)()>(&Stylesheet::callsNodeset))},
	{"checkForLoop", "(Ljava/lang/String;)Z", nullptr, $PUBLIC, $method(static_cast<bool(Stylesheet::*)($String*)>(&Stylesheet::checkForLoop))},
	{"checkOutputMethod", "()V", nullptr, $PRIVATE, $method(static_cast<void(Stylesheet::*)()>(&Stylesheet::checkOutputMethod))},
	{"compileBuildKeys", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;)Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(Stylesheet::*)($ClassGenerator*)>(&Stylesheet::compileBuildKeys))},
	{"compileConstructor", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Output;)V", nullptr, $PRIVATE, $method(static_cast<void(Stylesheet::*)($ClassGenerator*,$Output*)>(&Stylesheet::compileConstructor))},
	{"compileModes", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;)V", nullptr, $PRIVATE, $method(static_cast<void(Stylesheet::*)($ClassGenerator*)>(&Stylesheet::compileModes))},
	{"compileStaticInitializer", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;)V", nullptr, $PRIVATE, $method(static_cast<void(Stylesheet::*)($ClassGenerator*)>(&Stylesheet::compileStaticInitializer))},
	{"compileTopLevel", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;)Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(Stylesheet::*)($ClassGenerator*)>(&Stylesheet::compileTopLevel))},
	{"compileTransform", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;)V", nullptr, $PRIVATE, $method(static_cast<void(Stylesheet::*)($ClassGenerator*)>(&Stylesheet::compileTransform))},
	{"declareExtensionPrefixes", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Parser;)V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)($Parser*)>(&Stylesheet::declareExtensionPrefixes))},
	{"display", "(I)V", nullptr, $PUBLIC},
	{"extensionURI", "(Ljava/lang/String;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SymbolTable;)V", nullptr, $PRIVATE, $method(static_cast<void(Stylesheet::*)($String*,$SymbolTable*)>(&Stylesheet::extensionURI))},
	{"getAllValidTemplates", "()Ljava/util/List;", "()Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Template;>;", $PUBLIC, $method(static_cast<$List*(Stylesheet::*)()>(&Stylesheet::getAllValidTemplates))},
	{"getClassName", "()Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(Stylesheet::*)()>(&Stylesheet::getClassName))},
	{"getImportPrecedence", "()I", nullptr, $PUBLIC},
	{"getLastOutputElement", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Output;", nullptr, $PUBLIC, $method(static_cast<$Output*(Stylesheet::*)()>(&Stylesheet::getLastOutputElement))},
	{"getMinimumDescendantPrecedence", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(Stylesheet::*)()>(&Stylesheet::getMinimumDescendantPrecedence))},
	{"getMode", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Mode;", nullptr, $PUBLIC, $method(static_cast<$Mode*(Stylesheet::*)($QName*)>(&Stylesheet::getMode))},
	{"getNamespace", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(Stylesheet::*)($String*)>(&Stylesheet::getNamespace))},
	{"getOutputMethod", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(Stylesheet::*)()>(&Stylesheet::getOutputMethod))},
	{"getOutputProperties", "()Ljava/util/Properties;", nullptr, $PUBLIC, $method(static_cast<$Properties*(Stylesheet::*)()>(&Stylesheet::getOutputProperties))},
	{"getParentStylesheet", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Stylesheet;", nullptr, $PUBLIC, $method(static_cast<Stylesheet*(Stylesheet::*)()>(&Stylesheet::getParentStylesheet))},
	{"getSourceLoader", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SourceLoader;", nullptr, $PUBLIC, $method(static_cast<$SourceLoader*(Stylesheet::*)()>(&Stylesheet::getSourceLoader))},
	{"getSystemId", "()Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(Stylesheet::*)()>(&Stylesheet::getSystemId))},
	{"getTemplateInlining", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Stylesheet::*)()>(&Stylesheet::getTemplateInlining))},
	{"getTemplates", "()Ljava/util/List;", "()Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Template;>;", $PUBLIC, $method(static_cast<$List*(Stylesheet::*)()>(&Stylesheet::getTemplates))},
	{"hasGlobals", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Stylesheet::*)()>(&Stylesheet::hasGlobals))},
	{"hasLocalParams", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Stylesheet::*)()>(&Stylesheet::hasLocalParams))},
	{"isExtension", "(Ljava/lang/String;)Z", nullptr, $PUBLIC, $method(static_cast<bool(Stylesheet::*)($String*)>(&Stylesheet::isExtension))},
	{"isMultiDocument", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Stylesheet::*)()>(&Stylesheet::isMultiDocument))},
	{"isSimplified", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Stylesheet::*)()>(&Stylesheet::isSimplified))},
	{"lambda$compileModes$1", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Mode;)V", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<void(*)($ClassGenerator*,$Mode*)>(&Stylesheet::lambda$compileModes$1))},
	{"lambda$processModes$0", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Mode;)V", nullptr, $PRIVATE | $SYNTHETIC, $method(static_cast<void(Stylesheet::*)($Mode*)>(&Stylesheet::lambda$processModes$0))},
	{"makeStylesheetName", "(Ljava/lang/String;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;", nullptr, $PRIVATE, $method(static_cast<$QName*(Stylesheet::*)($String*)>(&Stylesheet::makeStylesheetName))},
	{"numberFormattingUsed", "()V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)()>(&Stylesheet::numberFormattingUsed))},
	{"parseContents", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Parser;)V", nullptr, $PUBLIC},
	{"parseOwnChildren", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Parser;)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(Stylesheet::*)($Parser*)>(&Stylesheet::parseOwnChildren))},
	{"peepHoleOptimization", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PRIVATE, $method(static_cast<void(Stylesheet::*)($MethodGenerator*)>(&Stylesheet::peepHoleOptimization))},
	{"processModes", "()V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)()>(&Stylesheet::processModes))},
	{"resolveDependencies", "(Ljava/util/List;)Ljava/util/List;", "(Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;>;)Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;>;", $PRIVATE, $method(static_cast<$List*(Stylesheet::*)($List*)>(&Stylesheet::resolveDependencies))},
	{"setCallsNodeset", "(Z)V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)(bool)>(&Stylesheet::setCallsNodeset))},
	{"setHasIdCall", "(Z)V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)(bool)>(&Stylesheet::setHasIdCall))},
	{"setImportPrecedence", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)(int32_t)>(&Stylesheet::setImportPrecedence))},
	{"setImportingStylesheet", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Stylesheet;)V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)(Stylesheet*)>(&Stylesheet::setImportingStylesheet))},
	{"setIncludingStylesheet", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Stylesheet;)V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)(Stylesheet*)>(&Stylesheet::setIncludingStylesheet))},
	{"setMultiDocument", "(Z)V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)(bool)>(&Stylesheet::setMultiDocument))},
	{"setOutputProperties", "(Ljava/util/Properties;)V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)($Properties*)>(&Stylesheet::setOutputProperties))},
	{"setOutputProperty", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)($String*,$String*)>(&Stylesheet::setOutputProperty))},
	{"setParentStylesheet", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Stylesheet;)V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)(Stylesheet*)>(&Stylesheet::setParentStylesheet))},
	{"setParser", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Parser;)V", nullptr, $PUBLIC},
	{"setSimplified", "()V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)()>(&Stylesheet::setSimplified))},
	{"setSourceLoader", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SourceLoader;)V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)($SourceLoader*)>(&Stylesheet::setSourceLoader))},
	{"setSystemId", "(Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)($String*)>(&Stylesheet::setSystemId))},
	{"setTemplateInlining", "(Z)V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)(bool)>(&Stylesheet::setTemplateInlining))},
	...
	{"translate", "()V", nullptr, $PUBLIC, $method(static_cast<void(Stylesheet::*)()>(&Stylesheet::translate))},
