...
$MethodInfo _FunctionCall_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;Ljava/util/List;)V", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;>;)V", $PUBLIC, $method(static_cast<void(FunctionCall::*)($QName*,$List*)>(&FunctionCall::init$))},
	{"<init>", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;)V", nullptr, $PUBLIC, $method(static_cast<void(FunctionCall::*)($QName*)>(&FunctionCall::init$))},
	{"argument", "(I)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;", nullptr, $PROTECTED | $FINAL, $method(static_cast<$Expression*(FunctionCall::*)(int32_t)>(&FunctionCall::argument))},
	{"argument", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;", nullptr, $PROTECTED | $FINAL, $method(static_cast<$Expression*(FunctionCall::*)()>(&FunctionCall::argument))},
	{"argumentCount", "()I", nullptr, $PROTECTED | $FINAL, $method(static_cast<int32_t(FunctionCall::*)()>(&FunctionCall::argumentCount))},
	{"findConstructors", "()Ljava/util/List;", "()Ljava/util/List<Ljava/lang/reflect/Constructor<*>;>;", $PRIVATE, $method(static_cast<$List*(FunctionCall::*)()>(&FunctionCall::findConstructors))},
	{"findMethods", "()Ljava/util/List;", "()Ljava/util/List<Ljava/lang/reflect/Method;>;", $PRIVATE, $method(static_cast<$List*(FunctionCall::*)()>(&FunctionCall::findMethods))},
	{"generateAddReads", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(FunctionCall::*)($ClassGenerator*,$MethodGenerator*,$String*)>(&FunctionCall::generateAddReads))},
	{"getClassNameFromUri", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PUBLIC},
	{"getMethodSignature", "(Ljava/util/List;)Ljava/lang/String;", "(Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;>;)Ljava/lang/String;", $PRIVATE, $method(static_cast<$String*(FunctionCall::*)($List*)>(&FunctionCall::getMethodSignature))},
	{"getName", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getSignature", "(Ljava/lang/Class;)Ljava/lang/String;", "(Ljava/lang/Class<*>;)Ljava/lang/String;", $STATIC | $FINAL, $method(static_cast<$String*(*)($Class*)>(&FunctionCall::getSignature))},
	{"getSignature", "(Ljava/lang/reflect/Method;)Ljava/lang/String;", nullptr, $STATIC | $FINAL, $method(static_cast<$String*(*)($Method*)>(&FunctionCall::getSignature))},
	{"getSignature", "(Ljava/lang/reflect/Constructor;)Ljava/lang/String;", "(Ljava/lang/reflect/Constructor<*>;)Ljava/lang/String;", $STATIC | $FINAL, $method(static_cast<$String*(*)($Constructor*)>(&FunctionCall::getSignature))},
	{"isExtension", "()Z", nullptr, $PUBLIC},
	{"isStandard", "()Z", nullptr, $PUBLIC},
	{"replaceDash", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PROTECTED | $STATIC, $method(static_cast<$String*(*)($String*)>(&FunctionCall::replaceDash))},
	{"setArgument", "(ILcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(FunctionCall::*)(int32_t,$Expression*)>(&FunctionCall::setArgument))},
	...
	{"translateUnallowedExtension", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Lcom/sun/org/apache/bcel/internal/generic/InstructionList;)V", nullptr, $PRIVATE, $method(static_cast<void(FunctionCall::*)($ConstantPoolGen*,$InstructionList*)>(&FunctionCall::translateUnallowedExtension))},
	...
	{"typeCheckArgs", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SymbolTable;)Ljava/util/List;", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SymbolTable;)Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;>;", $PUBLIC, nullptr, "com.sun.org.apache.xalan.internal.xsltc.compiler.util.TypeCheckError"},
	{"typeCheckConstructor", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SymbolTable;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;", nullptr, $PUBLIC, nullptr, "com.sun.org.apache.xalan.internal.xsltc.compiler.util.TypeCheckError"},
	{"typeCheckExternal", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SymbolTable;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;", nullptr, $PUBLIC, nullptr, "com.sun.org.apache.xalan.internal.xsltc.compiler.util.TypeCheckError"},
	{"typeCheckStandard", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SymbolTable;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;", nullptr, $PUBLIC, nullptr, "com.sun.org.apache.xalan.internal.xsltc.compiler.util.TypeCheckError"},
	{}
};
