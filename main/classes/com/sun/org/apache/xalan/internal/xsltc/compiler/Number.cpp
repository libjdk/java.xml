...
$MethodInfo _Number_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(Number::*)()>(&Number::init$))},
	{"addVariable", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/VariableRefBase;)V", nullptr, $PUBLIC},
	{"compileConstructor", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;)V", nullptr, $PRIVATE, $method(static_cast<void(Number::*)($ClassGenerator*)>(&Number::compileConstructor))},
	{"compileDefault", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PRIVATE, $method(static_cast<void(Number::*)($ClassGenerator*,$MethodGenerator*)>(&Number::compileDefault))},
	{"compileLocals", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/NodeCounterGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MatchGenerator;Lcom/sun/org/apache/bcel/internal/generic/InstructionList;)V", nullptr, $PRIVATE, $method(static_cast<void(Number::*)($NodeCounterGenerator*,$MatchGenerator*,$InstructionList*)>(&Number::compileLocals))},
	{"compilePatterns", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PRIVATE, $method(static_cast<void(Number::*)($ClassGenerator*,$MethodGenerator*)>(&Number::compilePatterns))},
	...
	{"hasValue", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Number::*)()>(&Number::hasValue))},
	{"inInnerClass", "()Z", nullptr, $PUBLIC},
	{"isDefault", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Number::*)()>(&Number::isDefault))},
