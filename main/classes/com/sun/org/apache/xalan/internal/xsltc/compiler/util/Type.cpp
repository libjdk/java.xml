...
$MethodInfo _Type_MethodInfo_[] = {
	...
	{"identicalTo", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;)Z", nullptr, $PUBLIC | $ABSTRACT},
	{"implementedAsMethod", "()Z", nullptr, $PUBLIC},
	{"isNumber", "()Z", nullptr, $PUBLIC},
	{"isSimple", "()Z", nullptr, $PUBLIC},
	{"newObjectType", "(Ljava/lang/String;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Type*(*)($String*)>(&Type::newObjectType))},
	{"newObjectType", "(Ljava/lang/Class;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;", "(Ljava/lang/Class<*>;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;", $PUBLIC | $STATIC, $method(static_cast<Type*(*)($Class*)>(&Type::newObjectType))},
	{"toJCType", "()Lcom/sun/org/apache/bcel/internal/generic/Type;", nullptr, $PUBLIC | $ABSTRACT},
	{"toSignature", "()Ljava/lang/String;", nullptr, $PUBLIC | $ABSTRACT},
	...
	{"translateToDesynthesized", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/FlowList;", nullptr, $PUBLIC},
