...
$MethodInfo _ErrorMsg_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(ErrorMsg::*)($String*)>(&ErrorMsg::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V", nullptr, $PUBLIC, $method(static_cast<void(ErrorMsg::*)($String*,$Throwable*)>(&ErrorMsg::init$))},
	{"<init>", "(Ljava/lang/String;I)V", nullptr, $PUBLIC, $method(static_cast<void(ErrorMsg::*)($String*,int32_t)>(&ErrorMsg::init$))},
	{"<init>", "(Ljava/lang/String;ILjava/lang/Object;)V", nullptr, $PUBLIC, $method(static_cast<void(ErrorMsg::*)($String*,int32_t,Object$*)>(&ErrorMsg::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/Object;)V", nullptr, $PUBLIC, $method(static_cast<void(ErrorMsg::*)($String*,Object$*)>(&ErrorMsg::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V", nullptr, $PUBLIC, $method(static_cast<void(ErrorMsg::*)($String*,Object$*,Object$*)>(&ErrorMsg::init$))},
	{"<init>", "(Ljava/lang/String;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;)V", nullptr, $PUBLIC, $method(static_cast<void(ErrorMsg::*)($String*,$SyntaxTreeNode*)>(&ErrorMsg::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/Object;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;)V", nullptr, $PUBLIC, $method(static_cast<void(ErrorMsg::*)($String*,Object$*,$SyntaxTreeNode*)>(&ErrorMsg::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;)V", nullptr, $PUBLIC, $method(static_cast<void(ErrorMsg::*)($String*,Object$*,Object$*,$SyntaxTreeNode*)>(&ErrorMsg::init$))},
	{"formatLine", "()Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(ErrorMsg::*)()>(&ErrorMsg::formatLine))},
	{"getCause", "()Ljava/lang/Throwable;", nullptr, $PUBLIC, $method(static_cast<$Throwable*(ErrorMsg::*)()>(&ErrorMsg::getCause))},
	{"getErrorMessage", "()Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(ErrorMsg::*)()>(&ErrorMsg::getErrorMessage))},
	{"getFileName", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;)Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(ErrorMsg::*)($SyntaxTreeNode*)>(&ErrorMsg::getFileName))},
	{"isWarningError", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(ErrorMsg::*)()>(&ErrorMsg::isWarningError))},
	{"setWarningError", "(Z)V", nullptr, $PUBLIC, $method(static_cast<void(ErrorMsg::*)(bool)>(&ErrorMsg::setWarningError))},
	{"toString", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"toString", "(Ljava/lang/Object;)Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(ErrorMsg::*)(Object$*)>(&ErrorMsg::toString))},
	{"toString", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(ErrorMsg::*)(Object$*,Object$*)>(&ErrorMsg::toString))},
	{}
};
