...
$MethodInfo _Predicate_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;)V", nullptr, $PUBLIC, $method(static_cast<void(Predicate::*)($Expression*)>(&Predicate::init$))},
	{"addVariable", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/VariableRefBase;)V", nullptr, $PUBLIC},
	{"compileFilter", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PRIVATE, $method(static_cast<void(Predicate::*)($ClassGenerator*,$MethodGenerator*)>(&Predicate::compileFilter))},
	{"dontOptimize", "()V", nullptr, $PUBLIC, $method(static_cast<void(Predicate::*)()>(&Predicate::dontOptimize))},
	{"getCompareValue", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;", nullptr, $PUBLIC, $method(static_cast<$Expression*(Predicate::*)()>(&Predicate::getCompareValue))},
	{"getExpr", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;", nullptr, $PUBLIC, $method(static_cast<$Expression*(Predicate::*)()>(&Predicate::getExpr))},
	...
	{"getPosType", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(Predicate::*)()>(&Predicate::getPosType))},
	{"getStep", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Step;", nullptr, $PUBLIC, $method(static_cast<$Step*(Predicate::*)()>(&Predicate::getStep))},
	{"hasLastCall", "()Z", nullptr, $PUBLIC},
	{"hasPositionCall", "()Z", nullptr, $PUBLIC},
	{"inInnerClass", "()Z", nullptr, $PUBLIC},
	{"isBooleanTest", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Predicate::*)()>(&Predicate::isBooleanTest))},
	{"isNodeValueTest", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Predicate::*)()>(&Predicate::isNodeValueTest))},
	{"isNthDescendant", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Predicate::*)()>(&Predicate::isNthDescendant))},
	{"isNthPositionFilter", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Predicate::*)()>(&Predicate::isNthPositionFilter))},
	{"parentIsPattern", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Predicate::*)()>(&Predicate::parentIsPattern))},
	...
	{"translateFilter", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PUBLIC, $method(static_cast<void(Predicate::*)($ClassGenerator*,$MethodGenerator*)>(&Predicate::translateFilter))},
