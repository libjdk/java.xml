...
$MethodInfo _Template_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(Template::*)()>(&Template::init$))},
	{"addDependency", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/TopLevelElement;)V", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"addParameter", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Param;)V", nullptr, $PUBLIC, $method(static_cast<void(Template::*)($Param*)>(&Template::addParameter))},
	{"compareTo", "(Ljava/lang/Object;)I", nullptr, $PUBLIC, $method(static_cast<int32_t(Template::*)(Object$*)>(&Template::compareTo))},
	{"compile", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)Lcom/sun/org/apache/bcel/internal/generic/InstructionList;", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"disable", "()V", nullptr, $PUBLIC, $method(static_cast<void(Template::*)()>(&Template::disable))},
	{"disabled", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Template::*)()>(&Template::disabled))},
	{"display", "(I)V", nullptr, $PUBLIC},
	{"getDependencies", "()Ljava/util/List;", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"getModeName", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;", nullptr, $PUBLIC, $method(static_cast<$QName*(Template::*)()>(&Template::getModeName))},
	{"getName", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;", nullptr, $PUBLIC, $method(static_cast<$QName*(Template::*)()>(&Template::getName))},
	{"getParameters", "()Ljava/util/List;", "()Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Param;>;", $PUBLIC, $method(static_cast<$List*(Template::*)()>(&Template::getParameters))},
	{"getPattern", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Pattern;", nullptr, $PUBLIC, $method(static_cast<$Pattern*(Template::*)()>(&Template::getPattern))},
	{"getPosition", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(Template::*)()>(&Template::getPosition))},
	{"getPriority", "()D", nullptr, $PUBLIC, $method(static_cast<double(Template::*)()>(&Template::getPriority))},
	{"getStylesheet", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Stylesheet;", nullptr, $PUBLIC},
	{"hasParams", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Template::*)()>(&Template::hasParams))},
	{"isNamed", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Template::*)()>(&Template::isNamed))},
	{"isSimpleNamedTemplate", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Template::*)()>(&Template::isSimpleNamedTemplate))},
	{"isSimplified", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Template::*)()>(&Template::isSimplified))},
	{"parseContents", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Parser;)V", nullptr, $PUBLIC},
	{"parseSimplified", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Stylesheet;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Parser;)V", nullptr, $PUBLIC, $method(static_cast<void(Template::*)($Stylesheet*,$Parser*)>(&Template::parseSimplified))},
	{"resolveNamedTemplates", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Template;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Parser;)Z", nullptr, $PRIVATE, $method(static_cast<bool(Template::*)(Template*,$Parser*)>(&Template::resolveNamedTemplates))},
	{"setName", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;)V", nullptr, $PUBLIC, $method(static_cast<void(Template::*)($QName*)>(&Template::setName))},
	{"setSimplified", "()V", nullptr, $PUBLIC, $method(static_cast<void(Template::*)()>(&Template::setSimplified))},
