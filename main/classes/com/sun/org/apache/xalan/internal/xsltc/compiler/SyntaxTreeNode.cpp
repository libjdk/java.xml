...
$MethodInfo SyntaxTreeNode$$Lambda$lambda$isSimpleRTF$0::methodInfos[3] = {
	{"<init>", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;)V", nullptr, $PUBLIC, $method(static_cast<void(SyntaxTreeNode$$Lambda$lambda$isSimpleRTF$0::*)(SyntaxTreeNode*)>(&SyntaxTreeNode$$Lambda$lambda$isSimpleRTF$0::init$))},
...
$MethodInfo _SyntaxTreeNode_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(SyntaxTreeNode::*)()>(&SyntaxTreeNode::init$))},
	{"<init>", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(SyntaxTreeNode::*)(int32_t)>(&SyntaxTreeNode::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(SyntaxTreeNode::*)($String*,$String*,$String*)>(&SyntaxTreeNode::init$))},
	{"addAttribute", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PROTECTED},
	{"addElement", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(SyntaxTreeNode::*)(SyntaxTreeNode*)>(&SyntaxTreeNode::addElement))},
	{"addPrefixMapping", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PROTECTED},
	{"compileResultTree", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PROTECTED},
	{"contextDependent", "()Z", nullptr, $PROTECTED},
	{"dependentContents", "()Z", nullptr, $PROTECTED},
	{"display", "(I)V", nullptr, $PUBLIC},
	{"displayContents", "(I)V", nullptr, $PROTECTED},
	{"elementAt", "(I)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;", nullptr, $PROTECTED | $FINAL, $method(static_cast<SyntaxTreeNode*(SyntaxTreeNode::*)(int32_t)>(&SyntaxTreeNode::elementAt))},
	{"elementCount", "()I", nullptr, $PROTECTED | $FINAL, $method(static_cast<int32_t(SyntaxTreeNode::*)()>(&SyntaxTreeNode::elementCount))},
	{"elements", "()Ljava/util/Iterator;", "()Ljava/util/Iterator<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;>;", $PROTECTED | $FINAL, $method(static_cast<$Iterator*(SyntaxTreeNode::*)()>(&SyntaxTreeNode::elements))},
	{"getAttribute", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PROTECTED},
	{"getAttribute", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", nullptr, $PROTECTED},
	{"getAttributes", "()Lorg/xml/sax/Attributes;", nullptr, $PROTECTED},
	{"getContents", "()Ljava/util/List;", "()Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;>;", $PROTECTED | $FINAL, $method(static_cast<$List*(SyntaxTreeNode::*)()>(&SyntaxTreeNode::getContents))},
	{"getImportPrecedence", "()I", nullptr, $PROTECTED},
	{"getLineNumber", "()I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(SyntaxTreeNode::*)()>(&SyntaxTreeNode::getLineNumber))},
	{"getParent", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;", nullptr, $PROTECTED | $FINAL, $method(static_cast<SyntaxTreeNode*(SyntaxTreeNode::*)()>(&SyntaxTreeNode::getParent))},
	{"getParser", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Parser;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$Parser*(SyntaxTreeNode::*)()>(&SyntaxTreeNode::getParser))},
	{"getPrefixMapping", "()Ljava/util/Map;", "()Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;", $PROTECTED},
	{"getQName", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;", nullptr, $PROTECTED},
	{"getStylesheet", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Stylesheet;", nullptr, $PUBLIC},
	{"getSymbolTable", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SymbolTable;", nullptr, $PROTECTED | $FINAL, $method(static_cast<$SymbolTable*(SyntaxTreeNode::*)()>(&SyntaxTreeNode::getSymbolTable))},
	{"getTemplate", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Template;", nullptr, $PROTECTED},
	{"getXSLTC", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/XSLTC;", nullptr, $PROTECTED | $FINAL, $method(static_cast<$XSLTC*(SyntaxTreeNode::*)()>(&SyntaxTreeNode::getXSLTC))},
	{"hasAttribute", "(Ljava/lang/String;)Z", nullptr, $PROTECTED},
	{"hasContents", "()Z", nullptr, $PROTECTED | $FINAL, $method(static_cast<bool(SyntaxTreeNode::*)()>(&SyntaxTreeNode::hasContents))},
	{"indent", "(I)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(SyntaxTreeNode::*)(int32_t)>(&SyntaxTreeNode::indent))},
	{"isAdaptiveRTF", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;)Z", nullptr, $PRIVATE, $method(static_cast<bool(SyntaxTreeNode::*)(SyntaxTreeNode*)>(&SyntaxTreeNode::isAdaptiveRTF))},
	{"isDummy", "()Z", nullptr, $PROTECTED | $FINAL, $method(static_cast<bool(SyntaxTreeNode::*)()>(&SyntaxTreeNode::isDummy))},
	{"isSimpleRTF", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;)Z", nullptr, $PRIVATE, $method(static_cast<bool(SyntaxTreeNode::*)(SyntaxTreeNode*)>(&SyntaxTreeNode::isSimpleRTF))},
	{"isTextElement", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;Z)Z", nullptr, $PRIVATE, $method(static_cast<bool(SyntaxTreeNode::*)(SyntaxTreeNode*,bool)>(&SyntaxTreeNode::isTextElement))},
	{"lambda$isSimpleRTF$0", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;)Z", nullptr, $PRIVATE | $SYNTHETIC, $method(static_cast<bool(SyntaxTreeNode::*)(SyntaxTreeNode*)>(&SyntaxTreeNode::lambda$isSimpleRTF$0))},
	{"lastChild", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;", nullptr, $PROTECTED | $FINAL, $method(static_cast<SyntaxTreeNode*(SyntaxTreeNode::*)()>(&SyntaxTreeNode::lastChild))},
	{"lookupNamespace", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PROTECTED},
	{"lookupPrefix", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PROTECTED},
	{"notTypeOf", "(Ljava/lang/Class;)Z", "(Ljava/lang/Class<*>;)Z", $PUBLIC},
	{"parseChildren", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Parser;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(SyntaxTreeNode::*)($Parser*)>(&SyntaxTreeNode::parseChildren))},
	{"parseContents", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Parser;)V", nullptr, $PUBLIC},
	{"removeElement", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(SyntaxTreeNode::*)(SyntaxTreeNode*)>(&SyntaxTreeNode::removeElement))},
	{"reportError", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Parser;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PROTECTED},
	{"reportWarning", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Parser;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PROTECTED},
	{"setAttributes", "(Lorg/xml/sax/helpers/AttributesImpl;)V", nullptr, $PROTECTED},
	{"setFirstElement", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(SyntaxTreeNode::*)(SyntaxTreeNode*)>(&SyntaxTreeNode::setFirstElement))},
	{"setLineNumber", "(I)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(SyntaxTreeNode::*)(int32_t)>(&SyntaxTreeNode::setLineNumber))},
	{"setParent", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;)V", nullptr, $PROTECTED},
	{"setParser", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Parser;)V", nullptr, $PROTECTED},
	{"setPrefixMapping", "(Ljava/util/Map;)V", "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;)V", $PROTECTED},
	{"setQName", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;)V", nullptr, $PROTECTED},
	{"setQName", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PROTECTED},
	...
	{"translateContents", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PROTECTED},
	{"typeCheck", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SymbolTable;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;", nullptr, $PUBLIC | $ABSTRACT, nullptr, "com.sun.org.apache.xalan.internal.xsltc.compiler.util.TypeCheckError"},
	{"typeCheckContents", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SymbolTable;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/Type;", nullptr, $PROTECTED, nullptr, "com.sun.org.apache.xalan.internal.xsltc.compiler.util.TypeCheckError"},
	{"updateScope", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Parser;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/SyntaxTreeNode;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;", nullptr, $PROTECTED},
	{}
};
