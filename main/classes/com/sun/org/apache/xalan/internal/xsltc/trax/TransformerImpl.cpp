...
$MethodInfo _TransformerImpl_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/Properties;ILcom/sun/org/apache/xalan/internal/xsltc/trax/TransformerFactoryImpl;)V", nullptr, $PROTECTED, $method(static_cast<void(TransformerImpl::*)($Properties*,int32_t,$TransformerFactoryImpl*)>(&TransformerImpl::init$))},
	{"<init>", "(Lcom/sun/org/apache/xalan/internal/xsltc/Translet;Ljava/util/Properties;ILcom/sun/org/apache/xalan/internal/xsltc/trax/TransformerFactoryImpl;)V", nullptr, $PROTECTED, $method(static_cast<void(TransformerImpl::*)($Translet*,$Properties*,int32_t,$TransformerFactoryImpl*)>(&TransformerImpl::init$))},
	{"clearParameters", "()V", nullptr, $PUBLIC},
	{"createOutputProperties", "(Ljava/util/Properties;)Ljava/util/Properties;", nullptr, $PRIVATE, $method(static_cast<$Properties*(TransformerImpl::*)($Properties*)>(&TransformerImpl::createOutputProperties))},
	{"getDOM", "(Ljavax/xml/transform/Source;)Lcom/sun/org/apache/xalan/internal/xsltc/DOM;", nullptr, $PRIVATE, $method(static_cast<$DOM*(TransformerImpl::*)($Source*)>(&TransformerImpl::getDOM)), "javax.xml.transform.TransformerException"},
	{"getErrorListener", "()Ljavax/xml/transform/ErrorListener;", nullptr, $PUBLIC},
	{"getOutputHandler", "(Ljavax/xml/transform/Result;)Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;", nullptr, $PUBLIC, $method(static_cast<$SerializationHandler*(TransformerImpl::*)($Result*)>(&TransformerImpl::getOutputHandler)), "javax.xml.transform.TransformerException"},
	{"getOutputProperties", "()Ljava/util/Properties;", nullptr, $PUBLIC},
	{"getOutputProperty", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PUBLIC, nullptr, "java.lang.IllegalArgumentException"},
	{"getParameter", "(Ljava/lang/String;)Ljava/lang/Object;", nullptr, $PUBLIC | $FINAL},
	{"getTransformerFactory", "()Lcom/sun/org/apache/xalan/internal/xsltc/trax/TransformerFactoryImpl;", nullptr, $PROTECTED, $method(static_cast<$TransformerFactoryImpl*(TransformerImpl::*)()>(&TransformerImpl::getTransformerFactory))},
	{"getTranslet", "()Lcom/sun/org/apache/xalan/internal/xsltc/runtime/AbstractTranslet;", nullptr, $PROTECTED, $method(static_cast<$AbstractTranslet*(TransformerImpl::*)()>(&TransformerImpl::getTranslet))},
	{"getTransletOutputHandlerFactory", "()Lcom/sun/org/apache/xalan/internal/xsltc/runtime/output/TransletOutputHandlerFactory;", nullptr, $PROTECTED, $method(static_cast<$TransletOutputHandlerFactory*(TransformerImpl::*)()>(&TransformerImpl::getTransletOutputHandlerFactory))},
	{"getURIResolver", "()Ljavax/xml/transform/URIResolver;", nullptr, $PUBLIC},
	{"isDefaultProperty", "(Ljava/lang/String;Ljava/util/Properties;)Z", nullptr, $PRIVATE, $method(static_cast<bool(TransformerImpl::*)($String*,$Properties*)>(&TransformerImpl::isDefaultProperty))},
	{"isIdentity", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(TransformerImpl::*)()>(&TransformerImpl::isIdentity))},
	{"isSecureProcessing", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(TransformerImpl::*)()>(&TransformerImpl::isSecureProcessing))},
	{"overrideDefaultParser", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(TransformerImpl::*)()>(&TransformerImpl::overrideDefaultParser))},
	{"postErrorToListener", "(Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(TransformerImpl::*)($String*)>(&TransformerImpl::postErrorToListener))},
	{"postWarningToListener", "(Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(TransformerImpl::*)($String*)>(&TransformerImpl::postWarningToListener))},
	...
	{"setDOM", "(Lcom/sun/org/apache/xalan/internal/xsltc/DOM;)V", nullptr, $PROTECTED, $method(static_cast<void(TransformerImpl::*)($DOM*)>(&TransformerImpl::setDOM))},
	{"setDefaults", "(Ljava/util/Properties;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(TransformerImpl::*)($Properties*,$String*)>(&TransformerImpl::setDefaults))},
	{"setErrorListener", "(Ljavax/xml/transform/ErrorListener;)V", nullptr, $PUBLIC, nullptr, "java.lang.IllegalArgumentException"},
	{"setOutputProperties", "(Ljava/util/Properties;)V", nullptr, $PUBLIC, nullptr, "java.lang.IllegalArgumentException"},
	{"setOutputProperty", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, nullptr, "java.lang.IllegalArgumentException"},
	{"setOverrideDefaultParser", "(Z)V", nullptr, $PUBLIC, $method(static_cast<void(TransformerImpl::*)(bool)>(&TransformerImpl::setOverrideDefaultParser))},
	{"setParameter", "(Ljava/lang/String;Ljava/lang/Object;)V", nullptr, $PUBLIC},
	{"setSecureProcessing", "(Z)V", nullptr, $PUBLIC, $method(static_cast<void(TransformerImpl::*)(bool)>(&TransformerImpl::setSecureProcessing))},
	{"setURIResolver", "(Ljavax/xml/transform/URIResolver;)V", nullptr, $PUBLIC},
	{"*toString", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"transferOutputProperties", "(Lcom/sun/org/apache/xalan/internal/xsltc/runtime/AbstractTranslet;)V", nullptr, $PRIVATE, $method(static_cast<void(TransformerImpl::*)($AbstractTranslet*)>(&TransformerImpl::transferOutputProperties))},
	{"transferOutputProperties", "(Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;)V", nullptr, $PUBLIC, $method(static_cast<void(TransformerImpl::*)($SerializationHandler*)>(&TransformerImpl::transferOutputProperties))},
	{"transform", "(Ljavax/xml/transform/Source;Ljavax/xml/transform/Result;)V", nullptr, $PUBLIC, nullptr, "javax.xml.transform.TransformerException"},
	{"transform", "(Ljavax/xml/transform/Source;Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(TransformerImpl::*)($Source*,$SerializationHandler*,$String*)>(&TransformerImpl::transform)), "javax.xml.transform.TransformerException"},
	{"transformIdentity", "(Ljavax/xml/transform/Source;Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;)V", nullptr, $PRIVATE, $method(static_cast<void(TransformerImpl::*)($Source*,$SerializationHandler*)>(&TransformerImpl::transformIdentity)), "java.lang.Exception"},
	{"validOutputProperty", "(Ljava/lang/String;)Z", nullptr, $PRIVATE, $method(static_cast<bool(TransformerImpl::*)($String*)>(&TransformerImpl::validOutputProperty))},
	{}
};
