...
$MethodInfo _KeyCall_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;Ljava/util/List;)V", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/QName;Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Expression;>;)V", $PUBLIC, $method(static_cast<void(KeyCall::*)($QName*,$List*)>(&KeyCall::init$))},
	{"addParentDependency", "()V", nullptr, $PUBLIC, $method(static_cast<void(KeyCall::*)()>(&KeyCall::addParentDependency))},
...
void KeyCall::init$($QName* fname, $List* arguments) {
	...
	default:
		{
			$set(this, _name, ($assignField(this, _value, nullptr)));
			break;
		}
	}
}
