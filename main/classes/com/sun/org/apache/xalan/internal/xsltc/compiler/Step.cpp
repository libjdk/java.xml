...
$MethodInfo _Step_MethodInfo_[] = {
	{"<init>", "(IILjava/util/List;)V", "(IILjava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Predicate;>;)V", $PUBLIC, $method(static_cast<void(Step::*)(int32_t,int32_t,$List*)>(&Step::init$))},
	{"addPredicates", "(Ljava/util/List;)V", "(Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Predicate;>;)V", $PUBLIC, $method(static_cast<void(Step::*)($List*)>(&Step::addPredicates))},
	{"getAxis", "()I", nullptr, $PUBLIC},
	{"getNodeType", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(Step::*)()>(&Step::getNodeType))},
	{"getPredicates", "()Ljava/util/List;", "()Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Predicate;>;", $PUBLIC, $method(static_cast<$List*(Step::*)()>(&Step::getPredicates))},
	{"hasParentLocationPath", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(Step::*)()>(&Step::hasParentLocationPath))},
	{"hasParentPattern", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(Step::*)()>(&Step::hasParentPattern))},
	{"hasPredicates", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(Step::*)()>(&Step::hasPredicates))},
	{"isAbbreviatedDDot", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Step::*)()>(&Step::isAbbreviatedDDot))},
	{"isAbbreviatedDot", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(Step::*)()>(&Step::isAbbreviatedDot))},
	{"isPredicate", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(Step::*)()>(&Step::isPredicate))},
	...
	{"translatePredicates", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;I)V", nullptr, $PUBLIC, $method(static_cast<void(Step::*)($ClassGenerator*,$MethodGenerator*,int32_t)>(&Step::translatePredicates))},
	{"translateStep", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;I)V", nullptr, $PRIVATE, $method(static_cast<void(Step::*)($ClassGenerator*,$MethodGenerator*,int32_t)>(&Step::translateStep))},
