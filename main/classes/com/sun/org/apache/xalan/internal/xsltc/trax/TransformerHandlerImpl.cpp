...
$MethodInfo _TransformerHandlerImpl_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xalan/internal/xsltc/trax/TransformerImpl;)V", nullptr, $PUBLIC, $method(static_cast<void(TransformerHandlerImpl::*)($TransformerImpl*)>(&TransformerHandlerImpl::init$))},
	...
	{"setResult", "(Ljavax/xml/transform/Result;)V", nullptr, $PUBLIC, nullptr, "java.lang.IllegalArgumentException"},
