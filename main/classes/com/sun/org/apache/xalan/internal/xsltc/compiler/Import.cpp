...
$MethodInfo _Import_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(Import::*)()>(&Import::init$))},
	{"getImportedStylesheet", "()Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Stylesheet;", nullptr, $PUBLIC, $method(static_cast<$Stylesheet*(Import::*)()>(&Import::getImportedStylesheet))},
