...
$MethodInfo _TransformerFactoryImpl_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TransformerFactoryImpl::*)()>(&TransformerFactoryImpl::init$))},
	{"buildCatalogFeatures", "()Ljavax/xml/catalog/CatalogFeatures;", nullptr, $PRIVATE, $method(static_cast<$CatalogFeatures*(TransformerFactoryImpl::*)()>(&TransformerFactoryImpl::buildCatalogFeatures))},
	{"createNewDTMManagerInstance", "()Lcom/sun/org/apache/xalan/internal/xsltc/dom/XSLTCDTMManager;", nullptr, $PROTECTED | $FINAL, $method(static_cast<$XSLTCDTMManager*(TransformerFactoryImpl::*)()>(&TransformerFactoryImpl::createNewDTMManagerInstance))},
	{"getAssociatedStylesheet", "(Ljavax/xml/transform/Source;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljavax/xml/transform/Source;", nullptr, $PUBLIC, nullptr, "javax.xml.transform.TransformerConfigurationException"},
	{"getAttribute", "(Ljava/lang/String;)Ljava/lang/Object;", nullptr, $PUBLIC, nullptr, "java.lang.IllegalArgumentException"},
	{"getBytecodesFromClasses", "(Ljavax/xml/transform/Source;Ljava/lang/String;)[[B", nullptr, $PRIVATE, $method(static_cast<$byteArray2*(TransformerFactoryImpl::*)($Source*,$String*)>(&TransformerFactoryImpl::getBytecodesFromClasses))},
	{"getBytecodesFromJar", "(Ljavax/xml/transform/Source;Ljava/lang/String;)[[B", nullptr, $PRIVATE, $method(static_cast<$byteArray2*(TransformerFactoryImpl::*)($Source*,$String*)>(&TransformerFactoryImpl::getBytecodesFromJar))},
	{"getErrorListener", "()Ljavax/xml/transform/ErrorListener;", nullptr, $PUBLIC},
	{"getExternalExtensionsMap", "()Ljava/util/Map;", "()Ljava/util/Map<Ljava/lang/String;Ljava/lang/Class<*>;>;", $PUBLIC},
	{"getFeature", "(Ljava/lang/String;)Z", nullptr, $PUBLIC},
	{"getJdkXmlFeatures", "()Ljdk/xml/internal/JdkXmlFeatures;", nullptr, $PUBLIC},
	{"getPackageName", "()Ljava/lang/String;", nullptr, 0},
	{"getStylesheetFileName", "(Ljavax/xml/transform/Source;)Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(TransformerFactoryImpl::*)($Source*)>(&TransformerFactoryImpl::getStylesheetFileName))},
	{"getTransletBaseName", "(Ljavax/xml/transform/Source;)Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(TransformerFactoryImpl::*)($Source*)>(&TransformerFactoryImpl::getTransletBaseName))},
	{"getURIResolver", "()Ljavax/xml/transform/URIResolver;", nullptr, $PUBLIC},
	{"loadSource", "(Ljava/lang/String;Ljava/lang/String;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/XSLTC;)Lorg/xml/sax/InputSource;", nullptr, $PUBLIC},
	{"newTemplates", "(Ljavax/xml/transform/Source;)Ljavax/xml/transform/Templates;", nullptr, $PUBLIC, nullptr, "javax.xml.transform.TransformerConfigurationException"},
	{"newTemplatesHandler", "()Ljavax/xml/transform/sax/TemplatesHandler;", nullptr, $PUBLIC, nullptr, "javax.xml.transform.TransformerConfigurationException"},
	{"newTransformer", "()Ljavax/xml/transform/Transformer;", nullptr, $PUBLIC, nullptr, "javax.xml.transform.TransformerConfigurationException"},
	{"newTransformer", "(Ljavax/xml/transform/Source;)Ljavax/xml/transform/Transformer;", nullptr, $PUBLIC, nullptr, "javax.xml.transform.TransformerConfigurationException"},
	{"newTransformerHandler", "()Ljavax/xml/transform/sax/TransformerHandler;", nullptr, $PUBLIC, nullptr, "javax.xml.transform.TransformerConfigurationException"},
	{"newTransformerHandler", "(Ljavax/xml/transform/Source;)Ljavax/xml/transform/sax/TransformerHandler;", nullptr, $PUBLIC, nullptr, "javax.xml.transform.TransformerConfigurationException"},
	{"newTransformerHandler", "(Ljavax/xml/transform/Templates;)Ljavax/xml/transform/sax/TransformerHandler;", nullptr, $PUBLIC, nullptr, "javax.xml.transform.TransformerConfigurationException"},
	{"newXMLFilter", "(Ljavax/xml/transform/Source;)Lorg/xml/sax/XMLFilter;", nullptr, $PUBLIC, nullptr, "javax.xml.transform.TransformerConfigurationException"},
	{"newXMLFilter", "(Ljavax/xml/transform/Templates;)Lorg/xml/sax/XMLFilter;", nullptr, $PUBLIC, nullptr, "javax.xml.transform.TransformerConfigurationException"},
	{"overrideDefaultParser", "()Z", nullptr, $PUBLIC},
	{"passErrorsToListener", "(Ljava/util/List;)V", "(Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ErrorMsg;>;)V", $PRIVATE, $method(static_cast<void(TransformerFactoryImpl::*)($List*)>(&TransformerFactoryImpl::passErrorsToListener))},
	{"passWarningsToListener", "(Ljava/util/List;)V", "(Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ErrorMsg;>;)V", $PRIVATE, $method(static_cast<void(TransformerFactoryImpl::*)($List*)>(&TransformerFactoryImpl::passWarningsToListener)), "javax.xml.transform.TransformerException"},
	{"readFromInputStream", "([BLjava/io/InputStream;I)V", nullptr, $PRIVATE, $method(static_cast<void(TransformerFactoryImpl::*)($bytes*,$InputStream*,int32_t)>(&TransformerFactoryImpl::readFromInputStream)), "java.io.IOException"},
	{"resetTransientAttributes", "()V", nullptr, $PRIVATE, $method(static_cast<void(TransformerFactoryImpl::*)()>(&TransformerFactoryImpl::resetTransientAttributes))},
	...
	{"setFeature", "(Ljava/lang/String;Z)V", nullptr, $PUBLIC, nullptr, "javax.xml.transform.TransformerConfigurationException"},
