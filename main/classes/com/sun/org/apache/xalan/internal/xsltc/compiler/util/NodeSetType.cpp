...
$MethodInfo _NodeSetType_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PROTECTED, $method(static_cast<void(NodeSetType::*)()>(&NodeSetType::init$))},
	...
	{"getFirstNode", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PRIVATE, $method(static_cast<void(NodeSetType::*)($ClassGenerator*,$MethodGenerator*)>(&NodeSetType::getFirstNode))},
...
bool NodeSetType::identicalTo($1Type* other) {
...
void NodeSetType::translateTo($ClassGenerator* classGen, $MethodGenerator* methodGen, $StringType* type) {
	...
	$init($1Type);
	$nc($1Type::Node)->translateTo(classGen, methodGen, static_cast<$1Type*>(type));
	$var($BranchHandle, truec, il->append(static_cast<$BranchInstruction*>($$new($GOTO, nullptr))));
