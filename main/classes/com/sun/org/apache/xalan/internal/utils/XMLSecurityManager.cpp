...
$MethodInfo _XMLSecurityManager_MethodInfo_[] = {
	...
	{"getLimit", "(Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;)I", nullptr, $PUBLIC, $method(static_cast<int32_t(XMLSecurityManager::*)($XMLSecurityManager$Limit*)>(&XMLSecurityManager::getLimit))},
	...
	{"getLimitByIndex", "(I)I", nullptr, $PUBLIC, $method(static_cast<int32_t(XMLSecurityManager::*)(int32_t)>(&XMLSecurityManager::getLimitByIndex))},
	{"getLimitValueAsString", "(Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;)Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(XMLSecurityManager::*)($XMLSecurityManager$Limit*)>(&XMLSecurityManager::getLimitValueAsString))},
	...
	{"getState", "(Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;)Ljdk/xml/internal/JdkProperty$State;", nullptr, $PUBLIC, $method(static_cast<$JdkProperty$State*(XMLSecurityManager::*)($XMLSecurityManager$Limit*)>(&XMLSecurityManager::getState))},
	{"getStateLiteral", "(Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;)Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(XMLSecurityManager::*)($XMLSecurityManager$Limit*)>(&XMLSecurityManager::getStateLiteral))},
	{"getSystemProperty", "(Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;Ljava/lang/String;)Z", nullptr, $PRIVATE, $method(static_cast<bool(XMLSecurityManager::*)($XMLSecurityManager$Limit*,$String*)>(&XMLSecurityManager::getSystemProperty))},
	...
	{"setLimit", "(Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$Limit;Ljdk/xml/internal/JdkProperty$State;I)V", nullptr, $PUBLIC, $method(static_cast<void(XMLSecurityManager::*)($XMLSecurityManager$Limit*,$JdkProperty$State*,int32_t)>(&XMLSecurityManager::setLimit))},
