...
$MethodInfo _SAX2StAXBaseWriter_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(SAX2StAXBaseWriter::*)()>(&SAX2StAXBaseWriter::init$))},
	{"<init>", "(Ljavax/xml/stream/XMLReporter;)V", nullptr, $PUBLIC, $method(static_cast<void(SAX2StAXBaseWriter::*)($XMLReporter*)>(&SAX2StAXBaseWriter::init$))},
	...
	{"getCurrentLocation", "()Ljavax/xml/stream/Location;", nullptr, $PUBLIC},
	{"parseQName", "(Ljava/lang/String;[Ljava/lang/String;)V", nullptr, $PUBLIC | $STATIC | $FINAL, $method(static_cast<void(*)($String*,$StringArray*)>(&SAX2StAXBaseWriter::parseQName))},
	{"reportException", "(Ljava/lang/String;Lorg/xml/sax/SAXException;)V", nullptr, $PROTECTED, nullptr, "org.xml.sax.SAXException"},
	...
	{"updateVersionAndEncoding", "()V", nullptr, $PRIVATE, $method(static_cast<void(SAX2StAXBaseWriter::*)()>(&SAX2StAXBaseWriter::updateVersionAndEncoding))},
