...
$MethodInfo _AbstractTranslet_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(AbstractTranslet::*)()>(&AbstractTranslet::init$))},
	{"addAuxiliaryClass", "(Ljava/lang/Class;)V", "(Ljava/lang/Class<*>;)V", $PUBLIC},
	{"addCdataElement", "(Ljava/lang/String;)V", nullptr, $PUBLIC},
	{"addDecimalFormat", "(Ljava/lang/String;Ljava/text/DecimalFormatSymbols;)V", nullptr, $PUBLIC},
	{"addParameter", "(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;", nullptr, $PUBLIC | $FINAL},
	{"addParameter", "(Ljava/lang/String;Ljava/lang/Object;Z)Ljava/lang/Object;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$Object*(AbstractTranslet::*)($String*,Object$*,bool)>(&AbstractTranslet::addParameter))},
	{"buildIDIndex", "(Lcom/sun/org/apache/xalan/internal/xsltc/DOM;)V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(AbstractTranslet::*)($DOM*)>(&AbstractTranslet::buildIDIndex))},
	{"buildKeyIndex", "(Ljava/lang/String;ILjava/lang/String;)V", nullptr, $PUBLIC},
	{"buildKeyIndex", "(Ljava/lang/String;Lcom/sun/org/apache/xalan/internal/xsltc/DOM;)V", nullptr, $PUBLIC},
	{"buildKeyIndexHelper", "(Ljava/lang/String;)Lcom/sun/org/apache/xalan/internal/xsltc/dom/KeyIndex;", nullptr, $PRIVATE, $method(static_cast<$KeyIndex*(AbstractTranslet::*)($String*)>(&AbstractTranslet::buildKeyIndexHelper))},
	{"buildKeys", "(Lcom/sun/org/apache/xalan/internal/xsltc/DOM;Lcom/sun/org/apache/xml/internal/dtm/DTMAxisIterator;Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;I)V", nullptr, $PUBLIC, nullptr, "com.sun.org.apache.xalan.internal.xsltc.TransletException"},
	{"characters", "(Ljava/lang/String;Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(AbstractTranslet::*)($String*,$SerializationHandler*)>(&AbstractTranslet::characters)), "com.sun.org.apache.xalan.internal.xsltc.TransletException"},
	{"clearParameters", "()V", nullptr, $PUBLIC},
	{"closeOutputHandler", "(Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;)V", nullptr, $PUBLIC},
	{"createKeyIndex", "()Lcom/sun/org/apache/xalan/internal/xsltc/dom/KeyIndex;", nullptr, $PUBLIC},
	{"displayMessage", "(Ljava/lang/String;)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(AbstractTranslet::*)($String*)>(&AbstractTranslet::displayMessage))},
	{"getAllowedProtocols", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getAuxiliaryClass", "(Ljava/lang/String;)Ljava/lang/Class;", "(Ljava/lang/String;)Ljava/lang/Class<*>;", $PUBLIC},
	{"getDOMCache", "()Lcom/sun/org/apache/xalan/internal/xsltc/DOMCache;", nullptr, $PUBLIC},
	{"getDecimalFormat", "(Ljava/lang/String;)Ljava/text/DecimalFormat;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$DecimalFormat*(AbstractTranslet::*)($String*)>(&AbstractTranslet::getDecimalFormat))},
	{"getKeyIndex", "(Ljava/lang/String;)Lcom/sun/org/apache/xalan/internal/xsltc/dom/KeyIndex;", nullptr, $PUBLIC},
	{"getNamesArray", "()[Ljava/lang/String;", nullptr, $PUBLIC},
	{"getNamespaceArray", "()[Ljava/lang/String;", nullptr, $PUBLIC},
	{"getParameter", "(Ljava/lang/String;)Ljava/lang/Object;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$Object*(AbstractTranslet::*)($String*)>(&AbstractTranslet::getParameter))},
	{"getTemplates", "()Ljavax/xml/transform/Templates;", nullptr, $PUBLIC},
	{"getTypesArray", "()[I", nullptr, $PUBLIC},
	{"getUrisArray", "()[Ljava/lang/String;", nullptr, $PUBLIC},
	{"hasIdCall", "()Z", nullptr, $PUBLIC},
	{"makeDOMAdapter", "(Lcom/sun/org/apache/xalan/internal/xsltc/DOM;)Lcom/sun/org/apache/xalan/internal/xsltc/dom/DOMAdapter;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$DOMAdapter*(AbstractTranslet::*)($DOM*)>(&AbstractTranslet::makeDOMAdapter)), "com.sun.org.apache.xalan.internal.xsltc.TransletException"},
	{"newDocument", "(Ljava/lang/String;Ljava/lang/String;)Lorg/w3c/dom/Document;", nullptr, $PUBLIC, nullptr, "javax.xml.parsers.ParserConfigurationException"},
	{"openOutputHandler", "(Ljava/lang/String;Z)Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;", nullptr, $PUBLIC, nullptr, "com.sun.org.apache.xalan.internal.xsltc.TransletException"},
	{"openOutputHandler", "(Ljava/lang/String;)Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;", nullptr, $PUBLIC, nullptr, "com.sun.org.apache.xalan.internal.xsltc.TransletException"},
	{"overrideDefaultParser", "()Z", nullptr, $PUBLIC},
	{"popParamFrame", "()V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(AbstractTranslet::*)()>(&AbstractTranslet::popParamFrame))},
	{"postInitialization", "()V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(AbstractTranslet::*)()>(&AbstractTranslet::postInitialization))},
	{"prepassDocument", "(Lcom/sun/org/apache/xalan/internal/xsltc/DOM;)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(AbstractTranslet::*)($DOM*)>(&AbstractTranslet::prepassDocument))},
	{"printInternalState", "()V", nullptr, $PUBLIC},
	{"pushParamFrame", "()V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(AbstractTranslet::*)()>(&AbstractTranslet::pushParamFrame))},
	{"setAllowedProtocols", "(Ljava/lang/String;)V", nullptr, $PUBLIC},
	{"setAuxiliaryClasses", "(Ljava/util/Map;)V", "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/Class<*>;>;)V", $PUBLIC},
	{"setDOMCache", "(Lcom/sun/org/apache/xalan/internal/xsltc/DOMCache;)V", nullptr, $PUBLIC},
	{"setIndexSize", "(I)V", nullptr, $PUBLIC},
	{"setKeyIndexDom", "(Ljava/lang/String;Lcom/sun/org/apache/xalan/internal/xsltc/DOM;)V", nullptr, $PUBLIC},
	{"setMessageHandler", "(Lcom/sun/org/apache/xalan/internal/xsltc/runtime/MessageHandler;)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(AbstractTranslet::*)($MessageHandler*)>(&AbstractTranslet::setMessageHandler))},
	{"setOverrideDefaultParser", "(Z)V", nullptr, $PUBLIC},
	{"setRootForKeys", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(AbstractTranslet::*)(int32_t)>(&AbstractTranslet::setRootForKeys))},
	{"setTemplates", "(Ljavax/xml/transform/Templates;)V", nullptr, $PUBLIC},
	{"transferOutputSettings", "(Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;)V", nullptr, $PROTECTED},
	...
	{"transform", "(Lcom/sun/org/apache/xalan/internal/xsltc/DOM;Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;)V", nullptr, $PUBLIC | $FINAL, nullptr, "com.sun.org.apache.xalan.internal.xsltc.TransletException"},
	{}
};
