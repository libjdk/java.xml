...
$MethodInfo _StepPattern_MethodInfo_[] = {
	{"<init>", "(IILjava/util/List;)V", "(IILjava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Predicate;>;)V", $PUBLIC, $method(static_cast<void(StepPattern::*)(int32_t,int32_t,$List*)>(&StepPattern::init$))},
	{"analyzeCases", "()I", nullptr, $PRIVATE, $method(static_cast<int32_t(StepPattern::*)()>(&StepPattern::analyzeCases))},
	...
	{"getNextFieldName", "()Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(StepPattern::*)()>(&StepPattern::getNextFieldName))},
	{"getNodeType", "()I", nullptr, $PUBLIC},
	{"hasPredicates", "()Z", nullptr, $PROTECTED},
	...
	{"setPredicates", "(Ljava/util/List;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/StepPattern;", "(Ljava/util/List<Lcom/sun/org/apache/xalan/internal/xsltc/compiler/Predicate;>;)Lcom/sun/org/apache/xalan/internal/xsltc/compiler/StepPattern;", $PUBLIC},
	{"setPriority", "(D)V", nullptr, $PUBLIC},
	...
	{"translateGeneralContext", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PRIVATE, $method(static_cast<void(StepPattern::*)($ClassGenerator*,$MethodGenerator*)>(&StepPattern::translateGeneralContext))},
	{"translateKernel", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PRIVATE, $method(static_cast<void(StepPattern::*)($ClassGenerator*,$MethodGenerator*)>(&StepPattern::translateKernel))},
	{"translateNoContext", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PRIVATE, $method(static_cast<void(StepPattern::*)($ClassGenerator*,$MethodGenerator*)>(&StepPattern::translateNoContext))},
	{"translateSimpleContext", "(Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/ClassGenerator;Lcom/sun/org/apache/xalan/internal/xsltc/compiler/util/MethodGenerator;)V", nullptr, $PRIVATE, $method(static_cast<void(StepPattern::*)($ClassGenerator*,$MethodGenerator*)>(&StepPattern::translateSimpleContext))},
...
$1Type* StepPattern::typeCheck($SymbolTable* stable) {
	...
	$init($1Type);
	return this->_axis == $Axis::CHILD ? $1Type::Element : $1Type::Attribute;
}
