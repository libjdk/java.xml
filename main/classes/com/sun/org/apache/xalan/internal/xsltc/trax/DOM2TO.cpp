...
$MethodInfo _DOM2TO_MethodInfo_[] = {
	...
	{"<init>", "(Lorg/w3c/dom/Node;Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;)V", nullptr, $PUBLIC, $method(static_cast<void(DOM2TO::*)($Node*,$SerializationHandler*)>(&DOM2TO::init$))},
	...
	{"getNodeTypeFromCode", "(S)Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(DOM2TO::*)(int16_t)>(&DOM2TO::getNodeTypeFromCode))},
	...
	{"parse", "()V", nullptr, $PUBLIC, nullptr, "java.io.IOException,org.xml.sax.SAXException"},
	{"parse", "(Lorg/w3c/dom/Node;)V", nullptr, $PRIVATE, $method(static_cast<void(DOM2TO::*)($Node*)>(&DOM2TO::parse)), "java.io.IOException,org.xml.sax.SAXException"},
	...
	{"setDocumentInfo", "(Lorg/w3c/dom/Document;)V", nullptr, $PRIVATE, $method(static_cast<void(DOM2TO::*)($Document*)>(&DOM2TO::setDocumentInfo))},
	{"setEncoding", "(Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(DOM2TO::*)($String*)>(&DOM2TO::setEncoding))},
	...
	{"setXMLVersion", "(Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(DOM2TO::*)($String*)>(&DOM2TO::setXMLVersion))},
