...
$MethodInfo _XMLSecurityManager$NameMap_MethodInfo_[] = {
	{"$values", "()[Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$NameMap;", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<$XMLSecurityManager$NameMapArray*(*)()>(&XMLSecurityManager$NameMap::$values))},
	...
	{"valueOf", "(Ljava/lang/String;)Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$NameMap;", nullptr, $PUBLIC | $STATIC, $method(static_cast<XMLSecurityManager$NameMap*(*)($String*)>(&XMLSecurityManager$NameMap::valueOf))},
	{"values", "()[Lcom/sun/org/apache/xalan/internal/utils/XMLSecurityManager$NameMap;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$XMLSecurityManager$NameMapArray*(*)()>(&XMLSecurityManager$NameMap::values))},
	{}
};
