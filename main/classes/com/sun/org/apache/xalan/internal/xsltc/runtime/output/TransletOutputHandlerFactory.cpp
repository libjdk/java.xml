...
$MethodInfo _TransletOutputHandlerFactory_MethodInfo_[] = {
	{"<init>", "(ZLjavax/xml/transform/ErrorListener;)V", nullptr, $PUBLIC, $method(static_cast<void(TransletOutputHandlerFactory::*)(bool,$ErrorListener*)>(&TransletOutputHandlerFactory::init$))},
	{"getNode", "()Lorg/w3c/dom/Node;", nullptr, $PUBLIC},
	{"getSerializationHandler", "()Lcom/sun/org/apache/xml/internal/serializer/SerializationHandler;", nullptr, $PUBLIC, nullptr, "java.io.IOException,javax.xml.parsers.ParserConfigurationException"},
	...
	{"newInstance", "(ZLjavax/xml/transform/ErrorListener;)Lcom/sun/org/apache/xalan/internal/xsltc/runtime/output/TransletOutputHandlerFactory;", nullptr, $PUBLIC | $STATIC, $method(static_cast<TransletOutputHandlerFactory*(*)(bool,$ErrorListener*)>(&TransletOutputHandlerFactory::newInstance))},
	{"setEncoding", "(Ljava/lang/String;)V", nullptr, $PUBLIC},
	{"setHandler", "(Lorg/xml/sax/ContentHandler;)V", nullptr, $PUBLIC},
	{"setIndentNumber", "(I)V", nullptr, $PUBLIC},
	...
	{"setOutputMethod", "(Ljava/lang/String;)V", nullptr, $PUBLIC},
	{"setOutputStream", "(Ljava/io/OutputStream;)V", nullptr, $PUBLIC},
	{"setOutputType", "(I)V", nullptr, $PUBLIC},
	{"setWriter", "(Ljava/io/Writer;)V", nullptr, $PUBLIC},
	{"setXMLEventWriter", "(Ljavax/xml/stream/XMLEventWriter;)V", nullptr, $PUBLIC},
	{"setXMLStreamWriter", "(Ljavax/xml/stream/XMLStreamWriter;)V", nullptr, $PUBLIC},
	{}
};
