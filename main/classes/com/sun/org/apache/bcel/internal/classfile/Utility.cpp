...
$MethodInfo _Utility_MethodInfo_[] = {
	...
	{"accessToString", "(I)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int32_t)>(&Utility::accessToString))},
	{"accessToString", "(IZ)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int32_t,bool)>(&Utility::accessToString))},
	{"byteToShort", "(B)S", nullptr, $PRIVATE | $STATIC, $method(static_cast<int16_t(*)(int8_t)>(&Utility::byteToShort))},
	{"classOrInterface", "(I)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int32_t)>(&Utility::classOrInterface))},
	{"clearBit", "(II)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t,int32_t)>(&Utility::clearBit))},
	{"codeToString", "([BLcom/sun/org/apache/bcel/internal/classfile/ConstantPool;IIZ)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($bytes*,$ConstantPool*,int32_t,int32_t,bool)>(&Utility::codeToString))},
	{"codeToString", "([BLcom/sun/org/apache/bcel/internal/classfile/ConstantPool;II)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($bytes*,$ConstantPool*,int32_t,int32_t)>(&Utility::codeToString))},
	{"codeToString", "(Lcom/sun/org/apache/bcel/internal/util/ByteSequence;Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;Z)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($ByteSequence*,$ConstantPool*,bool)>(&Utility::codeToString)), "java.io.IOException"},
	{"codeToString", "(Lcom/sun/org/apache/bcel/internal/util/ByteSequence;Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($ByteSequence*,$ConstantPool*)>(&Utility::codeToString)), "java.io.IOException"},
	{"compactClassName", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*)>(&Utility::compactClassName))},
	{"compactClassName", "(Ljava/lang/String;Z)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*,bool)>(&Utility::compactClassName))},
	{"compactClassName", "(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*,$String*,bool)>(&Utility::compactClassName))},
	{"convertString", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*)>(&Utility::convertString))},
	{"countBrackets", "(Ljava/lang/String;)I", nullptr, $PRIVATE | $STATIC, $method(static_cast<int32_t(*)($String*)>(&Utility::countBrackets))},
	{"decode", "(Ljava/lang/String;Z)[B", nullptr, $PUBLIC | $STATIC, $method(static_cast<$bytes*(*)($String*,bool)>(&Utility::decode)), "java.io.IOException"},
	{"encode", "([BZ)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($bytes*,bool)>(&Utility::encode)), "java.io.IOException"},
	{"equals", "([B[B)Z", nullptr, $STATIC, $method(static_cast<bool(*)($bytes*,$bytes*)>(&Utility::equals))},
	{"fillup", "(Ljava/lang/String;IZC)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*,int32_t,bool,char16_t)>(&Utility::fillup))},
	{"format", "(IIZC)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(int32_t,int32_t,bool,char16_t)>(&Utility::format))},
	{"getSignature", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*)>(&Utility::getSignature))},
	{"isJavaIdentifierPart", "(C)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(char16_t)>(&Utility::isJavaIdentifierPart))},
	{"isSet", "(II)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t,int32_t)>(&Utility::isSet))},
	{"methodSignatureArgumentTypes", "(Ljava/lang/String;)[Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$StringArray*(*)($String*)>(&Utility::methodSignatureArgumentTypes)), "com.sun.org.apache.bcel.internal.classfile.ClassFormatException"},
	{"methodSignatureArgumentTypes", "(Ljava/lang/String;Z)[Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$StringArray*(*)($String*,bool)>(&Utility::methodSignatureArgumentTypes)), "com.sun.org.apache.bcel.internal.classfile.ClassFormatException"},
	{"methodSignatureReturnType", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*)>(&Utility::methodSignatureReturnType)), "com.sun.org.apache.bcel.internal.classfile.ClassFormatException"},
	{"methodSignatureReturnType", "(Ljava/lang/String;Z)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*,bool)>(&Utility::methodSignatureReturnType)), "com.sun.org.apache.bcel.internal.classfile.ClassFormatException"},
	{"methodSignatureToString", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*,$String*,$String*)>(&Utility::methodSignatureToString))},
	{"methodSignatureToString", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*,$String*,$String*,bool)>(&Utility::methodSignatureToString))},
	{"methodSignatureToString", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLcom/sun/org/apache/bcel/internal/classfile/LocalVariableTable;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*,$String*,$String*,bool,$LocalVariableTable*)>(&Utility::methodSignatureToString)), "com.sun.org.apache.bcel.internal.classfile.ClassFormatException"},
	{"methodTypeToSignature", "(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*,$StringArray*)>(&Utility::methodTypeToSignature)), "com.sun.org.apache.bcel.internal.classfile.ClassFormatException"},
	{"pow2", "(I)I", nullptr, $PRIVATE | $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&Utility::pow2))},
	{"printArray", "(Ljava/io/PrintStream;[Ljava/lang/Object;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($PrintStream*,$ObjectArray*)>(&Utility::printArray))},
	{"printArray", "(Ljava/io/PrintWriter;[Ljava/lang/Object;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($PrintWriter*,$ObjectArray*)>(&Utility::printArray))},
	{"printArray", "([Ljava/lang/Object;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($ObjectArray*)>(&Utility::printArray))},
	{"printArray", "([Ljava/lang/Object;Z)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($ObjectArray*,bool)>(&Utility::printArray))},
	{"printArray", "([Ljava/lang/Object;ZZ)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($ObjectArray*,bool,bool)>(&Utility::printArray))},
	{"replace", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*,$String*,$String*)>(&Utility::replace))},
	{"searchOpcode", "(Ljava/lang/String;)S", nullptr, $PUBLIC | $STATIC, $method(static_cast<int16_t(*)($String*)>(&Utility::searchOpcode))},
	{"setBit", "(II)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(int32_t,int32_t)>(&Utility::setBit))},
	{"signatureToString", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*)>(&Utility::signatureToString))},
	{"signatureToString", "(Ljava/lang/String;Z)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*,bool)>(&Utility::signatureToString))},
	{"toHexString", "([B)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($bytes*)>(&Utility::toHexString))},
	{"typeOfMethodSignature", "(Ljava/lang/String;)B", nullptr, $PUBLIC | $STATIC, $method(static_cast<int8_t(*)($String*)>(&Utility::typeOfMethodSignature)), "com.sun.org.apache.bcel.internal.classfile.ClassFormatException"},
	{"typeOfSignature", "(Ljava/lang/String;)B", nullptr, $PUBLIC | $STATIC, $method(static_cast<int8_t(*)($String*)>(&Utility::typeOfSignature)), "com.sun.org.apache.bcel.internal.classfile.ClassFormatException"},
	{"typeParamTypeToString", "(Ljava/lang/String;Z)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*,bool)>(&Utility::typeParamTypeToString))},
	{"typeParamTypesToString", "(Ljava/lang/String;Z)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*,bool)>(&Utility::typeParamTypesToString))},
	{"typeSignatureToString", "(Ljava/lang/String;Z)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*,bool)>(&Utility::typeSignatureToString)), "com.sun.org.apache.bcel.internal.classfile.ClassFormatException"},
	{"typeSignaturesToString", "(Ljava/lang/String;ZC)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*,bool,char16_t)>(&Utility::typeSignaturesToString))},
	{"unwrap", "(Ljava/lang/ThreadLocal;)I", "(Ljava/lang/ThreadLocal<Ljava/lang/Integer;>;)I", $PRIVATE | $STATIC, $method(static_cast<int32_t(*)($ThreadLocal*)>(&Utility::unwrap))},
	{"wrap", "(Ljava/lang/ThreadLocal;I)V", "(Ljava/lang/ThreadLocal<Ljava/lang/Integer;>;I)V", $PRIVATE | $STATIC, $method(static_cast<void(*)($ThreadLocal*,int32_t)>(&Utility::wrap))},
	{}
};
