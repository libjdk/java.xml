...
$MethodInfo _SimpleElementValueGen_MethodInfo_[] = {
	{"<init>", "(IILcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;)V", nullptr, $PROTECTED, $method(static_cast<void(SimpleElementValueGen::*)(int32_t,int32_t,$ConstantPoolGen*)>(&SimpleElementValueGen::init$))},
	{"<init>", "(ILcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;I)V", nullptr, $PUBLIC, $method(static_cast<void(SimpleElementValueGen::*)(int32_t,$ConstantPoolGen*,int32_t)>(&SimpleElementValueGen::init$))},
	{"<init>", "(ILcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;J)V", nullptr, $PUBLIC, $method(static_cast<void(SimpleElementValueGen::*)(int32_t,$ConstantPoolGen*,int64_t)>(&SimpleElementValueGen::init$))},
	{"<init>", "(ILcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;D)V", nullptr, $PUBLIC, $method(static_cast<void(SimpleElementValueGen::*)(int32_t,$ConstantPoolGen*,double)>(&SimpleElementValueGen::init$))},
	{"<init>", "(ILcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;F)V", nullptr, $PUBLIC, $method(static_cast<void(SimpleElementValueGen::*)(int32_t,$ConstantPoolGen*,float)>(&SimpleElementValueGen::init$))},
	{"<init>", "(ILcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;S)V", nullptr, $PUBLIC, $method(static_cast<void(SimpleElementValueGen::*)(int32_t,$ConstantPoolGen*,int16_t)>(&SimpleElementValueGen::init$))},
	{"<init>", "(ILcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;B)V", nullptr, $PUBLIC, $method(static_cast<void(SimpleElementValueGen::*)(int32_t,$ConstantPoolGen*,int8_t)>(&SimpleElementValueGen::init$))},
	{"<init>", "(ILcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;C)V", nullptr, $PUBLIC, $method(static_cast<void(SimpleElementValueGen::*)(int32_t,$ConstantPoolGen*,char16_t)>(&SimpleElementValueGen::init$))},
	{"<init>", "(ILcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Z)V", nullptr, $PUBLIC, $method(static_cast<void(SimpleElementValueGen::*)(int32_t,$ConstantPoolGen*,bool)>(&SimpleElementValueGen::init$))},
	{"<init>", "(ILcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(SimpleElementValueGen::*)(int32_t,$ConstantPoolGen*,$String*)>(&SimpleElementValueGen::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/classfile/SimpleElementValue;Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Z)V", nullptr, $PUBLIC, $method(static_cast<void(SimpleElementValueGen::*)($SimpleElementValue*,$ConstantPoolGen*,bool)>(&SimpleElementValueGen::init$))},
