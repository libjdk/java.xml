...
$MethodInfo _PUSH_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;I)V", nullptr, $PUBLIC, $method(static_cast<void(PUSH::*)($ConstantPoolGen*,int32_t)>(&PUSH::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Z)V", nullptr, $PUBLIC, $method(static_cast<void(PUSH::*)($ConstantPoolGen*,bool)>(&PUSH::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;F)V", nullptr, $PUBLIC, $method(static_cast<void(PUSH::*)($ConstantPoolGen*,float)>(&PUSH::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;J)V", nullptr, $PUBLIC, $method(static_cast<void(PUSH::*)($ConstantPoolGen*,int64_t)>(&PUSH::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;D)V", nullptr, $PUBLIC, $method(static_cast<void(PUSH::*)($ConstantPoolGen*,double)>(&PUSH::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(PUSH::*)($ConstantPoolGen*,$String*)>(&PUSH::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Lcom/sun/org/apache/bcel/internal/generic/ObjectType;)V", nullptr, $PUBLIC, $method(static_cast<void(PUSH::*)($ConstantPoolGen*,$ObjectType*)>(&PUSH::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Ljava/lang/Number;)V", nullptr, $PUBLIC, $method(static_cast<void(PUSH::*)($ConstantPoolGen*,$Number*)>(&PUSH::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Ljava/lang/Character;)V", nullptr, $PUBLIC, $method(static_cast<void(PUSH::*)($ConstantPoolGen*,$Character*)>(&PUSH::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Ljava/lang/Boolean;)V", nullptr, $PUBLIC, $method(static_cast<void(PUSH::*)($ConstantPoolGen*,$Boolean*)>(&PUSH::init$))},
	{"getInstruction", "()Lcom/sun/org/apache/bcel/internal/generic/Instruction;", nullptr, $PUBLIC, $method(static_cast<$Instruction*(PUSH::*)()>(&PUSH::getInstruction))},
