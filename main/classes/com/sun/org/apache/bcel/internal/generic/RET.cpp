...
$MethodInfo _RET_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(RET::*)()>(&RET::init$))},
	{"<init>", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(RET::*)(int32_t)>(&RET::init$))},
	...
	{"setWide", "()V", nullptr, $PRIVATE, $method(static_cast<void(RET::*)()>(&RET::setWide))},
