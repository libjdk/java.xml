...
$MethodInfo _Attribute_MethodInfo_[] = {
	...
	{"<init>", "(BIILcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)V", nullptr, $PROTECTED, $method(static_cast<void(Attribute::*)(int8_t,int32_t,int32_t,$ConstantPool*)>(&Attribute::init$))},
	{"addAttributeReader", "(Ljava/lang/String;Lcom/sun/org/apache/bcel/internal/classfile/UnknownAttributeReader;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($String*,$UnknownAttributeReader*)>(&Attribute::addAttributeReader))},
	{"clone", "()Ljava/lang/Object;", nullptr, $PUBLIC},
	{"copy", "(Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)Lcom/sun/org/apache/bcel/internal/classfile/Attribute;", nullptr, $PUBLIC | $ABSTRACT},
	{"dump", "(Ljava/io/DataOutputStream;)V", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"getConstantPool", "()Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$ConstantPool*(Attribute::*)()>(&Attribute::getConstantPool))},
	{"getLength", "()I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(Attribute::*)()>(&Attribute::getLength))},
	{"getName", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getNameIndex", "()I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(Attribute::*)()>(&Attribute::getNameIndex))},
	{"getTag", "()B", nullptr, $PUBLIC | $FINAL, $method(static_cast<int8_t(Attribute::*)()>(&Attribute::getTag))},
	{"println", "(Ljava/lang/String;)V", nullptr, $PROTECTED | $STATIC, $method(static_cast<void(*)($String*)>(&Attribute::println))},
	{"readAttribute", "(Ljava/io/DataInput;Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)Lcom/sun/org/apache/bcel/internal/classfile/Attribute;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Attribute*(*)($DataInput*,$ConstantPool*)>(&Attribute::readAttribute)), "java.io.IOException,com.sun.org.apache.bcel.internal.classfile.ClassFormatException"},
	{"readAttribute", "(Ljava/io/DataInputStream;Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)Lcom/sun/org/apache/bcel/internal/classfile/Attribute;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Attribute*(*)($DataInputStream*,$ConstantPool*)>(&Attribute::readAttribute)), "java.io.IOException,com.sun.org.apache.bcel.internal.classfile.ClassFormatException"},
	{"removeAttributeReader", "(Ljava/lang/String;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($String*)>(&Attribute::removeAttributeReader))},
	{"setConstantPool", "(Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(Attribute::*)($ConstantPool*)>(&Attribute::setConstantPool))},
	{"setLength", "(I)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(Attribute::*)(int32_t)>(&Attribute::setLength))},
	{"setNameIndex", "(I)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(Attribute::*)(int32_t)>(&Attribute::setNameIndex))},
