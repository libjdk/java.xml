...
$MethodInfo _IF_ICMPLT_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(IF_ICMPLT::*)()>(&IF_ICMPLT::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V", nullptr, $PUBLIC, $method(static_cast<void(IF_ICMPLT::*)($InstructionHandle*)>(&IF_ICMPLT::init$))},
