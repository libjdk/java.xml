...
$MethodInfo _Type_MethodInfo_[] = {
	{"<init>", "(BLjava/lang/String;)V", nullptr, $PROTECTED, $method(static_cast<void(Type::*)(int8_t,$String*)>(&Type::init$))},
	{"consumed", "(I)I", nullptr, $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&Type::consumed))},
	{"encode", "(II)I", nullptr, $STATIC, $method(static_cast<int32_t(*)(int32_t,int32_t)>(&Type::encode))},
	{"equals", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC},
	{"getArgumentTypes", "(Ljava/lang/String;)[Lcom/sun/org/apache/bcel/internal/generic/Type;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$TypeArray*(*)($String*)>(&Type::getArgumentTypes))},
	{"getArgumentTypesSize", "(Ljava/lang/String;)I", nullptr, $STATIC, $method(static_cast<int32_t(*)($String*)>(&Type::getArgumentTypesSize))},
	{"getMethodSignature", "(Lcom/sun/org/apache/bcel/internal/generic/Type;[Lcom/sun/org/apache/bcel/internal/generic/Type;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)(Type*,$TypeArray*)>(&Type::getMethodSignature))},
	{"getReturnType", "(Ljava/lang/String;)Lcom/sun/org/apache/bcel/internal/generic/Type;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Type*(*)($String*)>(&Type::getReturnType))},
	{"getReturnTypeSize", "(Ljava/lang/String;)I", nullptr, $STATIC, $method(static_cast<int32_t(*)($String*)>(&Type::getReturnTypeSize))},
	{"getSignature", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getSignature", "(Ljava/lang/reflect/Method;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($Method*)>(&Type::getSignature))},
	{"getSize", "()I", nullptr, $PUBLIC},
	{"getType", "()B", nullptr, $PUBLIC},
	{"getType", "(Ljava/lang/String;)Lcom/sun/org/apache/bcel/internal/generic/Type;", nullptr, $PUBLIC | $STATIC, $method(static_cast<Type*(*)($String*)>(&Type::getType)), "java.lang.StringIndexOutOfBoundsException"},
	{"getType", "(Ljava/lang/Class;)Lcom/sun/org/apache/bcel/internal/generic/Type;", "(Ljava/lang/Class<*>;)Lcom/sun/org/apache/bcel/internal/generic/Type;", $PUBLIC | $STATIC, $method(static_cast<Type*(*)($Class*)>(&Type::getType))},
	{"getTypeSize", "(Ljava/lang/String;)I", nullptr, $STATIC, $method(static_cast<int32_t(*)($String*)>(&Type::getTypeSize)), "java.lang.StringIndexOutOfBoundsException"},
	{"getTypes", "([Ljava/lang/Class;)[Lcom/sun/org/apache/bcel/internal/generic/Type;", "([Ljava/lang/Class<*>;)[Lcom/sun/org/apache/bcel/internal/generic/Type;", $PUBLIC | $STATIC, $method(static_cast<$TypeArray*(*)($ClassArray*)>(&Type::getTypes))},
	{"hashCode", "()I", nullptr, $PUBLIC},
	{"normalizeForStackOrLocal", "()Lcom/sun/org/apache/bcel/internal/generic/Type;", nullptr, $PUBLIC},
	{"setSignature", "(Ljava/lang/String;)V", nullptr, 0},
	{"size", "(I)I", nullptr, $STATIC, $method(static_cast<int32_t(*)(int32_t)>(&Type::size))},
	{"toString", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"unwrap", "(Ljava/lang/ThreadLocal;)I", "(Ljava/lang/ThreadLocal<Ljava/lang/Integer;>;)I", $PRIVATE | $STATIC, $method(static_cast<int32_t(*)($ThreadLocal*)>(&Type::unwrap))},
	{"wrap", "(Ljava/lang/ThreadLocal;I)V", "(Ljava/lang/ThreadLocal<Ljava/lang/Integer;>;I)V", $PRIVATE | $STATIC, $method(static_cast<void(*)($ThreadLocal*,int32_t)>(&Type::wrap))},
	{}
};
