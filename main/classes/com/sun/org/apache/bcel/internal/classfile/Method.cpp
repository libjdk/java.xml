...
$MethodInfo _Method_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/classfile/Method;)V", nullptr, $PUBLIC, $method(static_cast<void(Method::*)(Method*)>(&Method::init$))},
	{"<init>", "(Ljava/io/DataInput;Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)V", nullptr, 0, $method(static_cast<void(Method::*)($DataInput*,$ConstantPool*)>(&Method::init$)), "java.io.IOException,com.sun.org.apache.bcel.internal.classfile.ClassFormatException"},
	{"<init>", "(III[Lcom/sun/org/apache/bcel/internal/classfile/Attribute;Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)V", nullptr, $PUBLIC, $method(static_cast<void(Method::*)(int32_t,int32_t,int32_t,$AttributeArray*,$ConstantPool*)>(&Method::init$))},
	{"accept", "(Lcom/sun/org/apache/bcel/internal/classfile/Visitor;)V", nullptr, $PUBLIC},
	{"copy", "(Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)Lcom/sun/org/apache/bcel/internal/classfile/Method;", nullptr, $PUBLIC, $method(static_cast<Method*(Method::*)($ConstantPool*)>(&Method::copy))},
	{"equals", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC},
	{"getArgumentTypes", "()[Lcom/sun/org/apache/bcel/internal/generic/Type;", nullptr, $PUBLIC, $method(static_cast<$TypeArray*(Method::*)()>(&Method::getArgumentTypes))},
	{"getCode", "()Lcom/sun/org/apache/bcel/internal/classfile/Code;", nullptr, $PUBLIC, $method(static_cast<$Code*(Method::*)()>(&Method::getCode))},
	{"getComparator", "()Lcom/sun/org/apache/bcel/internal/util/BCELComparator;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$BCELComparator*(*)()>(&Method::getComparator))},
	{"getExceptionTable", "()Lcom/sun/org/apache/bcel/internal/classfile/ExceptionTable;", nullptr, $PUBLIC, $method(static_cast<$ExceptionTable*(Method::*)()>(&Method::getExceptionTable))},
	{"getLineNumberTable", "()Lcom/sun/org/apache/bcel/internal/classfile/LineNumberTable;", nullptr, $PUBLIC, $method(static_cast<$LineNumberTable*(Method::*)()>(&Method::getLineNumberTable))},
	{"getLocalVariableTable", "()Lcom/sun/org/apache/bcel/internal/classfile/LocalVariableTable;", nullptr, $PUBLIC, $method(static_cast<$LocalVariableTable*(Method::*)()>(&Method::getLocalVariableTable))},
	{"getParameterAnnotationEntries", "()[Lcom/sun/org/apache/bcel/internal/classfile/ParameterAnnotationEntry;", nullptr, $PUBLIC, $method(static_cast<$ParameterAnnotationEntryArray*(Method::*)()>(&Method::getParameterAnnotationEntries))},
	{"getReturnType", "()Lcom/sun/org/apache/bcel/internal/generic/Type;", nullptr, $PUBLIC, $method(static_cast<$Type*(Method::*)()>(&Method::getReturnType))},
	{"hashCode", "()I", nullptr, $PUBLIC},
	{"setComparator", "(Lcom/sun/org/apache/bcel/internal/util/BCELComparator;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($BCELComparator*)>(&Method::setComparator))},
