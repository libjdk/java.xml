...
$MethodInfo _ConstantModule_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/classfile/ConstantModule;)V", nullptr, $PUBLIC, $method(static_cast<void(ConstantModule::*)(ConstantModule*)>(&ConstantModule::init$))},
	{"<init>", "(Ljava/io/DataInput;)V", nullptr, 0, $method(static_cast<void(ConstantModule::*)($DataInput*)>(&ConstantModule::init$)), "java.io.IOException"},
	{"<init>", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(ConstantModule::*)(int32_t)>(&ConstantModule::init$))},
	...
	{"getBytes", "(Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(ConstantModule::*)($ConstantPool*)>(&ConstantModule::getBytes))},
	{"getConstantValue", "(Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)Ljava/lang/Object;", nullptr, $PUBLIC},
	{"getNameIndex", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(ConstantModule::*)()>(&ConstantModule::getNameIndex))},
	{"setNameIndex", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(ConstantModule::*)(int32_t)>(&ConstantModule::setNameIndex))},
