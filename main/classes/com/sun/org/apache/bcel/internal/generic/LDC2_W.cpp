...
$MethodInfo _LDC2_W_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(LDC2_W::*)()>(&LDC2_W::init$))},
	{"<init>", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(LDC2_W::*)(int32_t)>(&LDC2_W::init$))},
	...
	{"getValue", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;)Ljava/lang/Number;", nullptr, $PUBLIC},
