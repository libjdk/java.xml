...
$MethodInfo _FieldOrMethod_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/classfile/FieldOrMethod;)V", nullptr, $PROTECTED, $method(static_cast<void(FieldOrMethod::*)(FieldOrMethod*)>(&FieldOrMethod::init$))},
	{"<init>", "(Ljava/io/DataInputStream;Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)V", nullptr, $PROTECTED | $DEPRECATED, $method(static_cast<void(FieldOrMethod::*)($DataInputStream*,$ConstantPool*)>(&FieldOrMethod::init$)), "java.io.IOException,com.sun.org.apache.bcel.internal.classfile.ClassFormatException", nullptr, _FieldOrMethod_MethodAnnotations_init$2},
	{"<init>", "(Ljava/io/DataInput;Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)V", nullptr, $PROTECTED, $method(static_cast<void(FieldOrMethod::*)($DataInput*,$ConstantPool*)>(&FieldOrMethod::init$)), "java.io.IOException,com.sun.org.apache.bcel.internal.classfile.ClassFormatException"},
	{"<init>", "(III[Lcom/sun/org/apache/bcel/internal/classfile/Attribute;Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)V", nullptr, $PROTECTED, $method(static_cast<void(FieldOrMethod::*)(int32_t,int32_t,int32_t,$AttributeArray*,$ConstantPool*)>(&FieldOrMethod::init$))},
	{"copy_", "(Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)Lcom/sun/org/apache/bcel/internal/classfile/FieldOrMethod;", nullptr, $PROTECTED},
	{"dump", "(Ljava/io/DataOutputStream;)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(FieldOrMethod::*)($DataOutputStream*)>(&FieldOrMethod::dump)), "java.io.IOException"},
	{"getAnnotationEntries", "()[Lcom/sun/org/apache/bcel/internal/classfile/AnnotationEntry;", nullptr, $PUBLIC},
	{"getAttributes", "()[Lcom/sun/org/apache/bcel/internal/classfile/Attribute;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$AttributeArray*(FieldOrMethod::*)()>(&FieldOrMethod::getAttributes))},
	{"getConstantPool", "()Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$ConstantPool*(FieldOrMethod::*)()>(&FieldOrMethod::getConstantPool))},
	{"getGenericSignature", "()Ljava/lang/String;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$String*(FieldOrMethod::*)()>(&FieldOrMethod::getGenericSignature))},
	{"getName", "()Ljava/lang/String;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$String*(FieldOrMethod::*)()>(&FieldOrMethod::getName))},
	{"getNameIndex", "()I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(FieldOrMethod::*)()>(&FieldOrMethod::getNameIndex))},
	{"getSignature", "()Ljava/lang/String;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$String*(FieldOrMethod::*)()>(&FieldOrMethod::getSignature))},
	{"getSignatureIndex", "()I", nullptr, $PUBLIC | $FINAL, $method(static_cast<int32_t(FieldOrMethod::*)()>(&FieldOrMethod::getSignatureIndex))},
	{"setAttributes", "([Lcom/sun/org/apache/bcel/internal/classfile/Attribute;)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(FieldOrMethod::*)($AttributeArray*)>(&FieldOrMethod::setAttributes))},
	{"setConstantPool", "(Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(FieldOrMethod::*)($ConstantPool*)>(&FieldOrMethod::setConstantPool))},
	{"setNameIndex", "(I)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(FieldOrMethod::*)(int32_t)>(&FieldOrMethod::setNameIndex))},
	{"setSignatureIndex", "(I)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(FieldOrMethod::*)(int32_t)>(&FieldOrMethod::setSignatureIndex))},
