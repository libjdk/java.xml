...
$MethodInfo _BCELFactory_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/MethodGen;Ljava/io/PrintWriter;)V", nullptr, 0, $method(static_cast<void(BCELFactory::*)($MethodGen*,$PrintWriter*)>(&BCELFactory::init$))},
	{"createConstant", "(Ljava/lang/Object;)V", nullptr, $PRIVATE, $method(static_cast<void(BCELFactory::*)(Object$*)>(&BCELFactory::createConstant))},
	{"start", "()V", nullptr, $PUBLIC},
	{"updateBranchTargets", "()V", nullptr, $PRIVATE, $method(static_cast<void(BCELFactory::*)()>(&BCELFactory::updateBranchTargets))},
	{"updateExceptionHandlers", "()V", nullptr, $PRIVATE, $method(static_cast<void(BCELFactory::*)()>(&BCELFactory::updateExceptionHandlers))},
	...
	{"visitInstruction", "(Lcom/sun/org/apache/bcel/internal/generic/Instruction;)Z", nullptr, $PRIVATE, $method(static_cast<bool(BCELFactory::*)($Instruction*)>(&BCELFactory::visitInstruction))},
