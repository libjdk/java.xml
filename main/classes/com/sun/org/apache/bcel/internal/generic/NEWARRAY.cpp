...
$MethodInfo _NEWARRAY_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(NEWARRAY::*)()>(&NEWARRAY::init$))},
	{"<init>", "(B)V", nullptr, $PUBLIC, $method(static_cast<void(NEWARRAY::*)(int8_t)>(&NEWARRAY::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/BasicType;)V", nullptr, $PUBLIC, $method(static_cast<void(NEWARRAY::*)($BasicType*)>(&NEWARRAY::init$))},
	...
	{"getType", "()Lcom/sun/org/apache/bcel/internal/generic/Type;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$Type*(NEWARRAY::*)()>(&NEWARRAY::getType))},
	{"getTypecode", "()B", nullptr, $PUBLIC | $FINAL, $method(static_cast<int8_t(NEWARRAY::*)()>(&NEWARRAY::getTypecode))},
