...
$MethodInfo _JsrInstruction_MethodInfo_[] = {
	...
	{"<init>", "(SLcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V", nullptr, 0, $method(static_cast<void(JsrInstruction::*)(int16_t,$InstructionHandle*)>(&JsrInstruction::init$))},
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(JsrInstruction::*)()>(&JsrInstruction::init$))},
	...
	{"physicalSuccessor", "()Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;", nullptr, $PUBLIC},
