...
$MethodInfo _LineNumber_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/classfile/LineNumber;)V", nullptr, $PUBLIC, $method(static_cast<void(LineNumber::*)(LineNumber*)>(&LineNumber::init$))},
	{"<init>", "(Ljava/io/DataInput;)V", nullptr, 0, $method(static_cast<void(LineNumber::*)($DataInput*)>(&LineNumber::init$)), "java.io.IOException"},
	{"<init>", "(II)V", nullptr, $PUBLIC, $method(static_cast<void(LineNumber::*)(int32_t,int32_t)>(&LineNumber::init$))},
	{"accept", "(Lcom/sun/org/apache/bcel/internal/classfile/Visitor;)V", nullptr, $PUBLIC},
	{"copy", "()Lcom/sun/org/apache/bcel/internal/classfile/LineNumber;", nullptr, $PUBLIC, $method(static_cast<LineNumber*(LineNumber::*)()>(&LineNumber::copy))},
	{"dump", "(Ljava/io/DataOutputStream;)V", nullptr, $PUBLIC, $method(static_cast<void(LineNumber::*)($DataOutputStream*)>(&LineNumber::dump)), "java.io.IOException"},
	{"getLineNumber", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(LineNumber::*)()>(&LineNumber::getLineNumber))},
	{"getStartPC", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(LineNumber::*)()>(&LineNumber::getStartPC))},
	{"setLineNumber", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(LineNumber::*)(int32_t)>(&LineNumber::setLineNumber))},
	{"setStartPC", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(LineNumber::*)(int32_t)>(&LineNumber::setStartPC))},
