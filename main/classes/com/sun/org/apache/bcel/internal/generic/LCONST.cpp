...
$MethodInfo _LCONST_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(LCONST::*)()>(&LCONST::init$))},
	{"<init>", "(J)V", nullptr, $PUBLIC, $method(static_cast<void(LCONST::*)(int64_t)>(&LCONST::init$))},
	...
	{"getValue", "()Ljava/lang/Number;", nullptr, $PUBLIC},
