...
$MethodInfo _ConstantInteger_MethodInfo_[] = {
	...
	{"<init>", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(ConstantInteger::*)(int32_t)>(&ConstantInteger::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/classfile/ConstantInteger;)V", nullptr, $PUBLIC, $method(static_cast<void(ConstantInteger::*)(ConstantInteger*)>(&ConstantInteger::init$))},
	{"<init>", "(Ljava/io/DataInput;)V", nullptr, 0, $method(static_cast<void(ConstantInteger::*)($DataInput*)>(&ConstantInteger::init$)), "java.io.IOException"},
	...
	{"getBytes", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(ConstantInteger::*)()>(&ConstantInteger::getBytes))},
	{"getConstantValue", "(Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)Ljava/lang/Object;", nullptr, $PUBLIC},
	{"setBytes", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(ConstantInteger::*)(int32_t)>(&ConstantInteger::setBytes))},
