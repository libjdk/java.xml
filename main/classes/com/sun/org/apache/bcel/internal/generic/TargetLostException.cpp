...
TargetLostException::TargetLostException(const TargetLostException& e) {
}

TargetLostException TargetLostException::wrapper$() {
	$pendingException(this);
	return *this;
}

void TargetLostException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
