...
$MethodInfo _MULTIANEWARRAY_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(MULTIANEWARRAY::*)()>(&MULTIANEWARRAY::init$))},
	{"<init>", "(IS)V", nullptr, $PUBLIC, $method(static_cast<void(MULTIANEWARRAY::*)(int32_t,int16_t)>(&MULTIANEWARRAY::init$))},
	...
	{"getDimensions", "()S", nullptr, $PUBLIC | $FINAL, $method(static_cast<int16_t(MULTIANEWARRAY::*)()>(&MULTIANEWARRAY::getDimensions))},
