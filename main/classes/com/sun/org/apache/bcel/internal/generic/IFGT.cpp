...
$MethodInfo _IFGT_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(IFGT::*)()>(&IFGT::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V", nullptr, $PUBLIC, $method(static_cast<void(IFGT::*)($InstructionHandle*)>(&IFGT::init$))},
