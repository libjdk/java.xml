...
$MethodInfo _Select_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(Select::*)()>(&Select::init$))},
	{"<init>", "(S[I[Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V", nullptr, 0, $method(static_cast<void(Select::*)(int16_t,$ints*,$InstructionHandleArray*,$InstructionHandle*)>(&Select::init$))},
	...
	{"getFixed_length", "()I", nullptr, $FINAL, $method(static_cast<int32_t(Select::*)()>(&Select::getFixed_length))},
	{"getIndices", "()[I", nullptr, $PUBLIC},
	{"getIndices", "(I)I", nullptr, $FINAL, $method(static_cast<int32_t(Select::*)(int32_t)>(&Select::getIndices))},
	{"getMatch", "(I)I", nullptr, $FINAL, $method(static_cast<int32_t(Select::*)(int32_t)>(&Select::getMatch))},
	{"getMatch_length", "()I", nullptr, $FINAL, $method(static_cast<int32_t(Select::*)()>(&Select::getMatch_length))},
	{"getMatchs", "()[I", nullptr, $PUBLIC},
	{"getPadding", "()I", nullptr, $FINAL, $method(static_cast<int32_t(Select::*)()>(&Select::getPadding))},
	{"getTarget", "(I)Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;", nullptr, $FINAL, $method(static_cast<$InstructionHandle*(Select::*)(int32_t)>(&Select::getTarget))},
	{"getTargets", "()[Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;", nullptr, $PUBLIC},
	...
	{"setFixed_length", "(I)V", nullptr, $FINAL, $method(static_cast<void(Select::*)(int32_t)>(&Select::setFixed_length))},
	{"setIndices", "([I)V", nullptr, $FINAL, $method(static_cast<void(Select::*)($ints*)>(&Select::setIndices))},
	{"setIndices", "(II)I", nullptr, $FINAL, $method(static_cast<int32_t(Select::*)(int32_t,int32_t)>(&Select::setIndices))},
	{"setMatch", "(II)V", nullptr, $FINAL, $method(static_cast<void(Select::*)(int32_t,int32_t)>(&Select::setMatch))},
	{"setMatch_length", "(I)I", nullptr, $FINAL, $method(static_cast<int32_t(Select::*)(int32_t)>(&Select::setMatch_length))},
	{"setMatches", "([I)V", nullptr, $FINAL, $method(static_cast<void(Select::*)($ints*)>(&Select::setMatches))},
	{"setTarget", "(ILcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V", nullptr, $PUBLIC},
	{"setTargets", "([Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V", nullptr, $FINAL, $method(static_cast<void(Select::*)($InstructionHandleArray*)>(&Select::setTargets))},
