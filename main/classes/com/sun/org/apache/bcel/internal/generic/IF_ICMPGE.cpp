...
$MethodInfo _IF_ICMPGE_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(IF_ICMPGE::*)()>(&IF_ICMPGE::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V", nullptr, $PUBLIC, $method(static_cast<void(IF_ICMPGE::*)($InstructionHandle*)>(&IF_ICMPGE::init$))},
