...
$MethodInfo _CodeExceptionGen_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;Lcom/sun/org/apache/bcel/internal/generic/ObjectType;)V", nullptr, $PUBLIC, $method(static_cast<void(CodeExceptionGen::*)($InstructionHandle*,$InstructionHandle*,$InstructionHandle*,$ObjectType*)>(&CodeExceptionGen::init$))},
	{"clone", "()Ljava/lang/Object;", nullptr, $PUBLIC},
	{"containsTarget", "(Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)Z", nullptr, $PUBLIC},
	{"getCatchType", "()Lcom/sun/org/apache/bcel/internal/generic/ObjectType;", nullptr, $PUBLIC, $method(static_cast<$ObjectType*(CodeExceptionGen::*)()>(&CodeExceptionGen::getCatchType))},
	{"getCodeException", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;)Lcom/sun/org/apache/bcel/internal/classfile/CodeException;", nullptr, $PUBLIC, $method(static_cast<$CodeException*(CodeExceptionGen::*)($ConstantPoolGen*)>(&CodeExceptionGen::getCodeException))},
	{"getEndPC", "()Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;", nullptr, $PUBLIC, $method(static_cast<$InstructionHandle*(CodeExceptionGen::*)()>(&CodeExceptionGen::getEndPC))},
	{"getHandlerPC", "()Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;", nullptr, $PUBLIC, $method(static_cast<$InstructionHandle*(CodeExceptionGen::*)()>(&CodeExceptionGen::getHandlerPC))},
	{"getStartPC", "()Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;", nullptr, $PUBLIC, $method(static_cast<$InstructionHandle*(CodeExceptionGen::*)()>(&CodeExceptionGen::getStartPC))},
	{"setCatchType", "(Lcom/sun/org/apache/bcel/internal/generic/ObjectType;)V", nullptr, $PUBLIC, $method(static_cast<void(CodeExceptionGen::*)($ObjectType*)>(&CodeExceptionGen::setCatchType))},
	{"setEndPC", "(Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V", nullptr, $PUBLIC, $method(static_cast<void(CodeExceptionGen::*)($InstructionHandle*)>(&CodeExceptionGen::setEndPC))},
	{"setHandlerPC", "(Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V", nullptr, $PUBLIC, $method(static_cast<void(CodeExceptionGen::*)($InstructionHandle*)>(&CodeExceptionGen::setHandlerPC))},
	{"setStartPC", "(Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V", nullptr, $PUBLIC, $method(static_cast<void(CodeExceptionGen::*)($InstructionHandle*)>(&CodeExceptionGen::setStartPC))},
