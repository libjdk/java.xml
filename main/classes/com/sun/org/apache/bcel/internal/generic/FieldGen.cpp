...
$MethodInfo _FieldGen_MethodInfo_[] = {
	{"<init>", "(ILcom/sun/org/apache/bcel/internal/generic/Type;Ljava/lang/String;Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;)V", nullptr, $PUBLIC, $method(static_cast<void(FieldGen::*)(int32_t,$Type*,$String*,$ConstantPoolGen*)>(&FieldGen::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/classfile/Field;Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;)V", nullptr, $PUBLIC, $method(static_cast<void(FieldGen::*)($Field*,$ConstantPoolGen*)>(&FieldGen::init$))},
	{"addAnnotationsAsAttribute", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;)V", nullptr, $PRIVATE, $method(static_cast<void(FieldGen::*)($ConstantPoolGen*)>(&FieldGen::addAnnotationsAsAttribute))},
	{"addConstant", "()I", nullptr, $PRIVATE, $method(static_cast<int32_t(FieldGen::*)()>(&FieldGen::addConstant))},
	{"addObserver", "(Lcom/sun/org/apache/bcel/internal/generic/FieldObserver;)V", nullptr, $PUBLIC},
	{"cancelInitValue", "()V", nullptr, $PUBLIC},
	{"checkType", "(Lcom/sun/org/apache/bcel/internal/generic/Type;)V", nullptr, $PRIVATE, $method(static_cast<void(FieldGen::*)($Type*)>(&FieldGen::checkType))},
	{"copy", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;)Lcom/sun/org/apache/bcel/internal/generic/FieldGen;", nullptr, $PUBLIC},
	{"equals", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC},
	{"getComparator", "()Lcom/sun/org/apache/bcel/internal/util/BCELComparator;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$BCELComparator*(*)()>(&FieldGen::getComparator))},
	{"getField", "()Lcom/sun/org/apache/bcel/internal/classfile/Field;", nullptr, $PUBLIC},
	{"getInitValue", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getSignature", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"hashCode", "()I", nullptr, $PUBLIC},
	{"removeObserver", "(Lcom/sun/org/apache/bcel/internal/generic/FieldObserver;)V", nullptr, $PUBLIC},
	{"setComparator", "(Lcom/sun/org/apache/bcel/internal/util/BCELComparator;)V", nullptr, $PUBLIC | $STATIC, $method(static_cast<void(*)($BCELComparator*)>(&FieldGen::setComparator))},
	{"setInitValue", "(Ljava/lang/String;)V", nullptr, $PUBLIC},
	{"setInitValue", "(J)V", nullptr, $PUBLIC},
	{"setInitValue", "(I)V", nullptr, $PUBLIC},
	{"setInitValue", "(S)V", nullptr, $PUBLIC},
	{"setInitValue", "(C)V", nullptr, $PUBLIC},
	{"setInitValue", "(B)V", nullptr, $PUBLIC},
	{"setInitValue", "(Z)V", nullptr, $PUBLIC},
	{"setInitValue", "(F)V", nullptr, $PUBLIC},
	{"setInitValue", "(D)V", nullptr, $PUBLIC},
	{"setValue", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(FieldGen::*)(int32_t)>(&FieldGen::setValue))},
