...
$MethodInfo _JSR_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(JSR::*)()>(&JSR::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V", nullptr, $PUBLIC, $method(static_cast<void(JSR::*)($InstructionHandle*)>(&JSR::init$))},
