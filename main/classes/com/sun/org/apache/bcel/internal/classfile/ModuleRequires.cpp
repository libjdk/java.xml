...
$MethodInfo _ModuleRequires_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/io/DataInput;)V", nullptr, 0, $method(static_cast<void(ModuleRequires::*)($DataInput*)>(&ModuleRequires::init$)), "java.io.IOException"},
	{"accept", "(Lcom/sun/org/apache/bcel/internal/classfile/Visitor;)V", nullptr, $PUBLIC},
	{"copy", "()Lcom/sun/org/apache/bcel/internal/classfile/ModuleRequires;", nullptr, $PUBLIC, $method(static_cast<ModuleRequires*(ModuleRequires::*)()>(&ModuleRequires::copy))},
	{"dump", "(Ljava/io/DataOutputStream;)V", nullptr, $PUBLIC, $method(static_cast<void(ModuleRequires::*)($DataOutputStream*)>(&ModuleRequires::dump)), "java.io.IOException"},
	{"toString", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"toString", "(Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(ModuleRequires::*)($ConstantPool*)>(&ModuleRequires::toString))},
	{}
};
