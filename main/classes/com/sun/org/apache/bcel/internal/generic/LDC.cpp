...
$MethodInfo _LDC_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(LDC::*)()>(&LDC::init$))},
	{"<init>", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(LDC::*)(int32_t)>(&LDC::init$))},
	...
	{"getValue", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;)Ljava/lang/Object;", nullptr, $PUBLIC},
	...
	{"setSize", "()V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(LDC::*)()>(&LDC::setSize))},
