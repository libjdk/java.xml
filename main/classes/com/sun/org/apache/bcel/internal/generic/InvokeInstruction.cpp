...
$MethodInfo _InvokeInstruction_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(InvokeInstruction::*)()>(&InvokeInstruction::init$))},
	{"<init>", "(SI)V", nullptr, $PROTECTED, $method(static_cast<void(InvokeInstruction::*)(int16_t,int32_t)>(&InvokeInstruction::init$))},
	{"consumeStack", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;)I", nullptr, $PUBLIC},
	{"getArgumentTypes", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;)[Lcom/sun/org/apache/bcel/internal/generic/Type;", nullptr, $PUBLIC},
	{"getClassName", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;)Ljava/lang/String;", nullptr, $PUBLIC | $DEPRECATED, nullptr, nullptr, nullptr, _InvokeInstruction_MethodAnnotations_getClassName4},
	{"getMethodName", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;)Ljava/lang/String;", nullptr, $PUBLIC},
	{"getReturnType", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;)Lcom/sun/org/apache/bcel/internal/generic/Type;", nullptr, $PUBLIC},
