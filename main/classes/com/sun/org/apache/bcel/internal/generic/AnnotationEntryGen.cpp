...
$MethodInfo _AnnotationEntryGen_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/classfile/AnnotationEntry;Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Z)V", nullptr, $PUBLIC, $method(static_cast<void(AnnotationEntryGen::*)($AnnotationEntry*,$ConstantPoolGen*,bool)>(&AnnotationEntryGen::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;)V", nullptr, $PRIVATE, $method(static_cast<void(AnnotationEntryGen::*)($ConstantPoolGen*)>(&AnnotationEntryGen::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/ObjectType;Ljava/util/List;ZLcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;)V", "(Lcom/sun/org/apache/bcel/internal/generic/ObjectType;Ljava/util/List<Lcom/sun/org/apache/bcel/internal/generic/ElementValuePairGen;>;ZLcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;)V", $PUBLIC, $method(static_cast<void(AnnotationEntryGen::*)($ObjectType*,$List*,bool,$ConstantPoolGen*)>(&AnnotationEntryGen::init$))},
	{"addElementNameValuePair", "(Lcom/sun/org/apache/bcel/internal/generic/ElementValuePairGen;)V", nullptr, $PUBLIC},
	{"copyValues", "([Lcom/sun/org/apache/bcel/internal/classfile/ElementValuePair;Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Z)Ljava/util/List;", "([Lcom/sun/org/apache/bcel/internal/classfile/ElementValuePair;Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Z)Ljava/util/List<Lcom/sun/org/apache/bcel/internal/generic/ElementValuePairGen;>;", $PRIVATE, $method(static_cast<$List*(AnnotationEntryGen::*)($ElementValuePairArray*,$ConstantPoolGen*,bool)>(&AnnotationEntryGen::copyValues))},
	{"dump", "(Ljava/io/DataOutputStream;)V", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"getAnnotation", "()Lcom/sun/org/apache/bcel/internal/classfile/AnnotationEntry;", nullptr, $PUBLIC},
	{"getAnnotationAttributes", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;[Lcom/sun/org/apache/bcel/internal/generic/AnnotationEntryGen;)[Lcom/sun/org/apache/bcel/internal/classfile/Attribute;", nullptr, $STATIC, $method(static_cast<$AttributeArray*(*)($ConstantPoolGen*,$AnnotationEntryGenArray*)>(&AnnotationEntryGen::getAnnotationAttributes))},
	{"getParameterAnnotationAttributes", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;[Ljava/util/List;)[Lcom/sun/org/apache/bcel/internal/classfile/Attribute;", "(Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;[Ljava/util/List<Lcom/sun/org/apache/bcel/internal/generic/AnnotationEntryGen;>;)[Lcom/sun/org/apache/bcel/internal/classfile/Attribute;", $STATIC, $method(static_cast<$AttributeArray*(*)($ConstantPoolGen*,$ListArray*)>(&AnnotationEntryGen::getParameterAnnotationAttributes))},
	{"getTypeIndex", "()I", nullptr, $PUBLIC},
	{"getTypeName", "()Ljava/lang/String;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$String*(AnnotationEntryGen::*)()>(&AnnotationEntryGen::getTypeName))},
	{"getTypeSignature", "()Ljava/lang/String;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$String*(AnnotationEntryGen::*)()>(&AnnotationEntryGen::getTypeSignature))},
	{"getValues", "()Ljava/util/List;", "()Ljava/util/List<Lcom/sun/org/apache/bcel/internal/generic/ElementValuePairGen;>;", $PUBLIC},
	{"isRuntimeVisible", "(Z)V", nullptr, $PRIVATE, $method(static_cast<void(AnnotationEntryGen::*)(bool)>(&AnnotationEntryGen::isRuntimeVisible))},
	{"isRuntimeVisible", "()Z", nullptr, $PUBLIC},
	{"read", "(Ljava/io/DataInput;Lcom/sun/org/apache/bcel/internal/generic/ConstantPoolGen;Z)Lcom/sun/org/apache/bcel/internal/generic/AnnotationEntryGen;", nullptr, $PUBLIC | $STATIC, $method(static_cast<AnnotationEntryGen*(*)($DataInput*,$ConstantPoolGen*,bool)>(&AnnotationEntryGen::read)), "java.io.IOException"},
