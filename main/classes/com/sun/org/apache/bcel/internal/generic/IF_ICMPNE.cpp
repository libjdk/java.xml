...
$MethodInfo _IF_ICMPNE_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(IF_ICMPNE::*)()>(&IF_ICMPNE::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V", nullptr, $PUBLIC, $method(static_cast<void(IF_ICMPNE::*)($InstructionHandle*)>(&IF_ICMPNE::init$))},
