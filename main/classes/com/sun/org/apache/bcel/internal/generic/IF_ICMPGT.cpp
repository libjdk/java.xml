...
$MethodInfo _IF_ICMPGT_MethodInfo_[] = {
	{"<init>", "()V", nullptr, 0, $method(static_cast<void(IF_ICMPGT::*)()>(&IF_ICMPGT::init$))},
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/generic/InstructionHandle;)V", nullptr, $PUBLIC, $method(static_cast<void(IF_ICMPGT::*)($InstructionHandle*)>(&IF_ICMPGT::init$))},
