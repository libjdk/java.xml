...
$MethodInfo _Code_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/bcel/internal/classfile/Code;)V", nullptr, $PUBLIC, $method(static_cast<void(Code::*)(Code*)>(&Code::init$))},
	{"<init>", "(IILjava/io/DataInput;Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)V", nullptr, 0, $method(static_cast<void(Code::*)(int32_t,int32_t,$DataInput*,$ConstantPool*)>(&Code::init$)), "java.io.IOException"},
	{"<init>", "(IIII[B[Lcom/sun/org/apache/bcel/internal/classfile/CodeException;[Lcom/sun/org/apache/bcel/internal/classfile/Attribute;Lcom/sun/org/apache/bcel/internal/classfile/ConstantPool;)V", nullptr, $PUBLIC, $method(static_cast<void(Code::*)(int32_t,int32_t,int32_t,int32_t,$bytes*,$CodeExceptionArray*,$AttributeArray*,$ConstantPool*)>(&Code::init$))},
	{"accept", "(Lcom/sun/org/apache/bcel/internal/classfile/Visitor;)V", nullptr, $PUBLIC},
	{"calculateLength", "()I", nullptr, $PRIVATE, $method(static_cast<int32_t(Code::*)()>(&Code::calculateLength))},
	...
	{"getAttributes", "()[Lcom/sun/org/apache/bcel/internal/classfile/Attribute;", nullptr, $PUBLIC, $method(static_cast<$AttributeArray*(Code::*)()>(&Code::getAttributes))},
	{"getCode", "()[B", nullptr, $PUBLIC, $method(static_cast<$bytes*(Code::*)()>(&Code::getCode))},
	{"getExceptionTable", "()[Lcom/sun/org/apache/bcel/internal/classfile/CodeException;", nullptr, $PUBLIC, $method(static_cast<$CodeExceptionArray*(Code::*)()>(&Code::getExceptionTable))},
	{"getInternalLength", "()I", nullptr, $PRIVATE, $method(static_cast<int32_t(Code::*)()>(&Code::getInternalLength))},
	{"getLineNumberTable", "()Lcom/sun/org/apache/bcel/internal/classfile/LineNumberTable;", nullptr, $PUBLIC, $method(static_cast<$LineNumberTable*(Code::*)()>(&Code::getLineNumberTable))},
	{"getLocalVariableTable", "()Lcom/sun/org/apache/bcel/internal/classfile/LocalVariableTable;", nullptr, $PUBLIC, $method(static_cast<$LocalVariableTable*(Code::*)()>(&Code::getLocalVariableTable))},
	{"getMaxLocals", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(Code::*)()>(&Code::getMaxLocals))},
	{"getMaxStack", "()I", nullptr, $PUBLIC, $method(static_cast<int32_t(Code::*)()>(&Code::getMaxStack))},
	{"setAttributes", "([Lcom/sun/org/apache/bcel/internal/classfile/Attribute;)V", nullptr, $PUBLIC, $method(static_cast<void(Code::*)($AttributeArray*)>(&Code::setAttributes))},
	{"setCode", "([B)V", nullptr, $PUBLIC, $method(static_cast<void(Code::*)($bytes*)>(&Code::setCode))},
	{"setExceptionTable", "([Lcom/sun/org/apache/bcel/internal/classfile/CodeException;)V", nullptr, $PUBLIC, $method(static_cast<void(Code::*)($CodeExceptionArray*)>(&Code::setExceptionTable))},
	{"setMaxLocals", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(Code::*)(int32_t)>(&Code::setMaxLocals))},
	{"setMaxStack", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(Code::*)(int32_t)>(&Code::setMaxStack))},
	{"toString", "(Z)Ljava/lang/String;", nullptr, $PUBLIC, $method(static_cast<$String*(Code::*)(bool)>(&Code::toString))},
