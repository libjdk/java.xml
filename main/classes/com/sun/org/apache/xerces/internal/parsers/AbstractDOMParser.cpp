...
$MethodInfo _AbstractDOMParser_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/xni/parser/XMLParserConfiguration;)V", nullptr, $PROTECTED, $method(static_cast<void(AbstractDOMParser::*)($XMLParserConfiguration*)>(&AbstractDOMParser::init$))},
	...
	{"createAttrNode", "(Lcom/sun/org/apache/xerces/internal/xni/QName;)Lorg/w3c/dom/Attr;", nullptr, $PROTECTED},
	{"createElementNode", "(Lcom/sun/org/apache/xerces/internal/xni/QName;)Lorg/w3c/dom/Element;", nullptr, $PROTECTED},
	...
	{"dropDocumentReferences", "()V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(AbstractDOMParser::*)()>(&AbstractDOMParser::dropDocumentReferences))},
	...
	{"getDocumentClassName", "()Ljava/lang/String;", nullptr, $PROTECTED},
	{"handleBaseURI", "(Lorg/w3c/dom/Node;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(AbstractDOMParser::*)($Node*)>(&AbstractDOMParser::handleBaseURI))},
	{"handleBaseURI", "(I)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(AbstractDOMParser::*)(int32_t)>(&AbstractDOMParser::handleBaseURI))},
	...
	{"setCharacterData", "(Z)V", nullptr, $PROTECTED},
	{"setDocumentClassName", "(Ljava/lang/String;)V", nullptr, $PROTECTED},
