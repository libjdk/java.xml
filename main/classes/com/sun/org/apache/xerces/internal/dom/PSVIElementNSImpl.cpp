...
$MethodInfo _PSVIElementNSImpl_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/dom/CoreDocumentImpl;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(PSVIElementNSImpl::*)($CoreDocumentImpl*,$String*,$String*,$String*)>(&PSVIElementNSImpl::init$))},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/dom/CoreDocumentImpl;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(PSVIElementNSImpl::*)($CoreDocumentImpl*,$String*,$String*)>(&PSVIElementNSImpl::init$))},
	{"constant", "()Lcom/sun/org/apache/xerces/internal/xs/ItemPSVI;", nullptr, $PUBLIC},
	{"getActualNormalizedValue", "()Ljava/lang/Object;", nullptr, $PUBLIC | $DEPRECATED, nullptr, nullptr, nullptr, _PSVIElementNSImpl_MethodAnnotations_getActualNormalizedValue3},
	{"getActualNormalizedValueType", "()S", nullptr, $PUBLIC | $DEPRECATED, nullptr, nullptr, nullptr, _PSVIElementNSImpl_MethodAnnotations_getActualNormalizedValueType4},
	{"getElementDeclaration", "()Lcom/sun/org/apache/xerces/internal/xs/XSElementDeclaration;", nullptr, $PUBLIC},
	{"getErrorCodes", "()Lcom/sun/org/apache/xerces/internal/xs/StringList;", nullptr, $PUBLIC},
	{"getErrorMessages", "()Lcom/sun/org/apache/xerces/internal/xs/StringList;", nullptr, $PUBLIC},
	{"getIsSchemaSpecified", "()Z", nullptr, $PUBLIC},
	{"getItemValueTypes", "()Lcom/sun/org/apache/xerces/internal/xs/ShortList;", nullptr, $PUBLIC | $DEPRECATED, nullptr, nullptr, nullptr, _PSVIElementNSImpl_MethodAnnotations_getItemValueTypes9},
	{"getMemberTypeDefinition", "()Lcom/sun/org/apache/xerces/internal/xs/XSSimpleTypeDefinition;", nullptr, $PUBLIC},
	{"getNil", "()Z", nullptr, $PUBLIC},
	{"getNotation", "()Lcom/sun/org/apache/xerces/internal/xs/XSNotationDeclaration;", nullptr, $PUBLIC},
	{"getSchemaDefault", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getSchemaInformation", "()Lcom/sun/org/apache/xerces/internal/xs/XSModel;", nullptr, $PUBLIC},
	{"getSchemaNormalizedValue", "()Ljava/lang/String;", nullptr, $PUBLIC | $DEPRECATED, nullptr, nullptr, nullptr, _PSVIElementNSImpl_MethodAnnotations_getSchemaNormalizedValue15},
	{"getSchemaValue", "()Lcom/sun/org/apache/xerces/internal/xs/XSValue;", nullptr, $PUBLIC},
	{"getTypeDefinition", "()Lcom/sun/org/apache/xerces/internal/xs/XSTypeDefinition;", nullptr, $PUBLIC},
	{"getValidationAttempted", "()S", nullptr, $PUBLIC},
	{"getValidationContext", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getValidity", "()S", nullptr, $PUBLIC},
	{"isConstant", "()Z", nullptr, $PUBLIC},
	{"readObject", "(Ljava/io/ObjectInputStream;)V", nullptr, $PRIVATE, $method(static_cast<void(PSVIElementNSImpl::*)($ObjectInputStream*)>(&PSVIElementNSImpl::readObject)), "java.io.IOException,java.lang.ClassNotFoundException"},
	{"setPSVI", "(Lcom/sun/org/apache/xerces/internal/xs/ElementPSVI;)V", nullptr, $PUBLIC},
	{"*toString", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"writeObject", "(Ljava/io/ObjectOutputStream;)V", nullptr, $PRIVATE, $method(static_cast<void(PSVIElementNSImpl::*)($ObjectOutputStream*)>(&PSVIElementNSImpl::writeObject)), "java.io.IOException"},
	{}
};
