...
$MethodInfo _XSComplexTypeDecl_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(XSComplexTypeDecl::*)()>(&XSComplexTypeDecl::init$))},
	{"appendTypeInfo", "(Ljava/lang/StringBuilder;)V", nullptr, 0},
	{"containsTypeID", "()Z", nullptr, $PUBLIC},
	...
	{"getAbstract", "()Z", nullptr, $PUBLIC},
	{"getAnnotations", "()Lcom/sun/org/apache/xerces/internal/xs/XSObjectList;", nullptr, $PUBLIC},
	{"getAnonymous", "()Z", nullptr, $PUBLIC},
	{"getAttrGrp", "()Lcom/sun/org/apache/xerces/internal/impl/xs/XSAttributeGroupDecl;", nullptr, $PUBLIC},
	{"getAttributeUse", "(Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/XSAttributeUse;", nullptr, $PUBLIC},
	{"getAttributeUses", "()Lcom/sun/org/apache/xerces/internal/xs/XSObjectList;", nullptr, $PUBLIC},
	{"getAttributeWildcard", "()Lcom/sun/org/apache/xerces/internal/xs/XSWildcard;", nullptr, $PUBLIC},
	{"getBaseType", "()Lcom/sun/org/apache/xerces/internal/xs/XSTypeDefinition;", nullptr, $PUBLIC},
	{"getContentModel", "(Lcom/sun/org/apache/xerces/internal/impl/xs/models/CMBuilder;)Lcom/sun/org/apache/xerces/internal/impl/xs/models/XSCMValidator;", nullptr, $PUBLIC},
	{"getContentModel", "(Lcom/sun/org/apache/xerces/internal/impl/xs/models/CMBuilder;Z)Lcom/sun/org/apache/xerces/internal/impl/xs/models/XSCMValidator;", nullptr, $PUBLIC | $SYNCHRONIZED},
	{"getContentType", "()S", nullptr, $PUBLIC},
	{"getDerivationMethod", "()S", nullptr, $PUBLIC},
	{"getFinal", "()S", nullptr, $PUBLIC},
	{"getFinalSet", "()S", nullptr, $PUBLIC},
	...
	{"getParticle", "()Lcom/sun/org/apache/xerces/internal/xs/XSParticle;", nullptr, $PUBLIC},
	{"getProhibitedSubstitutions", "()S", nullptr, $PUBLIC},
	{"getSimpleType", "()Lcom/sun/org/apache/xerces/internal/xs/XSSimpleTypeDefinition;", nullptr, $PUBLIC},
	{"getTargetNamespace", "()Ljava/lang/String;", nullptr, $PUBLIC},
	...
	{"isDerivedByAny", "(Ljava/lang/String;Ljava/lang/String;ILcom/sun/org/apache/xerces/internal/xs/XSTypeDefinition;)Z", nullptr, $PRIVATE, $method(static_cast<bool(XSComplexTypeDecl::*)($String*,$String*,int32_t,$XSTypeDefinition*)>(&XSComplexTypeDecl::isDerivedByAny))},
	{"isDerivedByExtension", "(Ljava/lang/String;Ljava/lang/String;ILcom/sun/org/apache/xerces/internal/xs/XSTypeDefinition;)Z", nullptr, $PRIVATE, $method(static_cast<bool(XSComplexTypeDecl::*)($String*,$String*,int32_t,$XSTypeDefinition*)>(&XSComplexTypeDecl::isDerivedByExtension))},
	{"isDerivedByRestriction", "(Ljava/lang/String;Ljava/lang/String;ILcom/sun/org/apache/xerces/internal/xs/XSTypeDefinition;)Z", nullptr, $PRIVATE, $method(static_cast<bool(XSComplexTypeDecl::*)($String*,$String*,int32_t,$XSTypeDefinition*)>(&XSComplexTypeDecl::isDerivedByRestriction))},
	{"isDerivedFrom", "(Ljava/lang/String;Ljava/lang/String;I)Z", nullptr, $PUBLIC},
	{"isFinal", "(S)Z", nullptr, $PUBLIC},
	{"isProhibitedSubstitution", "(S)Z", nullptr, $PUBLIC},
