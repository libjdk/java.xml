...
$MethodInfo _XMLEntityManager_MethodInfo_[] = {
	...
	{"closeReaders", "()V", nullptr, $PUBLIC},
	{"createOutputStream", "(Ljava/lang/String;)Ljava/io/OutputStream;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$OutputStream*(*)($String*)>(&XMLEntityManager::createOutputStream)), "java.io.IOException"},
	{"createReader", "(Ljava/io/InputStream;Ljava/lang/String;Ljava/lang/Boolean;)Ljava/io/Reader;", nullptr, $PROTECTED, nullptr, "java.io.IOException"},
	{"endEntity", "()V", nullptr, $PUBLIC, nullptr, "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"endExternalSubset", "()V", nullptr, $PUBLIC},
	{"expandSystemId", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*)>(&XMLEntityManager::expandSystemId))},
	{"expandSystemId", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*,$String*)>(&XMLEntityManager::expandSystemId))},
	{"expandSystemId", "(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*,$String*,bool)>(&XMLEntityManager::expandSystemId)), "com.sun.org.apache.xerces.internal.util.URI$MalformedURIException"},
	{"expandSystemIdStrictOff", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*,$String*)>(&XMLEntityManager::expandSystemIdStrictOff)), "com.sun.org.apache.xerces.internal.util.URI$MalformedURIException"},
	{"expandSystemIdStrictOff1", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*,$String*)>(&XMLEntityManager::expandSystemIdStrictOff1)), "java.net.URISyntaxException,com.sun.org.apache.xerces.internal.util.URI$MalformedURIException"},
	{"expandSystemIdStrictOn", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*,$String*)>(&XMLEntityManager::expandSystemIdStrictOn)), "com.sun.org.apache.xerces.internal.util.URI$MalformedURIException"},
	{"fixURI", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PROTECTED | $STATIC, $method(static_cast<$String*(*)($String*)>(&XMLEntityManager::fixURI))},
	{"getColumnNumber", "()I", nullptr, $PUBLIC},
	{"getCurrentEntity", "()Lcom/sun/xml/internal/stream/Entity$ScannedEntity;", nullptr, $PUBLIC},
	{"getCurrentResourceIdentifier", "()Lcom/sun/org/apache/xerces/internal/xni/XMLResourceIdentifier;", nullptr, $PUBLIC},
	{"getEncodingInfo", "([BI)Lcom/sun/org/apache/xerces/internal/impl/XMLEntityManager$EncodingInfo;", nullptr, $PROTECTED},
	{"getEntityScanner", "()Lcom/sun/org/apache/xerces/internal/impl/XMLEntityScanner;", nullptr, $PUBLIC},
	{"getEntityStore", "()Lcom/sun/xml/internal/stream/XMLEntityStorage;", nullptr, $PUBLIC},
	...
	{"getPathWithoutEscapes", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*)>(&XMLEntityManager::getPathWithoutEscapes))},
	...
	{"print", "()V", nullptr, $FINAL, $method(static_cast<void(XMLEntityManager::*)()>(&XMLEntityManager::print))},
	...
	{"resolveEntity", "(Lcom/sun/org/apache/xerces/internal/xni/XMLResourceIdentifier;)Lcom/sun/org/apache/xerces/internal/xni/parser/XMLInputSource;", nullptr, $PUBLIC, nullptr, "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"resolveEntityAsPerStax", "(Lcom/sun/org/apache/xerces/internal/xni/XMLResourceIdentifier;)Lcom/sun/xml/internal/stream/StaxXMLInputSource;", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"setEntityHandler", "(Lcom/sun/org/apache/xerces/internal/impl/XMLEntityHandler;)V", nullptr, $PUBLIC},
	...
	{"setScannerVersion", "(S)V", nullptr, $PUBLIC},
	{"setStandalone", "(Z)V", nullptr, $PUBLIC},
	{"setupCurrentEntity", "(ZLjava/lang/String;Lcom/sun/org/apache/xerces/internal/xni/parser/XMLInputSource;ZZ)Ljava/lang/String;", nullptr, $PUBLIC, nullptr, "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"startDTDEntity", "(Lcom/sun/org/apache/xerces/internal/xni/parser/XMLInputSource;)V", nullptr, $PUBLIC, nullptr, "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"startDocumentEntity", "(Lcom/sun/org/apache/xerces/internal/xni/parser/XMLInputSource;)V", nullptr, $PUBLIC, nullptr, "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"startEntity", "(ZLjava/lang/String;Z)V", nullptr, $PUBLIC, nullptr, "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"startEntity", "(ZLjava/lang/String;Lcom/sun/org/apache/xerces/internal/xni/parser/XMLInputSource;ZZ)V", nullptr, $PUBLIC, nullptr, "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
