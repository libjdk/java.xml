...
$MethodInfo _ValidatorHandlerImpl$XMLSchemaTypeInfoProvider_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/jaxp/validation/ValidatorHandlerImpl;)V", nullptr, $PRIVATE, $method(static_cast<void(ValidatorHandlerImpl$XMLSchemaTypeInfoProvider::*)($ValidatorHandlerImpl*)>(&ValidatorHandlerImpl$XMLSchemaTypeInfoProvider::init$))},
	{"beginEndElement", "(Lcom/sun/org/apache/xerces/internal/xni/Augmentations;)V", nullptr, 0},
	{"beginStartElement", "(Lcom/sun/org/apache/xerces/internal/xni/Augmentations;Lcom/sun/org/apache/xerces/internal/xni/XMLAttributes;)V", nullptr, 0},
	{"checkState", "(Z)V", nullptr, $PRIVATE, $method(static_cast<void(ValidatorHandlerImpl$XMLSchemaTypeInfoProvider::*)(bool)>(&ValidatorHandlerImpl$XMLSchemaTypeInfoProvider::checkState))},
	{"finishEndElement", "()V", nullptr, 0},
	{"finishStartElement", "()V", nullptr, 0},
	{"getAttributePSVI", "(I)Lcom/sun/org/apache/xerces/internal/xs/AttributePSVI;", nullptr, 0},
	{"getAttributePSVIByName", "(Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/AttributePSVI;", nullptr, 0},
	{"getAttributeType", "(I)Lorg/w3c/dom/TypeInfo;", nullptr, $PRIVATE, $method(static_cast<$TypeInfo*(ValidatorHandlerImpl$XMLSchemaTypeInfoProvider::*)(int32_t)>(&ValidatorHandlerImpl$XMLSchemaTypeInfoProvider::getAttributeType))},
	...
	{"getElementPSVI", "()Lcom/sun/org/apache/xerces/internal/xs/ElementPSVI;", nullptr, 0},
	{"getElementTypeInfo", "()Lorg/w3c/dom/TypeInfo;", nullptr, $PUBLIC},
	{"getTypeInfoFromPSVI", "(Lcom/sun/org/apache/xerces/internal/xs/ItemPSVI;)Lorg/w3c/dom/TypeInfo;", nullptr, $PRIVATE, $method(static_cast<$TypeInfo*(ValidatorHandlerImpl$XMLSchemaTypeInfoProvider::*)($ItemPSVI*)>(&ValidatorHandlerImpl$XMLSchemaTypeInfoProvider::getTypeInfoFromPSVI))},
