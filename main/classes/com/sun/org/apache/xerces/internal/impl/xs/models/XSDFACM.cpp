...
$MethodInfo _XSDFACM_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/impl/dtd/models/CMNode;I)V", nullptr, $PUBLIC, $method(static_cast<void(XSDFACM::*)($CMNode*,int32_t)>(&XSDFACM::init$))},
	{"buildDFA", "(Lcom/sun/org/apache/xerces/internal/impl/dtd/models/CMNode;)V", nullptr, $PRIVATE, $method(static_cast<void(XSDFACM::*)($CMNode*)>(&XSDFACM::buildDFA))},
	{"calcFollowList", "(Lcom/sun/org/apache/xerces/internal/impl/dtd/models/CMNode;)V", nullptr, $PRIVATE, $method(static_cast<void(XSDFACM::*)($CMNode*)>(&XSDFACM::calcFollowList))},
	...
	{"dumpTree", "(Lcom/sun/org/apache/xerces/internal/impl/dtd/models/CMNode;I)V", nullptr, $PRIVATE, $method(static_cast<void(XSDFACM::*)($CMNode*,int32_t)>(&XSDFACM::dumpTree))},
	...
	{"findMatchingDecl", "(Lcom/sun/org/apache/xerces/internal/xni/QName;[ILcom/sun/org/apache/xerces/internal/impl/xs/SubstitutionGroupHandler;I)Ljava/lang/Object;", nullptr, 0},
	{"getTermName", "(I)Ljava/lang/String;", nullptr, $PUBLIC},
	{"isCompactedForUPA", "()Z", nullptr, $PUBLIC},
	{"isFinalState", "(I)Z", nullptr, $PUBLIC},
	{"makeDefStateList", "()[I", nullptr, $PRIVATE, $method(static_cast<$ints*(XSDFACM::*)()>(&XSDFACM::makeDefStateList))},
	...
	{"postTreeBuildInit", "(Lcom/sun/org/apache/xerces/internal/impl/dtd/models/CMNode;)V", nullptr, $PRIVATE, $method(static_cast<void(XSDFACM::*)($CMNode*)>(&XSDFACM::postTreeBuildInit)), "java.lang.RuntimeException"},
