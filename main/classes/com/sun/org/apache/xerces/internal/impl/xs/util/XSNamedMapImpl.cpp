...
$MethodInfo _XSNamedMapImpl_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/util/SymbolHash;)V", nullptr, $PUBLIC, $method(static_cast<void(XSNamedMapImpl::*)($String*,$SymbolHash*)>(&XSNamedMapImpl::init$))},
	{"<init>", "([Ljava/lang/String;[Lcom/sun/org/apache/xerces/internal/util/SymbolHash;I)V", nullptr, $PUBLIC, $method(static_cast<void(XSNamedMapImpl::*)($StringArray*,$SymbolHashArray*,int32_t)>(&XSNamedMapImpl::init$))},
	{"<init>", "([Lcom/sun/org/apache/xerces/internal/xs/XSObject;I)V", nullptr, $PUBLIC, $method(static_cast<void(XSNamedMapImpl::*)($XSObjectArray*,int32_t)>(&XSNamedMapImpl::init$))},
	{"containsKey", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC},
	{"entrySet", "()Ljava/util/Set;", "()Ljava/util/Set<Ljava/util/Map$Entry<Ljavax/xml/namespace/QName;Lcom/sun/org/apache/xerces/internal/xs/XSObject;>;>;", $PUBLIC | $SYNCHRONIZED},
	{"get", "(Ljava/lang/Object;)Lcom/sun/org/apache/xerces/internal/xs/XSObject;", nullptr, $PUBLIC},
	{"getLength", "()I", nullptr, $PUBLIC | $SYNCHRONIZED},
	{"*isEmpty", "()Z", nullptr, $PUBLIC},
	{"isEqual", "(Ljava/lang/String;Ljava/lang/String;)Z", nullptr, $STATIC, $method(static_cast<bool(*)($String*,$String*)>(&XSNamedMapImpl::isEqual))},
