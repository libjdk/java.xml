...
$MethodInfo _XMLSecurityManager$Limit_MethodInfo_[] = {
	{"$values", "()[Lcom/sun/org/apache/xerces/internal/utils/XMLSecurityManager$Limit;", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<$XMLSecurityManager$LimitArray*(*)()>(&XMLSecurityManager$Limit::$values))},
	...
	{"valueOf", "(Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/utils/XMLSecurityManager$Limit;", nullptr, $PUBLIC | $STATIC, $method(static_cast<XMLSecurityManager$Limit*(*)($String*)>(&XMLSecurityManager$Limit::valueOf))},
	{"values", "()[Lcom/sun/org/apache/xerces/internal/utils/XMLSecurityManager$Limit;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$XMLSecurityManager$LimitArray*(*)()>(&XMLSecurityManager$Limit::values))},
	{}
};
