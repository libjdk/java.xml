...
$MethodInfo _DOMValidatorHelper_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/jaxp/validation/XMLSchemaValidatorComponentManager;)V", nullptr, $PUBLIC, $method(static_cast<void(DOMValidatorHelper::*)($XMLSchemaValidatorComponentManager*)>(&DOMValidatorHelper::init$))},
	{"beginNode", "(Lorg/w3c/dom/Node;)V", nullptr, $PRIVATE, $method(static_cast<void(DOMValidatorHelper::*)($Node*)>(&DOMValidatorHelper::beginNode))},
	{"fillQName", "(Lcom/sun/org/apache/xerces/internal/xni/QName;Lorg/w3c/dom/Node;)V", nullptr, $PRIVATE, $method(static_cast<void(DOMValidatorHelper::*)($QName*,$Node*)>(&DOMValidatorHelper::fillQName))},
	{"finishNode", "(Lorg/w3c/dom/Node;)V", nullptr, $PRIVATE, $method(static_cast<void(DOMValidatorHelper::*)($Node*)>(&DOMValidatorHelper::finishNode))},
	{"getCurrentElement", "()Lorg/w3c/dom/Node;", nullptr, 0, $method(static_cast<$Node*(DOMValidatorHelper::*)()>(&DOMValidatorHelper::getCurrentElement))},
	{"isEntityDeclared", "(Ljava/lang/String;)Z", nullptr, $PUBLIC},
	{"isEntityUnparsed", "(Ljava/lang/String;)Z", nullptr, $PUBLIC},
	{"processAttributes", "(Lorg/w3c/dom/NamedNodeMap;)V", nullptr, $PRIVATE, $method(static_cast<void(DOMValidatorHelper::*)($NamedNodeMap*)>(&DOMValidatorHelper::processAttributes))},
	{"sendCharactersToValidator", "(Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(DOMValidatorHelper::*)($String*)>(&DOMValidatorHelper::sendCharactersToValidator))},
	{"setupDOMResultHandler", "(Ljavax/xml/transform/dom/DOMSource;Ljavax/xml/transform/dom/DOMResult;)V", nullptr, $PRIVATE, $method(static_cast<void(DOMValidatorHelper::*)($DOMSource*,$DOMResult*)>(&DOMValidatorHelper::setupDOMResultHandler)), "org.xml.sax.SAXException"},
	{"setupEntityMap", "(Lorg/w3c/dom/Document;)V", nullptr, $PRIVATE, $method(static_cast<void(DOMValidatorHelper::*)($Document*)>(&DOMValidatorHelper::setupEntityMap))},
	...
	{"validate", "(Lorg/w3c/dom/Node;)V", nullptr, $PRIVATE, $method(static_cast<void(DOMValidatorHelper::*)($Node*)>(&DOMValidatorHelper::validate))},
	{}
};
