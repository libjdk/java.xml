...
$MethodInfo _XMLDTDDescription_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/xni/XMLResourceIdentifier;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(XMLDTDDescription::*)($XMLResourceIdentifier*,$String*)>(&XMLDTDDescription::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(XMLDTDDescription::*)($String*,$String*,$String*,$String*,$String*)>(&XMLDTDDescription::init$))},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/xni/parser/XMLInputSource;)V", nullptr, $PUBLIC, $method(static_cast<void(XMLDTDDescription::*)($XMLInputSource*)>(&XMLDTDDescription::init$))},
	...
	{"setPossibleRoots", "(Ljava/util/List;)V", "(Ljava/util/List<Ljava/lang/String;>;)V", $PUBLIC},
	{"*setPublicId", "(Ljava/lang/String;)V", nullptr, $PUBLIC},
	{"setRootName", "(Ljava/lang/String;)V", nullptr, $PUBLIC},
