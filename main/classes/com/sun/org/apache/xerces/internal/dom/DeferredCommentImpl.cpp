...
$MethodInfo _DeferredCommentImpl_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/dom/DeferredDocumentImpl;I)V", nullptr, 0, $method(static_cast<void(DeferredCommentImpl::*)($DeferredDocumentImpl*,int32_t)>(&DeferredCommentImpl::init$))},
