...
$MethodInfo _XMLDTDScannerImpl_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(XMLDTDScannerImpl::*)()>(&XMLDTDScannerImpl::init$))},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/util/SymbolTable;Lcom/sun/org/apache/xerces/internal/impl/XMLErrorReporter;Lcom/sun/org/apache/xerces/internal/impl/XMLEntityManager;)V", nullptr, $PUBLIC, $method(static_cast<void(XMLDTDScannerImpl::*)($SymbolTable*,$XMLErrorReporter*,$XMLEntityManager*)>(&XMLDTDScannerImpl::init$))},
	{"endEntity", "(Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/xni/Augmentations;)V", nullptr, $PUBLIC, nullptr, "com.sun.org.apache.xerces.internal.xni.XNIException,java.io.IOException"},
	{"ensureEnumerationSize", "(I)V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(XMLDTDScannerImpl::*)(int32_t)>(&XMLDTDScannerImpl::ensureEnumerationSize))},
	...
	{"getGrammar", "()Lcom/sun/xml/internal/stream/dtd/nonvalidating/DTDGrammar;", nullptr, $PUBLIC},
	...
	{"getScannerStateName", "(I)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)(int32_t)>(&XMLDTDScannerImpl::getScannerStateName))},
	{"init", "()V", nullptr, $PRIVATE, $method(static_cast<void(XMLDTDScannerImpl::*)()>(&XMLDTDScannerImpl::init))},
	{"peekReportEntity", "()Z", nullptr, $PRIVATE | $FINAL, $method(static_cast<bool(XMLDTDScannerImpl::*)()>(&XMLDTDScannerImpl::peekReportEntity))},
	{"popContentStack", "()I", nullptr, $PRIVATE | $FINAL, $method(static_cast<int32_t(XMLDTDScannerImpl::*)()>(&XMLDTDScannerImpl::popContentStack))},
	{"popPEStack", "()I", nullptr, $PRIVATE | $FINAL, $method(static_cast<int32_t(XMLDTDScannerImpl::*)()>(&XMLDTDScannerImpl::popPEStack))},
	{"pushContentStack", "(I)V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(XMLDTDScannerImpl::*)(int32_t)>(&XMLDTDScannerImpl::pushContentStack))},
	{"pushPEStack", "(IZ)V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(XMLDTDScannerImpl::*)(int32_t,bool)>(&XMLDTDScannerImpl::pushPEStack))},
	...
	{"scanAttDefaultDecl", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/xni/XMLString;Lcom/sun/org/apache/xerces/internal/xni/XMLString;)Ljava/lang/String;", nullptr, $PROTECTED | $FINAL, $method(static_cast<$String*(XMLDTDScannerImpl::*)($String*,$String*,$String*,$XMLString*,$XMLString*)>(&XMLDTDScannerImpl::scanAttDefaultDecl)), "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"scanAttType", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $FINAL, $method(static_cast<$String*(XMLDTDScannerImpl::*)($String*,$String*)>(&XMLDTDScannerImpl::scanAttType)), "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"scanAttlistDecl", "()V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(XMLDTDScannerImpl::*)()>(&XMLDTDScannerImpl::scanAttlistDecl)), "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"scanChildren", "(Ljava/lang/String;)V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(XMLDTDScannerImpl::*)($String*)>(&XMLDTDScannerImpl::scanChildren)), "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"scanComment", "()V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(XMLDTDScannerImpl::*)()>(&XMLDTDScannerImpl::scanComment)), "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"scanConditionalSect", "(I)V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(XMLDTDScannerImpl::*)(int32_t)>(&XMLDTDScannerImpl::scanConditionalSect)), "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"scanDTDExternalSubset", "(Z)Z", nullptr, $PUBLIC, nullptr, "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"scanDTDInternalSubset", "(ZZZ)Z", nullptr, $PUBLIC, nullptr, "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"scanDecls", "(Z)Z", nullptr, $PROTECTED | $FINAL, $method(static_cast<bool(XMLDTDScannerImpl::*)(bool)>(&XMLDTDScannerImpl::scanDecls)), "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"scanElementDecl", "()V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(XMLDTDScannerImpl::*)()>(&XMLDTDScannerImpl::scanElementDecl)), "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"scanEntityDecl", "()V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(XMLDTDScannerImpl::*)()>(&XMLDTDScannerImpl::scanEntityDecl)), "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"scanEntityValue", "(Ljava/lang/String;ZLcom/sun/org/apache/xerces/internal/xni/XMLString;Lcom/sun/org/apache/xerces/internal/xni/XMLString;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(XMLDTDScannerImpl::*)($String*,bool,$XMLString*,$XMLString*)>(&XMLDTDScannerImpl::scanEntityValue)), "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"scanMixed", "(Ljava/lang/String;)V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(XMLDTDScannerImpl::*)($String*)>(&XMLDTDScannerImpl::scanMixed)), "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"scanNotationDecl", "()V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(XMLDTDScannerImpl::*)()>(&XMLDTDScannerImpl::scanNotationDecl)), "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"scanPIData", "(Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/xni/XMLString;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(XMLDTDScannerImpl::*)($String*,$XMLString*)>(&XMLDTDScannerImpl::scanPIData)), "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"scanTextDecl", "()Z", nullptr, $PROTECTED | $FINAL, $method(static_cast<bool(XMLDTDScannerImpl::*)()>(&XMLDTDScannerImpl::scanTextDecl)), "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"scanningInternalSubset", "()Z", nullptr, $PROTECTED | $FINAL, $method(static_cast<bool(XMLDTDScannerImpl::*)()>(&XMLDTDScannerImpl::scanningInternalSubset))},
	...
	{"setInputSource", "(Lcom/sun/org/apache/xerces/internal/xni/parser/XMLInputSource;)V", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"setLimitAnalyzer", "(Lcom/sun/org/apache/xerces/internal/utils/XMLLimitAnalyzer;)V", nullptr, $PUBLIC},
	{"setScannerState", "(I)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(XMLDTDScannerImpl::*)(int32_t)>(&XMLDTDScannerImpl::setScannerState))},
	{"skipDTD", "(Z)Z", nullptr, $PUBLIC, nullptr, "java.io.IOException"},
	{"skipSeparator", "(ZZ)Z", nullptr, $PRIVATE, $method(static_cast<bool(XMLDTDScannerImpl::*)(bool,bool)>(&XMLDTDScannerImpl::skipSeparator)), "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"startEntity", "(Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/xni/XMLResourceIdentifier;Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/xni/Augmentations;)V", nullptr, $PUBLIC, nullptr, "com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"startPE", "(Ljava/lang/String;Z)V", nullptr, $PROTECTED, nullptr, "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
