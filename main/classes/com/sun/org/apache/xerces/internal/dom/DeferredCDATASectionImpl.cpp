...
$MethodInfo _DeferredCDATASectionImpl_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/dom/DeferredDocumentImpl;I)V", nullptr, 0, $method(static_cast<void(DeferredCDATASectionImpl::*)($DeferredDocumentImpl*,int32_t)>(&DeferredCDATASectionImpl::init$))},
