...
$MethodInfo _AbstractXMLSchema_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(AbstractXMLSchema::*)()>(&AbstractXMLSchema::init$))},
	{"getFeature", "(Ljava/lang/String;)Ljava/lang/Boolean;", nullptr, $PUBLIC | $FINAL},
	{"getProperty", "(Ljava/lang/String;)Ljava/lang/Object;", nullptr, $PUBLIC | $FINAL},
	{"newValidator", "()Ljavax/xml/validation/Validator;", nullptr, $PUBLIC | $FINAL},
	{"newValidatorHandler", "()Ljavax/xml/validation/ValidatorHandler;", nullptr, $PUBLIC | $FINAL},
	{"setFeature", "(Ljava/lang/String;Z)V", nullptr, $PUBLIC | $FINAL},
	{"setProperty", "(Ljava/lang/String;Ljava/lang/Object;)V", nullptr, $PUBLIC | $FINAL},
