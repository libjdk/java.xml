...
$MethodInfo _XSDeclarationPool_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(XSDeclarationPool::*)()>(&XSDeclarationPool::init$))},
	{"ensureAttrDeclCapacity", "(I)Z", nullptr, $PRIVATE, $method(static_cast<bool(XSDeclarationPool::*)(int32_t)>(&XSDeclarationPool::ensureAttrDeclCapacity))},
	{"ensureAttributeUseCapacity", "(I)Z", nullptr, $PRIVATE, $method(static_cast<bool(XSDeclarationPool::*)(int32_t)>(&XSDeclarationPool::ensureAttributeUseCapacity))},
	{"ensureCTDeclCapacity", "(I)Z", nullptr, $PRIVATE, $method(static_cast<bool(XSDeclarationPool::*)(int32_t)>(&XSDeclarationPool::ensureCTDeclCapacity))},
	{"ensureElementDeclCapacity", "(I)Z", nullptr, $PRIVATE, $method(static_cast<bool(XSDeclarationPool::*)(int32_t)>(&XSDeclarationPool::ensureElementDeclCapacity))},
	{"ensureModelGroupCapacity", "(I)Z", nullptr, $PRIVATE, $method(static_cast<bool(XSDeclarationPool::*)(int32_t)>(&XSDeclarationPool::ensureModelGroupCapacity))},
	{"ensureParticleDeclCapacity", "(I)Z", nullptr, $PRIVATE, $method(static_cast<bool(XSDeclarationPool::*)(int32_t)>(&XSDeclarationPool::ensureParticleDeclCapacity))},
	{"ensureSTDeclCapacity", "(I)Z", nullptr, $PRIVATE, $method(static_cast<bool(XSDeclarationPool::*)(int32_t)>(&XSDeclarationPool::ensureSTDeclCapacity))},
	{"getAttributeDecl", "()Lcom/sun/org/apache/xerces/internal/impl/xs/XSAttributeDecl;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$XSAttributeDecl*(XSDeclarationPool::*)()>(&XSDeclarationPool::getAttributeDecl))},
	{"getAttributeUse", "()Lcom/sun/org/apache/xerces/internal/impl/xs/XSAttributeUseImpl;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$XSAttributeUseImpl*(XSDeclarationPool::*)()>(&XSDeclarationPool::getAttributeUse))},
	{"getComplexTypeDecl", "()Lcom/sun/org/apache/xerces/internal/impl/xs/XSComplexTypeDecl;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$XSComplexTypeDecl*(XSDeclarationPool::*)()>(&XSDeclarationPool::getComplexTypeDecl))},
	{"getElementDecl", "()Lcom/sun/org/apache/xerces/internal/impl/xs/XSElementDecl;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$XSElementDecl*(XSDeclarationPool::*)()>(&XSDeclarationPool::getElementDecl))},
	{"getModelGroup", "()Lcom/sun/org/apache/xerces/internal/impl/xs/XSModelGroupImpl;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$XSModelGroupImpl*(XSDeclarationPool::*)()>(&XSDeclarationPool::getModelGroup))},
	{"getParticleDecl", "()Lcom/sun/org/apache/xerces/internal/impl/xs/XSParticleDecl;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$XSParticleDecl*(XSDeclarationPool::*)()>(&XSDeclarationPool::getParticleDecl))},
	{"getSimpleTypeDecl", "()Lcom/sun/org/apache/xerces/internal/impl/dv/xs/XSSimpleTypeDecl;", nullptr, $PUBLIC | $FINAL, $method(static_cast<$XSSimpleTypeDecl*(XSDeclarationPool::*)()>(&XSDeclarationPool::getSimpleTypeDecl))},
	{"reset", "()V", nullptr, $PUBLIC, $method(static_cast<void(XSDeclarationPool::*)()>(&XSDeclarationPool::reset))},
	{"resize", "([[Lcom/sun/org/apache/xerces/internal/impl/xs/XSElementDecl;I)[[Lcom/sun/org/apache/xerces/internal/impl/xs/XSElementDecl;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$XSElementDeclArray2*(*)($XSElementDeclArray2*,int32_t)>(&XSDeclarationPool::resize))},
	{"resize", "([[Lcom/sun/org/apache/xerces/internal/impl/xs/XSParticleDecl;I)[[Lcom/sun/org/apache/xerces/internal/impl/xs/XSParticleDecl;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$XSParticleDeclArray2*(*)($XSParticleDeclArray2*,int32_t)>(&XSDeclarationPool::resize))},
	{"resize", "([[Lcom/sun/org/apache/xerces/internal/impl/xs/XSModelGroupImpl;I)[[Lcom/sun/org/apache/xerces/internal/impl/xs/XSModelGroupImpl;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$XSModelGroupImplArray2*(*)($XSModelGroupImplArray2*,int32_t)>(&XSDeclarationPool::resize))},
	{"resize", "([[Lcom/sun/org/apache/xerces/internal/impl/xs/XSAttributeDecl;I)[[Lcom/sun/org/apache/xerces/internal/impl/xs/XSAttributeDecl;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$XSAttributeDeclArray2*(*)($XSAttributeDeclArray2*,int32_t)>(&XSDeclarationPool::resize))},
	{"resize", "([[Lcom/sun/org/apache/xerces/internal/impl/xs/XSAttributeUseImpl;I)[[Lcom/sun/org/apache/xerces/internal/impl/xs/XSAttributeUseImpl;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$XSAttributeUseImplArray2*(*)($XSAttributeUseImplArray2*,int32_t)>(&XSDeclarationPool::resize))},
	{"resize", "([[Lcom/sun/org/apache/xerces/internal/impl/dv/xs/XSSimpleTypeDecl;I)[[Lcom/sun/org/apache/xerces/internal/impl/dv/xs/XSSimpleTypeDecl;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$XSSimpleTypeDeclArray2*(*)($XSSimpleTypeDeclArray2*,int32_t)>(&XSDeclarationPool::resize))},
	{"resize", "([[Lcom/sun/org/apache/xerces/internal/impl/xs/XSComplexTypeDecl;I)[[Lcom/sun/org/apache/xerces/internal/impl/xs/XSComplexTypeDecl;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$XSComplexTypeDeclArray2*(*)($XSComplexTypeDeclArray2*,int32_t)>(&XSDeclarationPool::resize))},
	{"setDVFactory", "(Lcom/sun/org/apache/xerces/internal/impl/dv/xs/SchemaDVFactoryImpl;)V", nullptr, $PUBLIC, $method(static_cast<void(XSDeclarationPool::*)($SchemaDVFactoryImpl*)>(&XSDeclarationPool::setDVFactory))},
	{}
};
