...
$MethodInfo _XSElementDecl_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(XSElementDecl::*)()>(&XSElementDecl::init$))},
	{"addIDConstraint", "(Lcom/sun/org/apache/xerces/internal/impl/xs/identity/IdentityConstraint;)V", nullptr, $PUBLIC},
	{"equals", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC},
	{"getAbstract", "()Z", nullptr, $PUBLIC},
	{"getActualVC", "()Ljava/lang/Object;", nullptr, $PUBLIC | $DEPRECATED, nullptr, nullptr, nullptr, _XSElementDecl_MethodAnnotations_getActualVC4},
	{"getActualVCType", "()S", nullptr, $PUBLIC | $DEPRECATED, nullptr, nullptr, nullptr, _XSElementDecl_MethodAnnotations_getActualVCType5},
	...
	{"getConstraintValue", "()Ljava/lang/String;", nullptr, $PUBLIC | $DEPRECATED, nullptr, nullptr, nullptr, _XSElementDecl_MethodAnnotations_getConstraintValue9},
	{"getDisallowedSubstitutions", "()S", nullptr, $PUBLIC},
	{"getEnclosingCTDefinition", "()Lcom/sun/org/apache/xerces/internal/xs/XSComplexTypeDefinition;", nullptr, $PUBLIC},
	{"getIDConstraints", "()[Lcom/sun/org/apache/xerces/internal/impl/xs/identity/IdentityConstraint;", nullptr, $PUBLIC},
	{"getIdentityConstraints", "()Lcom/sun/org/apache/xerces/internal/xs/XSNamedMap;", nullptr, $PUBLIC},
	{"getItemValueTypes", "()Lcom/sun/org/apache/xerces/internal/xs/ShortList;", nullptr, $PUBLIC | $DEPRECATED, nullptr, nullptr, nullptr, _XSElementDecl_MethodAnnotations_getItemValueTypes14},
	...
	{"getNillable", "()Z", nullptr, $PUBLIC},
	{"getScope", "()S", nullptr, $PUBLIC},
	{"getSubstitutionGroupAffiliation", "()Lcom/sun/org/apache/xerces/internal/xs/XSElementDeclaration;", nullptr, $PUBLIC},
	{"getSubstitutionGroupExclusions", "()S", nullptr, $PUBLIC},
	...
	{"isDisallowedSubstitution", "(S)Z", nullptr, $PUBLIC},
	{"isSubstitutionGroupExclusion", "(S)Z", nullptr, $PUBLIC},
	{"reset", "()V", nullptr, $PUBLIC},
	{"resize", "([Lcom/sun/org/apache/xerces/internal/impl/xs/identity/IdentityConstraint;I)[Lcom/sun/org/apache/xerces/internal/impl/xs/identity/IdentityConstraint;", nullptr, $STATIC | $FINAL, $method(static_cast<$IdentityConstraintArray*(*)($IdentityConstraintArray*,int32_t)>(&XSElementDecl::resize))},
	{"setConstraintType", "(S)V", nullptr, $PUBLIC},
	{"setIsAbstract", "()V", nullptr, $PUBLIC},
	{"setIsGlobal", "()V", nullptr, $PUBLIC},
	{"setIsLocal", "(Lcom/sun/org/apache/xerces/internal/impl/xs/XSComplexTypeDecl;)V", nullptr, $PUBLIC},
	{"setIsNillable", "()V", nullptr, $PUBLIC},
