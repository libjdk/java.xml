...
$MethodInfo _XMLChar_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(XMLChar::*)()>(&XMLChar::init$))},
	{"highSurrogate", "(I)C", nullptr, $PUBLIC | $STATIC, $method(static_cast<char16_t(*)(int32_t)>(&XMLChar::highSurrogate))},
	{"isContent", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&XMLChar::isContent))},
	{"isHighSurrogate", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&XMLChar::isHighSurrogate))},
	{"isInvalid", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&XMLChar::isInvalid))},
	{"isLowSurrogate", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&XMLChar::isLowSurrogate))},
	{"isMarkup", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&XMLChar::isMarkup))},
	{"isNCName", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&XMLChar::isNCName))},
	{"isNCNameStart", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&XMLChar::isNCNameStart))},
	{"isName", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&XMLChar::isName))},
	{"isNameStart", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&XMLChar::isNameStart))},
	{"isPubid", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&XMLChar::isPubid))},
	{"isSpace", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&XMLChar::isSpace))},
	{"isSupplemental", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&XMLChar::isSupplemental))},
	{"isValid", "(I)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)(int32_t)>(&XMLChar::isValid))},
	{"isValidIANAEncoding", "(Ljava/lang/String;)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)($String*)>(&XMLChar::isValidIANAEncoding))},
	{"isValidJavaEncoding", "(Ljava/lang/String;)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)($String*)>(&XMLChar::isValidJavaEncoding))},
	{"isValidNCName", "(Ljava/lang/String;)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)($String*)>(&XMLChar::isValidNCName))},
	{"isValidName", "(Ljava/lang/String;)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)($String*)>(&XMLChar::isValidName))},
	{"isValidNmtoken", "(Ljava/lang/String;)Z", nullptr, $PUBLIC | $STATIC, $method(static_cast<bool(*)($String*)>(&XMLChar::isValidNmtoken))},
	{"lowSurrogate", "(I)C", nullptr, $PUBLIC | $STATIC, $method(static_cast<char16_t(*)(int32_t)>(&XMLChar::lowSurrogate))},
	{"supplemental", "(CC)I", nullptr, $PUBLIC | $STATIC, $method(static_cast<int32_t(*)(char16_t,char16_t)>(&XMLChar::supplemental))},
	{"trim", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($String*)>(&XMLChar::trim))},
	{}
};
