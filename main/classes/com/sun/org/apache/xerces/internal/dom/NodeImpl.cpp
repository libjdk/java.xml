...
$MethodInfo _NodeImpl_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/dom/CoreDocumentImpl;)V", nullptr, $PROTECTED, $method(static_cast<void(NodeImpl::*)($CoreDocumentImpl*)>(&NodeImpl::init$))},
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(NodeImpl::*)()>(&NodeImpl::init$))},
	{"addEventListener", "(Ljava/lang/String;Lorg/w3c/dom/events/EventListener;Z)V", nullptr, $PUBLIC},
	...
	{"compareTreePosition", "(Lorg/w3c/dom/Node;)S", nullptr, $PUBLIC | $DEPRECATED, nullptr, nullptr, nullptr, _NodeImpl_MethodAnnotations_compareTreePosition8},
	{"dispatchEvent", "(Lorg/w3c/dom/events/Event;)Z", nullptr, $PUBLIC},
	...
	{"getContainer", "()Lorg/w3c/dom/Node;", nullptr, $PROTECTED},
	{"getElementAncestor", "(Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;", nullptr, 0},
	...
	{"getTextContent", "(Ljava/lang/StringBuilder;)V", nullptr, 0, nullptr, "org.w3c.dom.DOMException"},
	{"getUserData", "(Ljava/lang/String;)Ljava/lang/Object;", nullptr, $PUBLIC},
	{"getUserData", "()Ljava/lang/Object;", nullptr, $PUBLIC},
	{"getUserDataRecord", "()Ljava/util/Map;", "()Ljava/util/Map<Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/dom/ParentNode$UserDataRecord;>;", $PROTECTED},
	{"hasAttributes", "()Z", nullptr, $PUBLIC},
	{"hasChildNodes", "()Z", nullptr, $PUBLIC},
	{"hasStringValue", "()Z", nullptr, $FINAL, $method(static_cast<bool(NodeImpl::*)()>(&NodeImpl::hasStringValue))},
	{"hasStringValue", "(Z)V", nullptr, $FINAL, $method(static_cast<void(NodeImpl::*)(bool)>(&NodeImpl::hasStringValue))},
	{"insertBefore", "(Lorg/w3c/dom/Node;Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;", nullptr, $PUBLIC, nullptr, "org.w3c.dom.DOMException"},
	{"internalIsIgnorableWhitespace", "()Z", nullptr, $FINAL, $method(static_cast<bool(NodeImpl::*)()>(&NodeImpl::internalIsIgnorableWhitespace))},
	{"isDefaultNamespace", "(Ljava/lang/String;)Z", nullptr, $PUBLIC},
	{"isEqualNode", "(Lorg/w3c/dom/Node;)Z", nullptr, $PUBLIC},
	{"isFirstChild", "()Z", nullptr, $FINAL, $method(static_cast<bool(NodeImpl::*)()>(&NodeImpl::isFirstChild))},
	{"isFirstChild", "(Z)V", nullptr, $FINAL, $method(static_cast<void(NodeImpl::*)(bool)>(&NodeImpl::isFirstChild))},
	{"isIdAttribute", "()Z", nullptr, $FINAL, $method(static_cast<bool(NodeImpl::*)()>(&NodeImpl::isIdAttribute))},
	{"isIdAttribute", "(Z)V", nullptr, $FINAL, $method(static_cast<void(NodeImpl::*)(bool)>(&NodeImpl::isIdAttribute))},
	{"isIgnorableWhitespace", "(Z)V", nullptr, $FINAL, $method(static_cast<void(NodeImpl::*)(bool)>(&NodeImpl::isIgnorableWhitespace))},
	{"isNormalized", "()Z", nullptr, $FINAL, $method(static_cast<bool(NodeImpl::*)()>(&NodeImpl::isNormalized))},
	{"isNormalized", "(Z)V", nullptr, $FINAL, $method(static_cast<void(NodeImpl::*)(bool)>(&NodeImpl::isNormalized))},
	{"isOwned", "()Z", nullptr, $FINAL, $method(static_cast<bool(NodeImpl::*)()>(&NodeImpl::isOwned))},
	{"isOwned", "(Z)V", nullptr, $FINAL, $method(static_cast<void(NodeImpl::*)(bool)>(&NodeImpl::isOwned))},
	{"isReadOnly", "()Z", nullptr, $FINAL, $method(static_cast<bool(NodeImpl::*)()>(&NodeImpl::isReadOnly))},
	{"isReadOnly", "(Z)V", nullptr, $FINAL, $method(static_cast<void(NodeImpl::*)(bool)>(&NodeImpl::isReadOnly))},
	{"isSameNode", "(Lorg/w3c/dom/Node;)Z", nullptr, $PUBLIC},
	{"isSpecified", "()Z", nullptr, $FINAL, $method(static_cast<bool(NodeImpl::*)()>(&NodeImpl::isSpecified))},
	{"isSpecified", "(Z)V", nullptr, $FINAL, $method(static_cast<void(NodeImpl::*)(bool)>(&NodeImpl::isSpecified))},
	{"isSupported", "(Ljava/lang/String;Ljava/lang/String;)Z", nullptr, $PUBLIC},
	{"item", "(I)Lorg/w3c/dom/Node;", nullptr, $PUBLIC},
	{"lookupNamespacePrefix", "(Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/dom/ElementImpl;)Ljava/lang/String;", nullptr, 0},
	...
	{"needsSyncChildren", "()Z", nullptr, $FINAL, $method(static_cast<bool(NodeImpl::*)()>(&NodeImpl::needsSyncChildren))},
	{"needsSyncChildren", "(Z)V", nullptr, $PUBLIC | $FINAL, $method(static_cast<void(NodeImpl::*)(bool)>(&NodeImpl::needsSyncChildren))},
	{"needsSyncData", "()Z", nullptr, $FINAL, $method(static_cast<bool(NodeImpl::*)()>(&NodeImpl::needsSyncData))},
	{"needsSyncData", "(Z)V", nullptr, $FINAL, $method(static_cast<void(NodeImpl::*)(bool)>(&NodeImpl::needsSyncData))},
	{"normalize", "()V", nullptr, $PUBLIC},
	{"ownerDocument", "()Lcom/sun/org/apache/xerces/internal/dom/CoreDocumentImpl;", nullptr, 0},
	{"parentNode", "()Lcom/sun/org/apache/xerces/internal/dom/NodeImpl;", nullptr, 0},
	{"previousSibling", "()Lcom/sun/org/apache/xerces/internal/dom/ChildNode;", nullptr, 0},
	{"removeChild", "(Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;", nullptr, $PUBLIC, nullptr, "org.w3c.dom.DOMException"},
	{"removeEventListener", "(Ljava/lang/String;Lorg/w3c/dom/events/EventListener;Z)V", nullptr, $PUBLIC},
	...
	{"writeObject", "(Ljava/io/ObjectOutputStream;)V", nullptr, $PRIVATE, $method(static_cast<void(NodeImpl::*)($ObjectOutputStream*)>(&NodeImpl::writeObject)), "java.io.IOException"},
	{}
};
