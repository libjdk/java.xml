...
$MethodInfo _NonValidatingConfiguration_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(NonValidatingConfiguration::*)()>(&NonValidatingConfiguration::init$))},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/util/SymbolTable;)V", nullptr, $PUBLIC, $method(static_cast<void(NonValidatingConfiguration::*)($SymbolTable*)>(&NonValidatingConfiguration::init$))},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/util/SymbolTable;Lcom/sun/org/apache/xerces/internal/xni/grammars/XMLGrammarPool;)V", nullptr, $PUBLIC, $method(static_cast<void(NonValidatingConfiguration::*)($SymbolTable*,$XMLGrammarPool*)>(&NonValidatingConfiguration::init$))},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/util/SymbolTable;Lcom/sun/org/apache/xerces/internal/xni/grammars/XMLGrammarPool;Lcom/sun/org/apache/xerces/internal/xni/parser/XMLComponentManager;)V", nullptr, $PUBLIC, $method(static_cast<void(NonValidatingConfiguration::*)($SymbolTable*,$XMLGrammarPool*,$XMLComponentManager*)>(&NonValidatingConfiguration::init$))},
