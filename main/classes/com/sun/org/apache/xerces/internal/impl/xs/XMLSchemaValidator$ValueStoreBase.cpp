...
$MethodInfo _XMLSchemaValidator$ValueStoreBase_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/impl/xs/XMLSchemaValidator;Lcom/sun/org/apache/xerces/internal/impl/xs/identity/IdentityConstraint;)V", nullptr, $PROTECTED, $method(static_cast<void(XMLSchemaValidator$ValueStoreBase::*)($XMLSchemaValidator*,$IdentityConstraint*)>(&XMLSchemaValidator$ValueStoreBase::init$))},
	{"addItemValueType", "(Lcom/sun/org/apache/xerces/internal/xs/ShortList;)V", nullptr, $PRIVATE, $method(static_cast<void(XMLSchemaValidator$ValueStoreBase::*)($ShortList*)>(&XMLSchemaValidator$ValueStoreBase::addItemValueType))},
	{"addValue", "(Lcom/sun/org/apache/xerces/internal/impl/xs/identity/Field;ZLjava/lang/Object;SLcom/sun/org/apache/xerces/internal/xs/ShortList;)V", nullptr, $PUBLIC},
	{"addValueType", "(S)V", nullptr, $PRIVATE, $method(static_cast<void(XMLSchemaValidator$ValueStoreBase::*)(int16_t)>(&XMLSchemaValidator$ValueStoreBase::addValueType))},
	{"append", "(Lcom/sun/org/apache/xerces/internal/impl/xs/XMLSchemaValidator$ValueStoreBase;)V", nullptr, $PUBLIC},
	{"checkDuplicateValues", "()V", nullptr, $PROTECTED},
	{"clear", "()V", nullptr, $PUBLIC},
	{"contains", "()Z", nullptr, $PUBLIC},
	{"contains", "(Lcom/sun/org/apache/xerces/internal/impl/xs/XMLSchemaValidator$ValueStoreBase;)I", nullptr, $PUBLIC},
	{"endDocument", "()V", nullptr, $PUBLIC},
	{"endDocumentFragment", "()V", nullptr, $PUBLIC},
	{"endValueScope", "()V", nullptr, $PUBLIC},
	{"getItemValueTypeAt", "(I)Lcom/sun/org/apache/xerces/internal/xs/ShortList;", nullptr, $PRIVATE, $method(static_cast<$ShortList*(XMLSchemaValidator$ValueStoreBase::*)(int32_t)>(&XMLSchemaValidator$ValueStoreBase::getItemValueTypeAt))},
	{"getValueTypeAt", "(I)S", nullptr, $PRIVATE, $method(static_cast<int16_t(XMLSchemaValidator$ValueStoreBase::*)(int32_t)>(&XMLSchemaValidator$ValueStoreBase::getValueTypeAt))},
	{"itemValueTypeContains", "(Lcom/sun/org/apache/xerces/internal/xs/ShortList;)Z", nullptr, $PRIVATE, $method(static_cast<bool(XMLSchemaValidator$ValueStoreBase::*)($ShortList*)>(&XMLSchemaValidator$ValueStoreBase::itemValueTypeContains))},
	{"reportError", "(Ljava/lang/String;[Ljava/lang/Object;)V", nullptr, $PUBLIC},
	{"startValueScope", "()V", nullptr, $PUBLIC},
	{"toString", "([Ljava/lang/Object;)Ljava/lang/String;", nullptr, $PROTECTED},
	{"toString", "(Ljava/util/Vector;II)Ljava/lang/String;", "(Ljava/util/Vector<Ljava/lang/Object;>;II)Ljava/lang/String;", $PROTECTED},
	{"toString", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"valueTypeContains", "(S)Z", nullptr, $PRIVATE, $method(static_cast<bool(XMLSchemaValidator$ValueStoreBase::*)(int16_t)>(&XMLSchemaValidator$ValueStoreBase::valueTypeContains))},
	{}
};
