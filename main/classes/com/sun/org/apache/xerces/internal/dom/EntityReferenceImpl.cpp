...
$MethodInfo _EntityReferenceImpl_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/dom/CoreDocumentImpl;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(EntityReferenceImpl::*)($CoreDocumentImpl*,$String*)>(&EntityReferenceImpl::init$))},
	{"cloneNode", "(Z)Lorg/w3c/dom/Node;", nullptr, $PUBLIC},
	{"getBaseURI", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getEntityRefValue", "()Ljava/lang/String;", nullptr, $PROTECTED},
