...
$MethodInfo _DeferredProcessingInstructionImpl_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/dom/DeferredDocumentImpl;I)V", nullptr, 0, $method(static_cast<void(DeferredProcessingInstructionImpl::*)($DeferredDocumentImpl*,int32_t)>(&DeferredProcessingInstructionImpl::init$))},
