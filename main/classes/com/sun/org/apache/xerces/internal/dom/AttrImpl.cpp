...
$MethodInfo _AttrImpl_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/dom/CoreDocumentImpl;Ljava/lang/String;)V", nullptr, $PROTECTED, $method(static_cast<void(AttrImpl::*)($CoreDocumentImpl*,$String*)>(&AttrImpl::init$))},
	{"<init>", "()V", nullptr, $PROTECTED, $method(static_cast<void(AttrImpl::*)()>(&AttrImpl::init$))},
	...
	{"getElement", "()Lorg/w3c/dom/Element;", nullptr, $PUBLIC | $DEPRECATED, nullptr, nullptr, nullptr, _AttrImpl_MethodAnnotations_getElement6},
	...
	{"lastChild", "()Lcom/sun/org/apache/xerces/internal/dom/ChildNode;", nullptr, $FINAL, $method(static_cast<$ChildNode*(AttrImpl::*)()>(&AttrImpl::lastChild))},
	{"lastChild", "(Lcom/sun/org/apache/xerces/internal/dom/ChildNode;)V", nullptr, $FINAL, $method(static_cast<void(AttrImpl::*)($ChildNode*)>(&AttrImpl::lastChild))},
	...
	{"makeChildNode", "()V", nullptr, $PROTECTED},
	{"normalize", "()V", nullptr, $PUBLIC},
	{"readObject", "(Ljava/io/ObjectInputStream;)V", nullptr, $PRIVATE, $method(static_cast<void(AttrImpl::*)($ObjectInputStream*)>(&AttrImpl::readObject)), "java.lang.ClassNotFoundException,java.io.IOException"},
	...
	{"setSpecified", "(Z)V", nullptr, $PUBLIC},
	{"*setTextContent", "(Ljava/lang/String;)V", nullptr, $PUBLIC},
	{"setType", "(Ljava/lang/Object;)V", nullptr, $PUBLIC},
	...
	{"writeObject", "(Ljava/io/ObjectOutputStream;)V", nullptr, $PRIVATE, $method(static_cast<void(AttrImpl::*)($ObjectOutputStream*)>(&AttrImpl::writeObject)), "java.io.IOException"},
	{}
};
