...
$MethodInfo _IdentityConstraint_MethodInfo_[] = {
	{"<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PROTECTED, $method(static_cast<void(IdentityConstraint::*)($String*,$String*,$String*)>(&IdentityConstraint::init$))},
	{"addAnnotation", "(Lcom/sun/org/apache/xerces/internal/impl/xs/XSAnnotationImpl;)V", nullptr, $PUBLIC},
	{"addField", "(Lcom/sun/org/apache/xerces/internal/impl/xs/identity/Field;)V", nullptr, $PUBLIC},
	{"equals", "(Lcom/sun/org/apache/xerces/internal/impl/xs/identity/IdentityConstraint;)Z", nullptr, $PUBLIC},
	{"getAnnotations", "()Lcom/sun/org/apache/xerces/internal/xs/XSObjectList;", nullptr, $PUBLIC},
	{"getCategory", "()S", nullptr, $PUBLIC},
	{"getElementName", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getFieldAt", "(I)Lcom/sun/org/apache/xerces/internal/impl/xs/identity/Field;", nullptr, $PUBLIC},
	{"getFieldCount", "()I", nullptr, $PUBLIC},
	{"getFieldStrs", "()Lcom/sun/org/apache/xerces/internal/xs/StringList;", nullptr, $PUBLIC},
	{"getIdentityConstraintName", "()Ljava/lang/String;", nullptr, $PUBLIC},
	...
	{"getSelector", "()Lcom/sun/org/apache/xerces/internal/impl/xs/identity/Selector;", nullptr, $PUBLIC},
	{"getSelectorStr", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getType", "()S", nullptr, $PUBLIC},
	{"resize", "([Lcom/sun/org/apache/xerces/internal/impl/xs/identity/Field;I)[Lcom/sun/org/apache/xerces/internal/impl/xs/identity/Field;", nullptr, $STATIC | $FINAL, $method(static_cast<$FieldArray*(*)($FieldArray*,int32_t)>(&IdentityConstraint::resize))},
	{"setSelector", "(Lcom/sun/org/apache/xerces/internal/impl/xs/identity/Selector;)V", nullptr, $PUBLIC},
