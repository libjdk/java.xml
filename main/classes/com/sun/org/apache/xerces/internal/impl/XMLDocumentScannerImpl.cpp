...
using $1XMLDTDDescription = ::com::sun::org::apache::xerces::internal::impl::dtd::XMLDTDDescription;
...
$MethodInfo _XMLDocumentScannerImpl_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(XMLDocumentScannerImpl::*)()>(&XMLDocumentScannerImpl::init$))},
	...
	{"getDTDDecl", "()Lcom/sun/org/apache/xerces/internal/util/XMLStringBuffer;", nullptr, $PUBLIC},
	...
	{"getScannetState", "()I", nullptr, $PUBLIC},
	...
	{"scanDoctypeDecl", "(Z)Z", nullptr, $PROTECTED, nullptr, "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"setEndDTDScanState", "()V", nullptr, $PROTECTED},
...
void XMLDocumentScannerImpl::init$() {
	...
	$set(this, fDTDDescription, $new($1XMLDTDDescription, nullptr, nullptr, nullptr, nullptr, nullptr));
}
