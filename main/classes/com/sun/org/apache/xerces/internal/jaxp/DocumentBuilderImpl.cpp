...
$MethodInfo _DocumentBuilderImpl_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/jaxp/DocumentBuilderFactoryImpl;Ljava/util/Map;Ljava/util/Map;)V", "(Lcom/sun/org/apache/xerces/internal/jaxp/DocumentBuilderFactoryImpl;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Boolean;>;)V", 0, $method(static_cast<void(DocumentBuilderImpl::*)($DocumentBuilderFactoryImpl*,$Map*,$Map*)>(&DocumentBuilderImpl::init$)), "org.xml.sax.SAXNotRecognizedException,org.xml.sax.SAXNotSupportedException"},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/jaxp/DocumentBuilderFactoryImpl;Ljava/util/Map;Ljava/util/Map;Z)V", "(Lcom/sun/org/apache/xerces/internal/jaxp/DocumentBuilderFactoryImpl;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Boolean;>;Z)V", 0, $method(static_cast<void(DocumentBuilderImpl::*)($DocumentBuilderFactoryImpl*,$Map*,$Map*,bool)>(&DocumentBuilderImpl::init$)), "org.xml.sax.SAXNotRecognizedException,org.xml.sax.SAXNotSupportedException"},
	{"getDOMImplementation", "()Lorg/w3c/dom/DOMImplementation;", nullptr, $PUBLIC},
	{"getDOMParser", "()Lcom/sun/org/apache/xerces/internal/parsers/DOMParser;", nullptr, 0},
	...
	{"newDocument", "()Lorg/w3c/dom/Document;", nullptr, $PUBLIC},
	{"parse", "(Lorg/xml/sax/InputSource;)Lorg/w3c/dom/Document;", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException,java.io.IOException"},
	{"reset", "()V", nullptr, $PUBLIC},
	{"resetSchemaValidator", "()V", nullptr, $PRIVATE, $method(static_cast<void(DocumentBuilderImpl::*)()>(&DocumentBuilderImpl::resetSchemaValidator)), "org.xml.sax.SAXException"},
	{"setDocumentBuilderFactoryAttributes", "(Ljava/util/Map;)V", "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;)V", $PRIVATE, $method(static_cast<void(DocumentBuilderImpl::*)($Map*)>(&DocumentBuilderImpl::setDocumentBuilderFactoryAttributes)), "org.xml.sax.SAXNotSupportedException,org.xml.sax.SAXNotRecognizedException"},
	{"setEntityResolver", "(Lorg/xml/sax/EntityResolver;)V", nullptr, $PUBLIC},
	{"setErrorHandler", "(Lorg/xml/sax/ErrorHandler;)V", nullptr, $PUBLIC},
	{"setFeatures", "(Ljava/util/Map;)V", "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/Boolean;>;)V", $PRIVATE, $method(static_cast<void(DocumentBuilderImpl::*)($Map*)>(&DocumentBuilderImpl::setFeatures)), "org.xml.sax.SAXNotSupportedException,org.xml.sax.SAXNotRecognizedException"},
