...
$MethodInfo _RangeToken_MethodInfo_[] = {
	{"<init>", "(I)V", nullptr, 0, $method(static_cast<void(RangeToken::*)(int32_t)>(&RangeToken::init$))},
	{"addRange", "(II)V", nullptr, $PROTECTED},
	{"compactRanges", "()V", nullptr, $PROTECTED},
	{"complementRanges", "(Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;)Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;", nullptr, $STATIC, $method(static_cast<$Token*(*)($Token*)>(&RangeToken::complementRanges))},
	{"createMap", "()V", nullptr, $PRIVATE, $method(static_cast<void(RangeToken::*)()>(&RangeToken::createMap))},
	{"dumpRanges", "()V", nullptr, 0, $method(static_cast<void(RangeToken::*)()>(&RangeToken::dumpRanges))},
	{"escapeCharInCharClass", "(I)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)(int32_t)>(&RangeToken::escapeCharInCharClass))},
	{"getCaseInsensitiveToken", "()Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/RangeToken;", nullptr, $SYNCHRONIZED, $method(static_cast<RangeToken*(RangeToken::*)()>(&RangeToken::getCaseInsensitiveToken))},
	{"intersectRanges", "(Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;)V", nullptr, $PROTECTED},
	{"isCompacted", "()Z", nullptr, $PRIVATE | $FINAL, $method(static_cast<bool(RangeToken::*)()>(&RangeToken::isCompacted))},
	{"isSorted", "()Z", nullptr, $PRIVATE | $FINAL, $method(static_cast<bool(RangeToken::*)()>(&RangeToken::isSorted))},
	{"match", "(I)Z", nullptr, 0},
	{"mergeRanges", "(Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;)V", nullptr, $PROTECTED},
	{"setCompacted", "()V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(RangeToken::*)()>(&RangeToken::setCompacted))},
	{"setSorted", "(Z)V", nullptr, $PRIVATE | $FINAL, $method(static_cast<void(RangeToken::*)(bool)>(&RangeToken::setSorted))},
