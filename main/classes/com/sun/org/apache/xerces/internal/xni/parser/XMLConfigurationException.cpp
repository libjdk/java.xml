...
XMLConfigurationException::XMLConfigurationException(const XMLConfigurationException& e) {
}

XMLConfigurationException XMLConfigurationException::wrapper$() {
	$pendingException(this);
	return *this;
}

void XMLConfigurationException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
