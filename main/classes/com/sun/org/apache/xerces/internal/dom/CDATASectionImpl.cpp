...
$MethodInfo _CDATASectionImpl_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/dom/CoreDocumentImpl;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(CDATASectionImpl::*)($CoreDocumentImpl*,$String*)>(&CDATASectionImpl::init$))},
