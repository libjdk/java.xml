...
$MethodInfo _NamespaceSupport$Prefixes_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/util/NamespaceSupport;[Ljava/lang/String;I)V", nullptr, $PUBLIC, $method(static_cast<void(NamespaceSupport$Prefixes::*)($NamespaceSupport*,$StringArray*,int32_t)>(&NamespaceSupport$Prefixes::init$))},
