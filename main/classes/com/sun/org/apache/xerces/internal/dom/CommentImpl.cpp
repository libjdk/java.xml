...
$MethodInfo _CommentImpl_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/dom/CoreDocumentImpl;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(CommentImpl::*)($CoreDocumentImpl*,$String*)>(&CommentImpl::init$))},
