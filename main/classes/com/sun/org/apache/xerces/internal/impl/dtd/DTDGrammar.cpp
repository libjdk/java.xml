...
$MethodInfo _DTDGrammar_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/util/SymbolTable;Lcom/sun/org/apache/xerces/internal/impl/dtd/XMLDTDDescription;)V", nullptr, $PUBLIC, $method(static_cast<void(DTDGrammar::*)($SymbolTable*,$XMLDTDDescription*)>(&DTDGrammar::init$))},
	{"addContentSpecNode", "(SLjava/lang/String;)I", nullptr, $PROTECTED},
	{"addContentSpecNode", "(SII)I", nullptr, $PROTECTED},
	{"addContentSpecToElement", "(Lcom/sun/org/apache/xerces/internal/impl/dtd/XMLElementDecl;)V", nullptr, $PROTECTED},
	{"addUniqueLeafNode", "(Ljava/lang/String;)I", nullptr, $PROTECTED},
	...
	{"appendContentSpec", "(Lcom/sun/org/apache/xerces/internal/impl/dtd/XMLContentSpec;Ljava/lang/StringBuffer;ZI)V", nullptr, $PRIVATE, $method(static_cast<void(DTDGrammar::*)($XMLContentSpec*,$StringBuffer*,bool,int32_t)>(&DTDGrammar::appendContentSpec))},
	...
	{"buildSyntaxTree", "(ILcom/sun/org/apache/xerces/internal/impl/dtd/XMLContentSpec;)Lcom/sun/org/apache/xerces/internal/impl/dtd/models/CMNode;", nullptr, $PRIVATE | $FINAL, $method(static_cast<$CMNode*(DTDGrammar::*)(int32_t,$XMLContentSpec*)>(&DTDGrammar::buildSyntaxTree))},
	...
	{"contentSpecTree", "(ILcom/sun/org/apache/xerces/internal/impl/dtd/XMLContentSpec;Lcom/sun/org/apache/xerces/internal/impl/dtd/DTDGrammar$ChildrenList;)V", nullptr, $PRIVATE, $method(static_cast<void(DTDGrammar::*)(int32_t,$XMLContentSpec*,$DTDGrammar$ChildrenList*)>(&DTDGrammar::contentSpecTree))},
	{"createAttributeDecl", "()I", nullptr, $PROTECTED},
	{"createChildModel", "(I)Lcom/sun/org/apache/xerces/internal/impl/dtd/models/ContentModelValidator;", nullptr, $PRIVATE | $SYNCHRONIZED, $method(static_cast<$ContentModelValidator*(DTDGrammar::*)(int32_t)>(&DTDGrammar::createChildModel))},
	{"createContentSpec", "()I", nullptr, $PROTECTED},
	{"createElementDecl", "()I", nullptr, $PROTECTED},
	{"createEntityDecl", "()I", nullptr, $PROTECTED},
	{"createNotationDecl", "()I", nullptr, $PROTECTED},
	...
	{"ensureAttributeDeclCapacity", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(DTDGrammar::*)(int32_t)>(&DTDGrammar::ensureAttributeDeclCapacity))},
	{"ensureContentSpecCapacity", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(DTDGrammar::*)(int32_t)>(&DTDGrammar::ensureContentSpecCapacity))},
	{"ensureElementDeclCapacity", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(DTDGrammar::*)(int32_t)>(&DTDGrammar::ensureElementDeclCapacity))},
	{"ensureEntityDeclCapacity", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(DTDGrammar::*)(int32_t)>(&DTDGrammar::ensureEntityDeclCapacity))},
	{"ensureNotationDeclCapacity", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(DTDGrammar::*)(int32_t)>(&DTDGrammar::ensureNotationDeclCapacity))},
	...
	{"getAttributeDecl", "(ILcom/sun/org/apache/xerces/internal/impl/dtd/XMLAttributeDecl;)Z", nullptr, $PUBLIC},
	{"getAttributeDeclIndex", "(ILjava/lang/String;)I", nullptr, $PUBLIC},
	{"getAttributeDeclIsExternal", "(I)Z", nullptr, $PUBLIC},
	{"getContentSpec", "(ILcom/sun/org/apache/xerces/internal/impl/dtd/XMLContentSpec;)Z", nullptr, $PUBLIC},
	{"getContentSpecAsString", "(I)Ljava/lang/String;", nullptr, $PUBLIC},
	{"getContentSpecIndex", "(I)I", nullptr, $PUBLIC},
	{"getContentSpecType", "(I)S", nullptr, $PUBLIC},
	...
	{"getElementContentModelValidator", "(I)Lcom/sun/org/apache/xerces/internal/impl/dtd/models/ContentModelValidator;", nullptr, $PROTECTED},
	{"getElementDecl", "(ILcom/sun/org/apache/xerces/internal/impl/dtd/XMLElementDecl;)Z", nullptr, $PUBLIC},
	{"getElementDeclIndex", "(Ljava/lang/String;)I", nullptr, $PUBLIC},
	{"getElementDeclIndex", "(Lcom/sun/org/apache/xerces/internal/xni/QName;)I", nullptr, $PUBLIC},
	{"getElementDeclIsExternal", "(I)Z", nullptr, $PUBLIC},
	{"getElementDeclName", "(I)Lcom/sun/org/apache/xerces/internal/xni/QName;", nullptr, 0},
	{"getEntityDecl", "(ILcom/sun/org/apache/xerces/internal/impl/dtd/XMLEntityDecl;)Z", nullptr, $PUBLIC},
	{"getEntityDeclIndex", "(Ljava/lang/String;)I", nullptr, $PUBLIC},
	{"getFirstAttributeDeclIndex", "(I)I", nullptr, $PUBLIC},
	{"getFirstElementDeclIndex", "()I", nullptr, $PUBLIC},
	{"getGrammarDescription", "()Lcom/sun/org/apache/xerces/internal/xni/grammars/XMLGrammarDescription;", nullptr, $PUBLIC},
	{"getNextAttributeDeclIndex", "(I)I", nullptr, $PUBLIC},
	{"getNextElementDeclIndex", "(I)I", nullptr, $PUBLIC},
	{"getNotationDecl", "(ILcom/sun/org/apache/xerces/internal/impl/dtd/XMLNotationDecl;)Z", nullptr, $PUBLIC},
	{"getNotationDeclIndex", "(Ljava/lang/String;)I", nullptr, $PUBLIC},
	...
	{"initializeContentModelStack", "()V", nullptr, $PROTECTED},
	...
	{"isCDATAAttribute", "(Lcom/sun/org/apache/xerces/internal/xni/QName;Lcom/sun/org/apache/xerces/internal/xni/QName;)Z", nullptr, $PUBLIC},
	{"isEntityDeclared", "(Ljava/lang/String;)Z", nullptr, $PUBLIC},
	{"isEntityUnparsed", "(Ljava/lang/String;)Z", nullptr, $PUBLIC},
	{"isImmutable", "()Z", nullptr, 0},
	...
	{"printAttribute", "(I)V", nullptr, $PRIVATE, $method(static_cast<void(DTDGrammar::*)(int32_t)>(&DTDGrammar::printAttribute))},
	{"printAttributes", "(I)V", nullptr, $PUBLIC},
	{"printElements", "()V", nullptr, $PUBLIC},
	...
	{"putElementNameMapping", "(Lcom/sun/org/apache/xerces/internal/xni/QName;II)V", nullptr, $PROTECTED},
	{"resize", "([[BI)[[B", nullptr, $PRIVATE | $STATIC, $method(static_cast<$byteArray2*(*)($byteArray2*,int32_t)>(&DTDGrammar::resize))},
	{"resize", "([[SI)[[S", nullptr, $PRIVATE | $STATIC, $method(static_cast<$shortArray2*(*)($shortArray2*,int32_t)>(&DTDGrammar::resize))},
	{"resize", "([[II)[[I", nullptr, $PRIVATE | $STATIC, $method(static_cast<$intArray2*(*)($intArray2*,int32_t)>(&DTDGrammar::resize))},
	{"resize", "([[Lcom/sun/org/apache/xerces/internal/impl/dv/DatatypeValidator;I)[[Lcom/sun/org/apache/xerces/internal/impl/dv/DatatypeValidator;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$DatatypeValidatorArray2*(*)($DatatypeValidatorArray2*,int32_t)>(&DTDGrammar::resize))},
	{"resize", "([[Lcom/sun/org/apache/xerces/internal/impl/dtd/models/ContentModelValidator;I)[[Lcom/sun/org/apache/xerces/internal/impl/dtd/models/ContentModelValidator;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$ContentModelValidatorArray2*(*)($ContentModelValidatorArray2*,int32_t)>(&DTDGrammar::resize))},
	{"resize", "([[Ljava/lang/Object;I)[[Ljava/lang/Object;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$ObjectArray2*(*)($ObjectArray2*,int32_t)>(&DTDGrammar::resize))},
	{"resize", "([[Lcom/sun/org/apache/xerces/internal/xni/QName;I)[[Lcom/sun/org/apache/xerces/internal/xni/QName;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$QNameArray2*(*)($QNameArray2*,int32_t)>(&DTDGrammar::resize))},
	{"resize", "([[Ljava/lang/String;I)[[Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$StringArray2*(*)($StringArray2*,int32_t)>(&DTDGrammar::resize))},
	{"resize", "([[[Ljava/lang/String;I)[[[Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$StringArray3*(*)($StringArray3*,int32_t)>(&DTDGrammar::resize))},
	...
	{"setAttributeDecl", "(IILcom/sun/org/apache/xerces/internal/impl/dtd/XMLAttributeDecl;)V", nullptr, $PROTECTED},
	{"setContentSpec", "(ILcom/sun/org/apache/xerces/internal/impl/dtd/XMLContentSpec;)V", nullptr, $PROTECTED},
	{"setContentSpecIndex", "(II)V", nullptr, $PROTECTED},
	...
	{"setElementDecl", "(ILcom/sun/org/apache/xerces/internal/impl/dtd/XMLElementDecl;)V", nullptr, $PROTECTED},
	{"setEntityDecl", "(ILcom/sun/org/apache/xerces/internal/impl/dtd/XMLEntityDecl;)V", nullptr, $PROTECTED},
	{"setFirstAttributeDeclIndex", "(II)V", nullptr, $PROTECTED},
	{"setNotationDecl", "(ILcom/sun/org/apache/xerces/internal/impl/dtd/XMLNotationDecl;)V", nullptr, $PROTECTED},
