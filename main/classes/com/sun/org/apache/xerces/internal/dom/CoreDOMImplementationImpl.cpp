...
$MethodInfo _CoreDOMImplementationImpl_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CoreDOMImplementationImpl::*)()>(&CoreDOMImplementationImpl::init$))},
	{"assignDocTypeNumber", "()I", nullptr, $PROTECTED | $SYNCHRONIZED},
	{"assignDocumentNumber", "()I", nullptr, $PROTECTED | $SYNCHRONIZED},
	{"checkQName", "(Ljava/lang/String;)V", nullptr, $FINAL, $method(static_cast<void(CoreDOMImplementationImpl::*)($String*)>(&CoreDOMImplementationImpl::checkQName))},
	...
	{"createLSInput", "()Lorg/w3c/dom/ls/LSInput;", nullptr, $PUBLIC},
	{"createLSOutput", "()Lorg/w3c/dom/ls/LSOutput;", nullptr, $PUBLIC},
	{"createLSParser", "(SLjava/lang/String;)Lorg/w3c/dom/ls/LSParser;", nullptr, $PUBLIC, nullptr, "org.w3c.dom.DOMException"},
	{"createLSSerializer", "()Lorg/w3c/dom/ls/LSSerializer;", nullptr, $PUBLIC},
	{"getDOMImplementation", "()Lorg/w3c/dom/DOMImplementation;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$DOMImplementation*(*)()>(&CoreDOMImplementationImpl::getDOMImplementation))},
	{"getDTDLoader", "(Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/impl/dtd/XMLDTDLoader;", nullptr, $FINAL | $SYNCHRONIZED, $method(static_cast<$XMLDTDLoader*(CoreDOMImplementationImpl::*)($String*)>(&CoreDOMImplementationImpl::getDTDLoader))},
	{"getFeature", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;", nullptr, $PUBLIC},
	{"getValidator", "(Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/impl/RevalidationHandler;", nullptr, $SYNCHRONIZED},
	{"hasFeature", "(Ljava/lang/String;Ljava/lang/String;)Z", nullptr, $PUBLIC},
	{"releaseDTDLoader", "(Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/impl/dtd/XMLDTDLoader;)V", nullptr, $FINAL | $SYNCHRONIZED, $method(static_cast<void(CoreDOMImplementationImpl::*)($String*,$XMLDTDLoader*)>(&CoreDOMImplementationImpl::releaseDTDLoader))},
	{"releaseValidator", "(Ljava/lang/String;Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/impl/RevalidationHandler;)V", nullptr, $SYNCHRONIZED},
