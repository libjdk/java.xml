...
$MethodInfo _DOMErrorHandlerWrapper_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(DOMErrorHandlerWrapper::*)()>(&DOMErrorHandlerWrapper::init$))},
	{"<init>", "(Lorg/w3c/dom/DOMErrorHandler;)V", nullptr, $PUBLIC, $method(static_cast<void(DOMErrorHandlerWrapper::*)($DOMErrorHandler*)>(&DOMErrorHandlerWrapper::init$))},
	...
	{"printError", "(Lorg/w3c/dom/DOMError;)V", nullptr, $PRIVATE, $method(static_cast<void(DOMErrorHandlerWrapper::*)($DOMError*)>(&DOMErrorHandlerWrapper::printError))},
