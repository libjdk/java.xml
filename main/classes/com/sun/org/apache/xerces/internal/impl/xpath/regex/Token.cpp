...
$MethodInfo _Token_MethodInfo_[] = {
	{"<init>", "(I)V", nullptr, $PROTECTED, $method(static_cast<void(Token::*)(int32_t)>(&Token::init$))},
	{"addChild", "(Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;)V", nullptr, 0},
	{"addRange", "(II)V", nullptr, $PROTECTED},
	{"analyzeFirstCharacter", "(Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/RangeToken;I)I", nullptr, $FINAL, $method(static_cast<int32_t(Token::*)($RangeToken*,int32_t)>(&Token::analyzeFirstCharacter))},
	{"compactRanges", "()V", nullptr, $PROTECTED},
	{"complementRanges", "(Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;)Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;", nullptr, $STATIC, $method(static_cast<Token*(*)(Token*)>(&Token::complementRanges))},
	{"createAnchor", "(I)Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token$CharToken;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$Token$CharToken*(*)(int32_t)>(&Token::createAnchor))},
	{"createBackReference", "(I)Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token$StringToken;", nullptr, $STATIC, $method(static_cast<$Token$StringToken*(*)(int32_t)>(&Token::createBackReference))},
	{"createChar", "(I)Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token$CharToken;", nullptr, $STATIC, $method(static_cast<$Token$CharToken*(*)(int32_t)>(&Token::createChar))},
	{"createClosure", "(Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;)Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token$ClosureToken;", nullptr, $STATIC, $method(static_cast<$Token$ClosureToken*(*)(Token*)>(&Token::createClosure))},
	{"createConcat", "(Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;)Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token$ConcatToken;", nullptr, $STATIC, $method(static_cast<$Token$ConcatToken*(*)(Token*,Token*)>(&Token::createConcat))},
	{"createConcat", "()Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token$UnionToken;", nullptr, $STATIC, $method(static_cast<$Token$UnionToken*(*)()>(&Token::createConcat))},
	{"createCondition", "(ILcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;)Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token$ConditionToken;", nullptr, $STATIC, $method(static_cast<$Token$ConditionToken*(*)(int32_t,Token*,Token*,Token*)>(&Token::createCondition))},
	{"createEmpty", "()Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;", nullptr, $STATIC, $method(static_cast<Token*(*)()>(&Token::createEmpty))},
	{"createLook", "(ILcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;)Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token$ParenToken;", nullptr, $STATIC, $method(static_cast<$Token$ParenToken*(*)(int32_t,Token*)>(&Token::createLook))},
	{"createModifierGroup", "(Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;II)Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token$ModifierToken;", nullptr, $STATIC, $method(static_cast<$Token$ModifierToken*(*)(Token*,int32_t,int32_t)>(&Token::createModifierGroup))},
	{"createNGClosure", "(Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;)Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token$ClosureToken;", nullptr, $STATIC, $method(static_cast<$Token$ClosureToken*(*)(Token*)>(&Token::createNGClosure))},
	{"createNRange", "()Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/RangeToken;", nullptr, $STATIC, $method(static_cast<$RangeToken*(*)()>(&Token::createNRange))},
	{"createParen", "(Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;I)Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token$ParenToken;", nullptr, $STATIC, $method(static_cast<$Token$ParenToken*(*)(Token*,int32_t)>(&Token::createParen))},
	{"createRange", "()Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/RangeToken;", nullptr, $STATIC, $method(static_cast<$RangeToken*(*)()>(&Token::createRange))},
	{"createString", "(Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token$StringToken;", nullptr, $STATIC, $method(static_cast<$Token$StringToken*(*)($String*)>(&Token::createString))},
	{"createUnion", "()Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token$UnionToken;", nullptr, $STATIC, $method(static_cast<$Token$UnionToken*(*)()>(&Token::createUnion))},
	{"findFixedString", "(Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token$FixedStringContainer;I)V", nullptr, $FINAL, $method(static_cast<void(Token::*)($Token$FixedStringContainer*,int32_t)>(&Token::findFixedString))},
	{"getChar", "()I", nullptr, 0},
	{"getChild", "(I)Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;", nullptr, 0},
	{"getCombiningCharacterSequence", "()Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;", nullptr, $STATIC | $SYNCHRONIZED, $method(static_cast<Token*(*)()>(&Token::getCombiningCharacterSequence))},
	{"getGraphemePattern", "()Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;", nullptr, $STATIC | $SYNCHRONIZED, $method(static_cast<Token*(*)()>(&Token::getGraphemePattern))},
	{"getMax", "()I", nullptr, 0},
	{"getMaxLength", "()I", nullptr, $FINAL, $method(static_cast<int32_t(Token::*)()>(&Token::getMaxLength))},
	{"getMin", "()I", nullptr, 0},
	{"getMinLength", "()I", nullptr, $FINAL, $method(static_cast<int32_t(Token::*)()>(&Token::getMinLength))},
	{"getParenNumber", "()I", nullptr, 0},
	{"getRange", "(Ljava/lang/String;Z)Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/RangeToken;", nullptr, $PROTECTED | $STATIC, $method(static_cast<$RangeToken*(*)($String*,bool)>(&Token::getRange))},
	{"getRange", "(Ljava/lang/String;ZZ)Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/RangeToken;", nullptr, $PROTECTED | $STATIC, $method(static_cast<$RangeToken*(*)($String*,bool,bool)>(&Token::getRange))},
	{"getReferenceNumber", "()I", nullptr, 0},
	{"getString", "()Ljava/lang/String;", nullptr, 0},
	{"intersectRanges", "(Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;)V", nullptr, $PROTECTED},
	{"isRegisterNonXS", "(Ljava/lang/String;)Z", nullptr, $PROTECTED | $STATIC, $method(static_cast<bool(*)($String*)>(&Token::isRegisterNonXS))},
	{"isSet", "(II)Z", nullptr, $PRIVATE | $STATIC | $FINAL, $method(static_cast<bool(*)(int32_t,int32_t)>(&Token::isSet))},
	{"isShorterThan", "(Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;)Z", nullptr, $PRIVATE | $FINAL, $method(static_cast<bool(Token::*)(Token*)>(&Token::isShorterThan))},
	{"match", "(I)Z", nullptr, 0},
	{"mergeRanges", "(Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;)V", nullptr, $PROTECTED},
	{"registerNonXS", "(Ljava/lang/String;)V", nullptr, $PROTECTED | $STATIC, $method(static_cast<void(*)($String*)>(&Token::registerNonXS))},
	{"setAlias", "(Ljava/util/Map;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Z)V", "(Ljava/util/Map<Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;>;Ljava/util/Map<Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;>;Ljava/lang/String;Ljava/lang/String;Z)V", $PRIVATE | $STATIC, $method(static_cast<void(*)($Map*,$Map*,$String*,$String*,bool)>(&Token::setAlias))},
	{"setMax", "(I)V", nullptr, 0},
	{"setMin", "(I)V", nullptr, 0},
	{"size", "()I", nullptr, 0},
	{"sortRanges", "()V", nullptr, $PROTECTED},
	{"subtractRanges", "(Lcom/sun/org/apache/xerces/internal/impl/xpath/regex/Token;)V", nullptr, $PROTECTED},
