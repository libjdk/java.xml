...
$MethodInfo _DOMConfigurationImpl_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PROTECTED, $method(static_cast<void(DOMConfigurationImpl::*)()>(&DOMConfigurationImpl::init$))},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/util/SymbolTable;)V", nullptr, $PROTECTED, $method(static_cast<void(DOMConfigurationImpl::*)($SymbolTable*)>(&DOMConfigurationImpl::init$))},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/util/SymbolTable;Lcom/sun/org/apache/xerces/internal/xni/parser/XMLComponentManager;)V", nullptr, $PROTECTED, $method(static_cast<void(DOMConfigurationImpl::*)($SymbolTable*,$XMLComponentManager*)>(&DOMConfigurationImpl::init$))},
	...
	{"createValidationManager", "()Lcom/sun/org/apache/xerces/internal/impl/validation/ValidationManager;", nullptr, $PROTECTED},
	...
	{"newFeatureNotFoundError", "(Ljava/lang/String;)Lorg/w3c/dom/DOMException;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$DOMException*(*)($String*)>(&DOMConfigurationImpl::newFeatureNotFoundError))},
	{"newFeatureNotSupportedError", "(Ljava/lang/String;)Lorg/w3c/dom/DOMException;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$DOMException*(*)($String*)>(&DOMConfigurationImpl::newFeatureNotSupportedError))},
	{"newTypeMismatchError", "(Ljava/lang/String;)Lorg/w3c/dom/DOMException;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$DOMException*(*)($String*)>(&DOMConfigurationImpl::newTypeMismatchError))},
	...
	{"setDTDValidatorFactory", "(Ljava/lang/String;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(DOMConfigurationImpl::*)($String*)>(&DOMConfigurationImpl::setDTDValidatorFactory))},
