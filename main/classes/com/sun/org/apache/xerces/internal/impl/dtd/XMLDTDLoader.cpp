...
$MethodInfo _XMLDTDLoader_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(XMLDTDLoader::*)()>(&XMLDTDLoader::init$))},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/util/SymbolTable;)V", nullptr, $PUBLIC, $method(static_cast<void(XMLDTDLoader::*)($SymbolTable*)>(&XMLDTDLoader::init$))},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/util/SymbolTable;Lcom/sun/org/apache/xerces/internal/xni/grammars/XMLGrammarPool;)V", nullptr, $PUBLIC, $method(static_cast<void(XMLDTDLoader::*)($SymbolTable*,$XMLGrammarPool*)>(&XMLDTDLoader::init$))},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/util/SymbolTable;Lcom/sun/org/apache/xerces/internal/xni/grammars/XMLGrammarPool;Lcom/sun/org/apache/xerces/internal/impl/XMLErrorReporter;Lcom/sun/org/apache/xerces/internal/xni/parser/XMLEntityResolver;)V", nullptr, 0, $method(static_cast<void(XMLDTDLoader::*)($SymbolTable*,$XMLGrammarPool*,$XMLErrorReporter*,$XMLEntityResolver*)>(&XMLDTDLoader::init$))},
	...
	{"loadGrammarWithContext", "(Lcom/sun/org/apache/xerces/internal/impl/dtd/XMLDTDValidator;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, nullptr, "java.io.IOException,com.sun.org.apache.xerces.internal.xni.XNIException"},
