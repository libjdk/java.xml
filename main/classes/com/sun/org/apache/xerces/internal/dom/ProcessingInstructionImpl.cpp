...
$MethodInfo _ProcessingInstructionImpl_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/dom/CoreDocumentImpl;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(ProcessingInstructionImpl::*)($CoreDocumentImpl*,$String*,$String*)>(&ProcessingInstructionImpl::init$))},
