...
$MethodInfo _XSDAbstractTraverser_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/impl/xs/traversers/XSDHandler;Lcom/sun/org/apache/xerces/internal/impl/xs/traversers/XSAttributeChecker;)V", nullptr, 0, $method(static_cast<void(XSDAbstractTraverser::*)($XSDHandler*,$XSAttributeChecker*)>(&XSDAbstractTraverser::init$))},
	{"checkEnumerationAndLengthInconsistency", "(Lcom/sun/org/apache/xerces/internal/impl/dv/XSSimpleType;Ljava/util/List;Lorg/w3c/dom/Element;Ljava/lang/String;)V", "(Lcom/sun/org/apache/xerces/internal/impl/dv/XSSimpleType;Ljava/util/List<Ljava/lang/String;>;Lorg/w3c/dom/Element;Ljava/lang/String;)V", $PRIVATE, $method(static_cast<void(XSDAbstractTraverser::*)($XSSimpleType*,$List*,$Element*,$String*)>(&XSDAbstractTraverser::checkEnumerationAndLengthInconsistency))},
	{"checkEnumerationAndMaxLengthInconsistency", "(Lcom/sun/org/apache/xerces/internal/impl/dv/XSSimpleType;Ljava/util/List;Lorg/w3c/dom/Element;Ljava/lang/String;)V", "(Lcom/sun/org/apache/xerces/internal/impl/dv/XSSimpleType;Ljava/util/List<Ljava/lang/String;>;Lorg/w3c/dom/Element;Ljava/lang/String;)V", $PRIVATE, $method(static_cast<void(XSDAbstractTraverser::*)($XSSimpleType*,$List*,$Element*,$String*)>(&XSDAbstractTraverser::checkEnumerationAndMaxLengthInconsistency))},
	{"checkEnumerationAndMinLengthInconsistency", "(Lcom/sun/org/apache/xerces/internal/impl/dv/XSSimpleType;Ljava/util/List;Lorg/w3c/dom/Element;Ljava/lang/String;)V", "(Lcom/sun/org/apache/xerces/internal/impl/dv/XSSimpleType;Ljava/util/List<Ljava/lang/String;>;Lorg/w3c/dom/Element;Ljava/lang/String;)V", $PRIVATE, $method(static_cast<void(XSDAbstractTraverser::*)($XSSimpleType*,$List*,$Element*,$String*)>(&XSDAbstractTraverser::checkEnumerationAndMinLengthInconsistency))},
	{"checkNotationType", "(Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/xs/XSTypeDefinition;Lorg/w3c/dom/Element;)V", nullptr, 0},
	{"checkOccurrences", "(Lcom/sun/org/apache/xerces/internal/impl/xs/XSParticleDecl;Ljava/lang/String;Lorg/w3c/dom/Element;IJ)Lcom/sun/org/apache/xerces/internal/impl/xs/XSParticleDecl;", nullptr, $PROTECTED},
	{"containsQName", "(Lcom/sun/org/apache/xerces/internal/impl/dv/XSSimpleType;)Z", nullptr, $PRIVATE, $method(static_cast<bool(XSDAbstractTraverser::*)($XSSimpleType*)>(&XSDAbstractTraverser::containsQName))},
	{"escapeAttValue", "(Ljava/lang/String;I)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*,int32_t)>(&XSDAbstractTraverser::escapeAttValue))},
	{"getSchemaTypeName", "(Lcom/sun/org/apache/xerces/internal/xs/XSTypeDefinition;)Ljava/lang/String;", nullptr, $PUBLIC | $STATIC, $method(static_cast<$String*(*)($XSTypeDefinition*)>(&XSDAbstractTraverser::getSchemaTypeName))},
	{"processAttValue", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*)>(&XSDAbstractTraverser::processAttValue))},
	...
	{"reset", "(Lcom/sun/org/apache/xerces/internal/util/SymbolTable;ZLjava/util/Locale;)V", nullptr, 0},
	{"traverseAnnotationDecl", "(Lorg/w3c/dom/Element;[Ljava/lang/Object;ZLcom/sun/org/apache/xerces/internal/impl/xs/traversers/XSDocumentInfo;)Lcom/sun/org/apache/xerces/internal/impl/xs/XSAnnotationImpl;", nullptr, 0},
	{"traverseAttrsAndAttrGrps", "(Lorg/w3c/dom/Element;Lcom/sun/org/apache/xerces/internal/impl/xs/XSAttributeGroupDecl;Lcom/sun/org/apache/xerces/internal/impl/xs/traversers/XSDocumentInfo;Lcom/sun/org/apache/xerces/internal/impl/xs/SchemaGrammar;Lcom/sun/org/apache/xerces/internal/impl/xs/XSComplexTypeDecl;)Lorg/w3c/dom/Element;", nullptr, 0},
	{"traverseFacets", "(Lorg/w3c/dom/Element;Lcom/sun/org/apache/xerces/internal/xs/XSTypeDefinition;Lcom/sun/org/apache/xerces/internal/impl/dv/XSSimpleType;Lcom/sun/org/apache/xerces/internal/impl/xs/traversers/XSDocumentInfo;)Lcom/sun/org/apache/xerces/internal/impl/xs/traversers/XSDAbstractTraverser$FacetInfo;", nullptr, 0},
	{"traverseSyntheticAnnotation", "(Lorg/w3c/dom/Element;Ljava/lang/String;[Ljava/lang/Object;ZLcom/sun/org/apache/xerces/internal/impl/xs/traversers/XSDocumentInfo;)Lcom/sun/org/apache/xerces/internal/impl/xs/XSAnnotationImpl;", nullptr, 0},
	{}
};
