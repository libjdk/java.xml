...
$MethodInfo _DOMResultBuilder_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(DOMResultBuilder::*)()>(&DOMResultBuilder::init$))},
	{"append", "(Lorg/w3c/dom/Node;)V", nullptr, $PRIVATE, $method(static_cast<void(DOMResultBuilder::*)($Node*)>(&DOMResultBuilder::append)), "com.sun.org.apache.xerces.internal.xni.XNIException"},
