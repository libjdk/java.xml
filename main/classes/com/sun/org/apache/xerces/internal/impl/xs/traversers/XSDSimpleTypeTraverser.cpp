...
$MethodInfo _XSDSimpleTypeTraverser_MethodInfo_[] = {
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/impl/xs/traversers/XSDHandler;Lcom/sun/org/apache/xerces/internal/impl/xs/traversers/XSAttributeChecker;)V", nullptr, 0, $method(static_cast<void(XSDSimpleTypeTraverser::*)($XSDHandler*,$XSAttributeChecker*)>(&XSDSimpleTypeTraverser::init$))},
	{"checkBuiltIn", "(Ljava/lang/String;Ljava/lang/String;)Z", nullptr, $PRIVATE | $FINAL, $method(static_cast<bool(XSDSimpleTypeTraverser::*)($String*,$String*)>(&XSDSimpleTypeTraverser::checkBuiltIn))},
	{"errorType", "(Ljava/lang/String;Ljava/lang/String;S)Lcom/sun/org/apache/xerces/internal/impl/dv/XSSimpleType;", nullptr, $PRIVATE, $method(static_cast<$XSSimpleType*(XSDSimpleTypeTraverser::*)($String*,$String*,int16_t)>(&XSDSimpleTypeTraverser::errorType))},
	{"findDTValidator", "(Lorg/w3c/dom/Element;Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/xni/QName;SLcom/sun/org/apache/xerces/internal/impl/xs/traversers/XSDocumentInfo;)Lcom/sun/org/apache/xerces/internal/impl/dv/XSSimpleType;", nullptr, $PRIVATE, $method(static_cast<$XSSimpleType*(XSDSimpleTypeTraverser::*)($Element*,$String*,$QName*,int16_t,$XSDocumentInfo*)>(&XSDSimpleTypeTraverser::findDTValidator))},
	{"genAnonTypeName", "(Lorg/w3c/dom/Element;)Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(XSDSimpleTypeTraverser::*)($Element*)>(&XSDSimpleTypeTraverser::genAnonTypeName))},
	{"getSimpleType", "(Ljava/lang/String;Lorg/w3c/dom/Element;[Ljava/lang/Object;Lcom/sun/org/apache/xerces/internal/impl/xs/traversers/XSDocumentInfo;Lcom/sun/org/apache/xerces/internal/impl/xs/SchemaGrammar;)Lcom/sun/org/apache/xerces/internal/impl/dv/XSSimpleType;", nullptr, $PRIVATE, $method(static_cast<$XSSimpleType*(XSDSimpleTypeTraverser::*)($String*,$Element*,$ObjectArray*,$XSDocumentInfo*,$SchemaGrammar*)>(&XSDSimpleTypeTraverser::getSimpleType))},
	{"isListDatatype", "(Lcom/sun/org/apache/xerces/internal/impl/dv/XSSimpleType;)Z", nullptr, $PRIVATE, $method(static_cast<bool(XSDSimpleTypeTraverser::*)($XSSimpleType*)>(&XSDSimpleTypeTraverser::isListDatatype))},
	{"traverseGlobal", "(Lorg/w3c/dom/Element;Lcom/sun/org/apache/xerces/internal/impl/xs/traversers/XSDocumentInfo;Lcom/sun/org/apache/xerces/internal/impl/xs/SchemaGrammar;)Lcom/sun/org/apache/xerces/internal/impl/dv/XSSimpleType;", nullptr, 0},
	{"traverseLocal", "(Lorg/w3c/dom/Element;Lcom/sun/org/apache/xerces/internal/impl/xs/traversers/XSDocumentInfo;Lcom/sun/org/apache/xerces/internal/impl/xs/SchemaGrammar;)Lcom/sun/org/apache/xerces/internal/impl/dv/XSSimpleType;", nullptr, 0},
	{"traverseSimpleTypeDecl", "(Lorg/w3c/dom/Element;[Ljava/lang/Object;Lcom/sun/org/apache/xerces/internal/impl/xs/traversers/XSDocumentInfo;Lcom/sun/org/apache/xerces/internal/impl/xs/SchemaGrammar;)Lcom/sun/org/apache/xerces/internal/impl/dv/XSSimpleType;", nullptr, $PRIVATE, $method(static_cast<$XSSimpleType*(XSDSimpleTypeTraverser::*)($Element*,$ObjectArray*,$XSDocumentInfo*,$SchemaGrammar*)>(&XSDSimpleTypeTraverser::traverseSimpleTypeDecl))},
	{}
};
