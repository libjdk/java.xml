...
$MethodInfo _UnparsedEntityHandler_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/impl/validation/ValidationManager;)V", nullptr, 0, $method(static_cast<void(UnparsedEntityHandler::*)($ValidationManager*)>(&UnparsedEntityHandler::init$))},
	...
	{"reset", "()V", nullptr, $PUBLIC, $method(static_cast<void(UnparsedEntityHandler::*)()>(&UnparsedEntityHandler::reset))},
