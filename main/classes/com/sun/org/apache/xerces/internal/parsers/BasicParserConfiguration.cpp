...
$MethodInfo _BasicParserConfiguration_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PROTECTED, $method(static_cast<void(BasicParserConfiguration::*)()>(&BasicParserConfiguration::init$))},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/util/SymbolTable;)V", nullptr, $PROTECTED, $method(static_cast<void(BasicParserConfiguration::*)($SymbolTable*)>(&BasicParserConfiguration::init$))},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/util/SymbolTable;Lcom/sun/org/apache/xerces/internal/xni/parser/XMLComponentManager;)V", nullptr, $PROTECTED, $method(static_cast<void(BasicParserConfiguration::*)($SymbolTable*,$XMLComponentManager*)>(&BasicParserConfiguration::init$))},
