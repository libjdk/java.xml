...
$MethodInfo _ValidatorHandlerImpl_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/jaxp/validation/XSGrammarPoolContainer;)V", nullptr, $PUBLIC, $method(static_cast<void(ValidatorHandlerImpl::*)($XSGrammarPoolContainer*)>(&ValidatorHandlerImpl::init$))},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/jaxp/validation/XMLSchemaValidatorComponentManager;)V", nullptr, $PUBLIC, $method(static_cast<void(ValidatorHandlerImpl::*)($XMLSchemaValidatorComponentManager*)>(&ValidatorHandlerImpl::init$))},
	...
	{"fillQName", "(Lcom/sun/org/apache/xerces/internal/xni/QName;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(ValidatorHandlerImpl::*)($QName*,$String*,$String*,$String*)>(&ValidatorHandlerImpl::fillQName))},
	{"fillXMLAttribute", "(Lorg/xml/sax/Attributes;I)V", nullptr, $PRIVATE, $method(static_cast<void(ValidatorHandlerImpl::*)($Attributes*,int32_t)>(&ValidatorHandlerImpl::fillXMLAttribute))},
	{"fillXMLAttributes", "(Lorg/xml/sax/Attributes;)V", nullptr, $PRIVATE, $method(static_cast<void(ValidatorHandlerImpl::*)($Attributes*)>(&ValidatorHandlerImpl::fillXMLAttributes))},
	{"fillXMLAttributes2", "(Lorg/xml/sax/ext/Attributes2;)V", nullptr, $PRIVATE, $method(static_cast<void(ValidatorHandlerImpl::*)($Attributes2*)>(&ValidatorHandlerImpl::fillXMLAttributes2))},
	...
	{"getTypeInfoProvider", "()Ljavax/xml/validation/TypeInfoProvider;", nullptr, $PUBLIC},
