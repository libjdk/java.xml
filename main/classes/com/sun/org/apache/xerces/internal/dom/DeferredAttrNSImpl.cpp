...
$MethodInfo _DeferredAttrNSImpl_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/dom/DeferredDocumentImpl;I)V", nullptr, 0, $method(static_cast<void(DeferredAttrNSImpl::*)($DeferredDocumentImpl*,int32_t)>(&DeferredAttrNSImpl::init$))},
