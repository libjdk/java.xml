...
$MethodInfo _StringListImpl_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/util/List;)V", "(Ljava/util/List<Ljava/lang/String;>;)V", $PUBLIC, $method(static_cast<void(StringListImpl::*)($List*)>(&StringListImpl::init$))},
	{"<init>", "([Ljava/lang/String;I)V", nullptr, $PUBLIC, $method(static_cast<void(StringListImpl::*)($StringArray*,int32_t)>(&StringListImpl::init$))},
	...
	{"toArray0", "([Ljava/lang/Object;)V", nullptr, $PRIVATE, $method(static_cast<void(StringListImpl::*)($ObjectArray*)>(&StringListImpl::toArray0))},
