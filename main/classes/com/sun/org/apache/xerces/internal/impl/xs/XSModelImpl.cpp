...
$MethodInfo _XSModelImpl_MethodInfo_[] = {
	...
	{"<init>", "([Lcom/sun/org/apache/xerces/internal/impl/xs/SchemaGrammar;)V", nullptr, $PUBLIC, $method(static_cast<void(XSModelImpl::*)($SchemaGrammarArray*)>(&XSModelImpl::init$))},
	{"<init>", "([Lcom/sun/org/apache/xerces/internal/impl/xs/SchemaGrammar;S)V", nullptr, $PUBLIC, $method(static_cast<void(XSModelImpl::*)($SchemaGrammarArray*,int16_t)>(&XSModelImpl::init$))},
	{"buildSubGroups", "()Lcom/sun/org/apache/xerces/internal/util/SymbolHash;", nullptr, $PRIVATE, $method(static_cast<$SymbolHash*(XSModelImpl::*)()>(&XSModelImpl::buildSubGroups))},
	{"buildSubGroups_Org", "()Lcom/sun/org/apache/xerces/internal/util/SymbolHash;", nullptr, $PRIVATE, $method(static_cast<$SymbolHash*(XSModelImpl::*)()>(&XSModelImpl::buildSubGroups_Org))},
	{"get", "(I)Lcom/sun/org/apache/xerces/internal/xs/XSNamespaceItem;", nullptr, $PUBLIC},
	{"getAnnotations", "()Lcom/sun/org/apache/xerces/internal/xs/XSObjectList;", nullptr, $PUBLIC | $SYNCHRONIZED},
	{"getAttributeDeclaration", "(Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/XSAttributeDeclaration;", nullptr, $PUBLIC},
	{"getAttributeDeclaration", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/XSAttributeDeclaration;", nullptr, $PUBLIC, $method(static_cast<$XSAttributeDeclaration*(XSModelImpl::*)($String*,$String*,$String*)>(&XSModelImpl::getAttributeDeclaration))},
	{"getAttributeGroup", "(Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/XSAttributeGroupDefinition;", nullptr, $PUBLIC},
	{"getAttributeGroup", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/XSAttributeGroupDefinition;", nullptr, $PUBLIC, $method(static_cast<$XSAttributeGroupDefinition*(XSModelImpl::*)($String*,$String*,$String*)>(&XSModelImpl::getAttributeGroup))},
	{"getComponents", "(S)Lcom/sun/org/apache/xerces/internal/xs/XSNamedMap;", nullptr, $PUBLIC | $SYNCHRONIZED},
	{"getComponentsByNamespace", "(SLjava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/XSNamedMap;", nullptr, $PUBLIC | $SYNCHRONIZED},
	{"getElementDeclaration", "(Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/XSElementDeclaration;", nullptr, $PUBLIC},
	{"getElementDeclaration", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/XSElementDeclaration;", nullptr, $PUBLIC, $method(static_cast<$XSElementDeclaration*(XSModelImpl::*)($String*,$String*,$String*)>(&XSModelImpl::getElementDeclaration))},
	{"getGlobalElements", "()Lcom/sun/org/apache/xerces/internal/impl/xs/util/XSObjectListImpl;", nullptr, $PRIVATE, $method(static_cast<$XSObjectListImpl*(XSModelImpl::*)()>(&XSModelImpl::getGlobalElements))},
	{"getIDCDefinition", "(Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/XSIDCDefinition;", nullptr, $PUBLIC},
	{"getIDCDefinition", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/XSIDCDefinition;", nullptr, $PUBLIC, $method(static_cast<$XSIDCDefinition*(XSModelImpl::*)($String*,$String*,$String*)>(&XSModelImpl::getIDCDefinition))},
	{"getLength", "()I", nullptr, $PUBLIC},
	{"getModelGroupDefinition", "(Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/XSModelGroupDefinition;", nullptr, $PUBLIC},
	{"getModelGroupDefinition", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/XSModelGroupDefinition;", nullptr, $PUBLIC, $method(static_cast<$XSModelGroupDefinition*(XSModelImpl::*)($String*,$String*,$String*)>(&XSModelImpl::getModelGroupDefinition))},
	{"getNamespaceItems", "()Lcom/sun/org/apache/xerces/internal/xs/XSNamespaceItemList;", nullptr, $PUBLIC},
	{"getNamespaces", "()Lcom/sun/org/apache/xerces/internal/xs/StringList;", nullptr, $PUBLIC},
	{"getNotationDeclaration", "(Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/XSNotationDeclaration;", nullptr, $PUBLIC},
	{"getNotationDeclaration", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/XSNotationDeclaration;", nullptr, $PUBLIC, $method(static_cast<$XSNotationDeclaration*(XSModelImpl::*)($String*,$String*,$String*)>(&XSModelImpl::getNotationDeclaration))},
	{"getSubstitutionGroup", "(Lcom/sun/org/apache/xerces/internal/xs/XSElementDeclaration;)Lcom/sun/org/apache/xerces/internal/xs/XSObjectList;", nullptr, $PUBLIC},
	{"getTypeDefinition", "(Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/XSTypeDefinition;", nullptr, $PUBLIC},
	{"getTypeDefinition", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xs/XSTypeDefinition;", nullptr, $PUBLIC, $method(static_cast<$XSTypeDefinition*(XSModelImpl::*)($String*,$String*,$String*)>(&XSModelImpl::getTypeDefinition))},
	{"hasIDConstraints", "()Z", nullptr, $PUBLIC, $method(static_cast<bool(XSModelImpl::*)()>(&XSModelImpl::hasIDConstraints))},
	{"*isEmpty", "()Z", nullptr, $PUBLIC},
	{"item", "(I)Lcom/sun/org/apache/xerces/internal/xs/XSNamespaceItem;", nullptr, $PUBLIC},
	{"iterator", "()Ljava/util/Iterator;", "()Ljava/util/Iterator<Lcom/sun/org/apache/xerces/internal/xs/XSNamespaceItem;>;", $PUBLIC},
	{"*lastIndexOf", "(Ljava/lang/Object;)I", nullptr, $PUBLIC},
	{"listIterator", "()Ljava/util/ListIterator;", "()Ljava/util/ListIterator<Lcom/sun/org/apache/xerces/internal/xs/XSNamespaceItem;>;", $PUBLIC},
	{"listIterator", "(I)Ljava/util/ListIterator;", "(I)Ljava/util/ListIterator<Lcom/sun/org/apache/xerces/internal/xs/XSNamespaceItem;>;", $PUBLIC},
	{"listIterator0", "(I)Ljava/util/ListIterator;", "(I)Ljava/util/ListIterator<Lcom/sun/org/apache/xerces/internal/xs/XSNamespaceItem;>;", $PRIVATE, $method(static_cast<$ListIterator*(XSModelImpl::*)(int32_t)>(&XSModelImpl::listIterator0))},
	{"null2EmptyString", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC | $FINAL, $method(static_cast<$String*(*)($String*)>(&XSModelImpl::null2EmptyString))},
	...
	{"toArray0", "([Ljava/lang/Object;)V", nullptr, $PRIVATE, $method(static_cast<void(XSModelImpl::*)($ObjectArray*)>(&XSModelImpl::toArray0))},
