...
$MethodInfo _TextImpl_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(TextImpl::*)()>(&TextImpl::init$))},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/dom/CoreDocumentImpl;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(TextImpl::*)($CoreDocumentImpl*,$String*)>(&TextImpl::init$))},
	{"canModifyNext", "(Lorg/w3c/dom/Node;)Z", nullptr, $PRIVATE, $method(static_cast<bool(TextImpl::*)($Node*)>(&TextImpl::canModifyNext))},
	{"canModifyPrev", "(Lorg/w3c/dom/Node;)Z", nullptr, $PRIVATE, $method(static_cast<bool(TextImpl::*)($Node*)>(&TextImpl::canModifyPrev))},
	{"getNodeName", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getNodeType", "()S", nullptr, $PUBLIC},
	{"getWholeText", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getWholeTextBackward", "(Lorg/w3c/dom/Node;Ljava/lang/StringBuilder;Lorg/w3c/dom/Node;)Z", nullptr, $PRIVATE, $method(static_cast<bool(TextImpl::*)($Node*,$StringBuilder*,$Node*)>(&TextImpl::getWholeTextBackward))},
	{"getWholeTextForward", "(Lorg/w3c/dom/Node;Ljava/lang/StringBuilder;Lorg/w3c/dom/Node;)Z", nullptr, $PRIVATE, $method(static_cast<bool(TextImpl::*)($Node*,$StringBuilder*,$Node*)>(&TextImpl::getWholeTextForward))},
	{"hasTextOnlyChildren", "(Lorg/w3c/dom/Node;)Z", nullptr, $PRIVATE, $method(static_cast<bool(TextImpl::*)($Node*)>(&TextImpl::hasTextOnlyChildren))},
	...
	{"insertTextContent", "(Ljava/lang/StringBuilder;)V", nullptr, $PROTECTED, nullptr, "org.w3c.dom.DOMException"},
	...
	{"isIgnorableWhitespace", "()Z", nullptr, $PUBLIC},
	...
	{"removeData", "()Ljava/lang/String;", nullptr, $PUBLIC},
	...
	{"replaceData", "(Ljava/lang/String;)V", nullptr, $PUBLIC},
	...
	{"setIgnorableWhitespace", "(Z)V", nullptr, $PUBLIC},
	...
	{"setValues", "(Lcom/sun/org/apache/xerces/internal/dom/CoreDocumentImpl;Ljava/lang/String;)V", nullptr, $PUBLIC},
