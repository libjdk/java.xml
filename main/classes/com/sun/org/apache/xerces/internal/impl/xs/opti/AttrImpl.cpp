...
$MethodInfo _AttrImpl_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(AttrImpl::*)()>(&AttrImpl::init$))},
	{"<init>", "(Lorg/w3c/dom/Element;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(AttrImpl::*)($Element*,$String*,$String*,$String*,$String*,$String*)>(&AttrImpl::init$))},
