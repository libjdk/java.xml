...
$MethodInfo _XIncludeHandler_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(XIncludeHandler::*)()>(&XIncludeHandler::init$))},
	{"addNotation", "(Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/xni/XMLResourceIdentifier;Lcom/sun/org/apache/xerces/internal/xni/Augmentations;)V", nullptr, $PROTECTED},
	{"addUnparsedEntity", "(Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/xni/XMLResourceIdentifier;Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/xni/Augmentations;)V", nullptr, $PROTECTED},
	...
	{"checkAndSendNotation", "(Lcom/sun/org/apache/xerces/internal/xinclude/XIncludeHandler$Notation;)V", nullptr, $PROTECTED},
	{"checkAndSendUnparsedEntity", "(Lcom/sun/org/apache/xerces/internal/xinclude/XIncludeHandler$UnparsedEntity;)V", nullptr, $PROTECTED},
	{"checkMultipleRootElements", "()V", nullptr, $PRIVATE, $method(static_cast<void(XIncludeHandler::*)()>(&XIncludeHandler::checkMultipleRootElements))},
	{"checkNotation", "(Ljava/lang/String;)V", nullptr, $PROTECTED},
	{"checkUnparsedEntity", "(Ljava/lang/String;)V", nullptr, $PROTECTED},
	{"checkWhitespace", "(Lcom/sun/org/apache/xerces/internal/xni/XMLString;)V", nullptr, $PRIVATE, $method(static_cast<void(XIncludeHandler::*)($XMLString*)>(&XIncludeHandler::checkWhitespace))},
	...
	{"copyFeatures", "(Lcom/sun/org/apache/xerces/internal/xni/parser/XMLComponentManager;Lcom/sun/org/apache/xerces/internal/util/ParserConfigurationSettings;)V", nullptr, $PROTECTED},
	{"copyFeatures", "(Lcom/sun/org/apache/xerces/internal/xni/parser/XMLComponentManager;Lcom/sun/org/apache/xerces/internal/xni/parser/XMLParserConfiguration;)V", nullptr, $PROTECTED},
	{"copyFeatures1", "(Ljava/util/Enumeration;Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/xni/parser/XMLComponentManager;Lcom/sun/org/apache/xerces/internal/util/ParserConfigurationSettings;)V", "(Ljava/util/Enumeration<Ljava/lang/Object;>;Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/xni/parser/XMLComponentManager;Lcom/sun/org/apache/xerces/internal/util/ParserConfigurationSettings;)V", $PRIVATE, $method(static_cast<void(XIncludeHandler::*)($Enumeration*,$String*,$XMLComponentManager*,$ParserConfigurationSettings*)>(&XIncludeHandler::copyFeatures1))},
	{"copyFeatures1", "(Ljava/util/Enumeration;Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/xni/parser/XMLComponentManager;Lcom/sun/org/apache/xerces/internal/xni/parser/XMLParserConfiguration;)V", "(Ljava/util/Enumeration<Ljava/lang/Object;>;Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/xni/parser/XMLComponentManager;Lcom/sun/org/apache/xerces/internal/xni/parser/XMLParserConfiguration;)V", $PRIVATE, $method(static_cast<void(XIncludeHandler::*)($Enumeration*,$String*,$XMLComponentManager*,$XMLParserConfiguration*)>(&XIncludeHandler::copyFeatures1))},
	{"createInputSource", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcom/sun/org/apache/xerces/internal/xni/parser/XMLInputSource;", nullptr, $PRIVATE, $method(static_cast<$XMLInputSource*(XIncludeHandler::*)($String*,$String*,$String*,$String*,$String*)>(&XIncludeHandler::createInputSource))},
	...
	{"escapeHref", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(XIncludeHandler::*)($String*)>(&XIncludeHandler::escapeHref))},
	...
	{"getBaseURI", "(I)Ljava/lang/String;", nullptr, $PUBLIC},
	...
	{"getIncludeParentBaseURI", "()Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(XIncludeHandler::*)()>(&XIncludeHandler::getIncludeParentBaseURI))},
	{"getIncludeParentDepth", "()I", nullptr, $PRIVATE, $method(static_cast<int32_t(XIncludeHandler::*)()>(&XIncludeHandler::getIncludeParentDepth))},
	{"getIncludeParentLanguage", "()Ljava/lang/String;", nullptr, $PRIVATE, $method(static_cast<$String*(XIncludeHandler::*)()>(&XIncludeHandler::getIncludeParentLanguage))},
	...
	{"getRelativeBaseURI", "()Ljava/lang/String;", nullptr, $PROTECTED, nullptr, "com.sun.org.apache.xerces.internal.util.URI$MalformedURIException"},
	{"getRelativeURI", "(I)Ljava/lang/String;", nullptr, $PUBLIC, nullptr, "com.sun.org.apache.xerces.internal.util.URI$MalformedURIException"},
	{"getResultDepth", "()I", nullptr, $PRIVATE, $method(static_cast<int32_t(XIncludeHandler::*)()>(&XIncludeHandler::getResultDepth))},
	{"getRootElementProcessed", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(XIncludeHandler::*)()>(&XIncludeHandler::getRootElementProcessed))},
	{"getSawFallback", "(I)Z", nullptr, $PROTECTED},
	{"getSawInclude", "(I)Z", nullptr, $PROTECTED},
	{"getState", "(I)I", nullptr, $PROTECTED},
	{"getState", "()I", nullptr, $PROTECTED},
	{"handleFallbackElement", "()V", nullptr, $PROTECTED},
	{"handleIncludeElement", "(Lcom/sun/org/apache/xerces/internal/xni/XMLAttributes;)Z", nullptr, $PROTECTED, nullptr, "com.sun.org.apache.xerces.internal.xni.XNIException"},
	{"hasXIncludeNamespace", "(Lcom/sun/org/apache/xerces/internal/xni/QName;)Z", nullptr, $PROTECTED},
	...
	{"isFallbackElement", "(Lcom/sun/org/apache/xerces/internal/xni/QName;)Z", nullptr, $PROTECTED},
	{"isIncludeElement", "(Lcom/sun/org/apache/xerces/internal/xni/QName;)Z", nullptr, $PROTECTED},
	{"isRootDocument", "()Z", nullptr, $PROTECTED},
	{"isTopLevelIncludedItem", "()Z", nullptr, $PROTECTED},
	{"isTopLevelIncludedItemViaFallback", "()Z", nullptr, $PROTECTED},
	{"isTopLevelIncludedItemViaInclude", "()Z", nullptr, $PROTECTED},
	{"isValidInHTTPHeader", "(Ljava/lang/String;)Z", nullptr, $PRIVATE, $method(static_cast<bool(XIncludeHandler::*)($String*)>(&XIncludeHandler::isValidInHTTPHeader))},
	{"modifyAugmentations", "(Lcom/sun/org/apache/xerces/internal/xni/Augmentations;)Lcom/sun/org/apache/xerces/internal/xni/Augmentations;", nullptr, $PROTECTED},
	{"modifyAugmentations", "(Lcom/sun/org/apache/xerces/internal/xni/Augmentations;Z)Lcom/sun/org/apache/xerces/internal/xni/Augmentations;", nullptr, $PROTECTED},
	...
	{"processAttributes", "(Lcom/sun/org/apache/xerces/internal/xni/XMLAttributes;)Lcom/sun/org/apache/xerces/internal/xni/XMLAttributes;", nullptr, $PROTECTED},
	{"processXMLBaseAttributes", "(Lcom/sun/org/apache/xerces/internal/xni/XMLAttributes;)V", nullptr, $PROTECTED},
	{"processXMLLangAttributes", "(Lcom/sun/org/apache/xerces/internal/xni/XMLAttributes;)V", nullptr, $PROTECTED},
	...
	{"reportError", "(Ljava/lang/String;[Ljava/lang/Object;SLjava/lang/Exception;)V", nullptr, $PRIVATE, $method(static_cast<void(XIncludeHandler::*)($String*,$ObjectArray*,int16_t,$Exception*)>(&XIncludeHandler::reportError))},
	{"reportFatalError", "(Ljava/lang/String;)V", nullptr, $PROTECTED},
	{"reportFatalError", "(Ljava/lang/String;[Ljava/lang/Object;)V", nullptr, $PROTECTED},
	{"reportFatalError", "(Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/Exception;)V", nullptr, $PROTECTED},
	{"reportResourceError", "(Ljava/lang/String;)V", nullptr, $PROTECTED},
	{"reportResourceError", "(Ljava/lang/String;[Ljava/lang/Object;)V", nullptr, $PROTECTED},
	{"reportResourceError", "(Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/Exception;)V", nullptr, $PROTECTED},
	...
	{"restoreBaseURI", "()V", nullptr, $PROTECTED},
	{"restoreLanguage", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"sameBaseURIAsIncludeParent", "()Z", nullptr, $PROTECTED},
	{"sameLanguageAsIncludeParent", "()Z", nullptr, $PROTECTED},
	{"saveBaseURI", "()V", nullptr, $PROTECTED},
	{"saveLanguage", "(Ljava/lang/String;)V", nullptr, $PROTECTED},
	{"scopeOfBaseURI", "(I)I", nullptr, $PRIVATE, $method(static_cast<int32_t(XIncludeHandler::*)(int32_t)>(&XIncludeHandler::scopeOfBaseURI))},
	{"scopeOfLanguage", "(I)I", nullptr, $PRIVATE, $method(static_cast<int32_t(XIncludeHandler::*)(int32_t)>(&XIncludeHandler::scopeOfLanguage))},
	{"searchForRecursiveIncludes", "(Ljava/lang/String;)Z", nullptr, $PROTECTED},
	...
	{"setErrorReporter", "(Lcom/sun/org/apache/xerces/internal/impl/XMLErrorReporter;)V", nullptr, $PRIVATE, $method(static_cast<void(XIncludeHandler::*)($XMLErrorReporter*)>(&XIncludeHandler::setErrorReporter))},
	...
	{"setHref", "(Ljava/lang/String;)V", nullptr, $PROTECTED},
	{"setParent", "(Lcom/sun/org/apache/xerces/internal/xinclude/XIncludeHandler;)V", nullptr, $PROTECTED},
	...
	{"setRootElementProcessed", "(Z)V", nullptr, $PRIVATE, $method(static_cast<void(XIncludeHandler::*)(bool)>(&XIncludeHandler::setRootElementProcessed))},
	{"setSawFallback", "(IZ)V", nullptr, $PROTECTED},
	{"setSawInclude", "(IZ)V", nullptr, $PROTECTED},
	{"setState", "(I)V", nullptr, $PROTECTED},
	{"setXIncludeLocator", "(Lcom/sun/org/apache/xerces/internal/util/XMLLocatorWrapper;)V", nullptr, $PROTECTED},
	{"setupCurrentBaseURI", "(Lcom/sun/org/apache/xerces/internal/xni/XMLLocator;)V", nullptr, $PRIVATE, $method(static_cast<void(XIncludeHandler::*)($XMLLocator*)>(&XIncludeHandler::setupCurrentBaseURI))},
