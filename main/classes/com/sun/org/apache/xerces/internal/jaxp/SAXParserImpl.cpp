...
$MethodInfo _SAXParserImpl_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/jaxp/SAXParserFactoryImpl;Ljava/util/Map;)V", "(Lcom/sun/org/apache/xerces/internal/jaxp/SAXParserFactoryImpl;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Boolean;>;)V", 0, $method(static_cast<void(SAXParserImpl::*)($SAXParserFactoryImpl*,$Map*)>(&SAXParserImpl::init$)), "org.xml.sax.SAXException"},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/jaxp/SAXParserFactoryImpl;Ljava/util/Map;Z)V", "(Lcom/sun/org/apache/xerces/internal/jaxp/SAXParserFactoryImpl;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Boolean;>;Z)V", 0, $method(static_cast<void(SAXParserImpl::*)($SAXParserFactoryImpl*,$Map*,bool)>(&SAXParserImpl::init$)), "org.xml.sax.SAXException"},
	...
	{"getParser", "()Lorg/xml/sax/Parser;", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException"},
	...
	{"parse", "(Lorg/xml/sax/InputSource;Lorg/xml/sax/helpers/DefaultHandler;)V", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException,java.io.IOException"},
	{"parse", "(Lorg/xml/sax/InputSource;Lorg/xml/sax/HandlerBase;)V", nullptr, $PUBLIC, nullptr, "org.xml.sax.SAXException,java.io.IOException"},
	{"reset", "()V", nullptr, $PUBLIC},
	{"setFeatures", "(Ljava/util/Map;)V", "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/Boolean;>;)V", $PRIVATE, $method(static_cast<void(SAXParserImpl::*)($Map*)>(&SAXParserImpl::setFeatures)), "org.xml.sax.SAXNotSupportedException,org.xml.sax.SAXNotRecognizedException"},
