...
$MethodInfo _SAXParserImpl$JAXPSAXParser_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(SAXParserImpl$JAXPSAXParser::*)()>(&SAXParserImpl$JAXPSAXParser::init$))},
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/jaxp/SAXParserImpl;Lcom/sun/org/apache/xerces/internal/utils/XMLSecurityPropertyManager;Lcom/sun/org/apache/xerces/internal/utils/XMLSecurityManager;)V", nullptr, 0, $method(static_cast<void(SAXParserImpl$JAXPSAXParser::*)($SAXParserImpl*,$XMLSecurityPropertyManager*,$XMLSecurityManager*)>(&SAXParserImpl$JAXPSAXParser::init$))},
	{"getFeature", "(Ljava/lang/String;)Z", nullptr, $PUBLIC | $SYNCHRONIZED, nullptr, "org.xml.sax.SAXNotRecognizedException,org.xml.sax.SAXNotSupportedException"},
	{"getFeature0", "(Ljava/lang/String;)Z", nullptr, 0, nullptr, "org.xml.sax.SAXNotRecognizedException,org.xml.sax.SAXNotSupportedException"},
	{"getLocale", "()Ljava/util/Locale;", nullptr, 0},
	{"getProperty", "(Ljava/lang/String;)Ljava/lang/Object;", nullptr, $PUBLIC | $SYNCHRONIZED, nullptr, "org.xml.sax.SAXNotRecognizedException,org.xml.sax.SAXNotSupportedException"},
	{"getProperty0", "(Ljava/lang/String;)Ljava/lang/Object;", nullptr, 0, nullptr, "org.xml.sax.SAXNotRecognizedException,org.xml.sax.SAXNotSupportedException"},
	{"getXMLParserConfiguration", "()Lcom/sun/org/apache/xerces/internal/xni/parser/XMLParserConfiguration;", nullptr, 0},
	...
	{"resetSchemaValidator", "()V", nullptr, $PRIVATE, $method(static_cast<void(SAXParserImpl$JAXPSAXParser::*)()>(&SAXParserImpl$JAXPSAXParser::resetSchemaValidator)), "org.xml.sax.SAXException"},
	{"restoreInitState", "()V", nullptr, $SYNCHRONIZED, nullptr, "org.xml.sax.SAXNotRecognizedException,org.xml.sax.SAXNotSupportedException"},
	{"setFeature", "(Ljava/lang/String;Z)V", nullptr, $PUBLIC | $SYNCHRONIZED, nullptr, "org.xml.sax.SAXNotRecognizedException,org.xml.sax.SAXNotSupportedException"},
	{"setFeature0", "(Ljava/lang/String;Z)V", nullptr, 0, nullptr, "org.xml.sax.SAXNotRecognizedException,org.xml.sax.SAXNotSupportedException"},
	{"setProperty", "(Ljava/lang/String;Ljava/lang/Object;)V", nullptr, $PUBLIC | $SYNCHRONIZED, nullptr, "org.xml.sax.SAXNotRecognizedException,org.xml.sax.SAXNotSupportedException"},
	{"setProperty0", "(Ljava/lang/String;Ljava/lang/Object;)V", nullptr, 0, nullptr, "org.xml.sax.SAXNotRecognizedException,org.xml.sax.SAXNotSupportedException"},
	{"setSchemaValidatorFeature", "(Ljava/lang/String;Z)V", nullptr, $PRIVATE, $method(static_cast<void(SAXParserImpl$JAXPSAXParser::*)($String*,bool)>(&SAXParserImpl$JAXPSAXParser::setSchemaValidatorFeature)), "org.xml.sax.SAXNotRecognizedException,org.xml.sax.SAXNotSupportedException"},
	{"setSchemaValidatorProperty", "(Ljava/lang/String;Ljava/lang/Object;)V", nullptr, $PRIVATE, $method(static_cast<void(SAXParserImpl$JAXPSAXParser::*)($String*,Object$*)>(&SAXParserImpl$JAXPSAXParser::setSchemaValidatorProperty)), "org.xml.sax.SAXNotRecognizedException,org.xml.sax.SAXNotSupportedException"},
	{}
};
