...
$MethodInfo _DocumentFragmentImpl_MethodInfo_[] = {
	...
	{"<init>", "(Lcom/sun/org/apache/xerces/internal/dom/CoreDocumentImpl;)V", nullptr, $PUBLIC, $method(static_cast<void(DocumentFragmentImpl::*)($CoreDocumentImpl*)>(&DocumentFragmentImpl::init$))},
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(DocumentFragmentImpl::*)()>(&DocumentFragmentImpl::init$))},
