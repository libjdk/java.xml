...
$MethodInfo _XSObjectListImpl_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(XSObjectListImpl::*)()>(&XSObjectListImpl::init$))},
	{"<init>", "([Lcom/sun/org/apache/xerces/internal/xs/XSObject;I)V", nullptr, $PUBLIC, $method(static_cast<void(XSObjectListImpl::*)($XSObjectArray*,int32_t)>(&XSObjectListImpl::init$))},
	{"addXSObject", "(Lcom/sun/org/apache/xerces/internal/xs/XSObject;)V", nullptr, $PUBLIC},
	{"addXSObject", "(ILcom/sun/org/apache/xerces/internal/xs/XSObject;)V", nullptr, $PUBLIC},
	{"clearXSObjectList", "()V", nullptr, $PUBLIC},
	{"contains", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC},
	{"containsNull", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(XSObjectListImpl::*)()>(&XSObjectListImpl::containsNull))},
	{"containsObject", "(Ljava/lang/Object;)Z", nullptr, $PRIVATE, $method(static_cast<bool(XSObjectListImpl::*)(Object$*)>(&XSObjectListImpl::containsObject))},
	{"get", "(I)Lcom/sun/org/apache/xerces/internal/xs/XSObject;", nullptr, $PUBLIC},
	{"getLength", "()I", nullptr, $PUBLIC},
	{"*isEmpty", "()Z", nullptr, $PUBLIC},
	{"item", "(I)Lcom/sun/org/apache/xerces/internal/xs/XSObject;", nullptr, $PUBLIC},
	{"iterator", "()Ljava/util/Iterator;", "()Ljava/util/Iterator<Lcom/sun/org/apache/xerces/internal/xs/XSObject;>;", $PUBLIC},
	{"*lastIndexOf", "(Ljava/lang/Object;)I", nullptr, $PUBLIC},
	{"listIterator", "()Ljava/util/ListIterator;", "()Ljava/util/ListIterator<Lcom/sun/org/apache/xerces/internal/xs/XSObject;>;", $PUBLIC},
	{"listIterator", "(I)Ljava/util/ListIterator;", "(I)Ljava/util/ListIterator<Lcom/sun/org/apache/xerces/internal/xs/XSObject;>;", $PUBLIC},
	{"listIterator0", "(I)Ljava/util/ListIterator;", "(I)Ljava/util/ListIterator<Lcom/sun/org/apache/xerces/internal/xs/XSObject;>;", $PRIVATE, $method(static_cast<$ListIterator*(XSObjectListImpl::*)(int32_t)>(&XSObjectListImpl::listIterator0))},
	...
	{"toArray0", "([Ljava/lang/Object;)V", nullptr, $PRIVATE, $method(static_cast<void(XSObjectListImpl::*)($ObjectArray*)>(&XSObjectListImpl::toArray0))},
