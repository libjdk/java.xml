...
$MethodInfo _DOMNormalizer_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(DOMNormalizer::*)()>(&DOMNormalizer::init$))},
	{"addNamespaceDecl", "(Ljava/lang/String;Ljava/lang/String;Lcom/sun/org/apache/xerces/internal/dom/ElementImpl;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(DOMNormalizer::*)($String*,$String*,$ElementImpl*)>(&DOMNormalizer::addNamespaceDecl))},
	...
	{"expandEntityRef", "(Lorg/w3c/dom/Node;Lorg/w3c/dom/Node;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(DOMNormalizer::*)($Node*,$Node*)>(&DOMNormalizer::expandEntityRef))},
	...
	{"isAttrValueWF", "(Lorg/w3c/dom/DOMErrorHandler;Lcom/sun/org/apache/xerces/internal/dom/DOMErrorImpl;Lcom/sun/org/apache/xerces/internal/dom/DOMLocatorImpl;Lorg/w3c/dom/NamedNodeMap;Lorg/w3c/dom/Attr;Ljava/lang/String;Z)V", nullptr, $PUBLIC | $STATIC | $FINAL, $method(static_cast<void(*)($DOMErrorHandler*,$DOMErrorImpl*,$DOMLocatorImpl*,$NamedNodeMap*,$Attr*,$String*,bool)>(&DOMNormalizer::isAttrValueWF))},
	{"isCDataWF", "(Lorg/w3c/dom/DOMErrorHandler;Lcom/sun/org/apache/xerces/internal/dom/DOMErrorImpl;Lcom/sun/org/apache/xerces/internal/dom/DOMLocatorImpl;Ljava/lang/String;Z)V", nullptr, $PUBLIC | $STATIC | $FINAL, $method(static_cast<void(*)($DOMErrorHandler*,$DOMErrorImpl*,$DOMLocatorImpl*,$String*,bool)>(&DOMNormalizer::isCDataWF))},
	{"isCommentWF", "(Lorg/w3c/dom/DOMErrorHandler;Lcom/sun/org/apache/xerces/internal/dom/DOMErrorImpl;Lcom/sun/org/apache/xerces/internal/dom/DOMLocatorImpl;Ljava/lang/String;Z)V", nullptr, $PUBLIC | $STATIC | $FINAL, $method(static_cast<void(*)($DOMErrorHandler*,$DOMErrorImpl*,$DOMLocatorImpl*,$String*,bool)>(&DOMNormalizer::isCommentWF))},
	{"isXMLCharWF", "(Lorg/w3c/dom/DOMErrorHandler;Lcom/sun/org/apache/xerces/internal/dom/DOMErrorImpl;Lcom/sun/org/apache/xerces/internal/dom/DOMLocatorImpl;Ljava/lang/String;Z)V", nullptr, $PUBLIC | $STATIC | $FINAL, $method(static_cast<void(*)($DOMErrorHandler*,$DOMErrorImpl*,$DOMLocatorImpl*,$String*,bool)>(&DOMNormalizer::isXMLCharWF))},
	{"namespaceFixUp", "(Lcom/sun/org/apache/xerces/internal/dom/ElementImpl;Lcom/sun/org/apache/xerces/internal/dom/AttributeMap;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(DOMNormalizer::*)($ElementImpl*,$AttributeMap*)>(&DOMNormalizer::namespaceFixUp))},
	{"normalizeAttributeValue", "(Ljava/lang/String;Lorg/w3c/dom/Attr;)Ljava/lang/String;", nullptr, $FINAL, $method(static_cast<$String*(DOMNormalizer::*)($String*,$Attr*)>(&DOMNormalizer::normalizeAttributeValue))},
	{"normalizeDocument", "(Lcom/sun/org/apache/xerces/internal/dom/CoreDocumentImpl;Lcom/sun/org/apache/xerces/internal/dom/DOMConfigurationImpl;)V", nullptr, $PROTECTED},
	{"normalizeNode", "(Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;", nullptr, $PROTECTED},
	{"processDTD", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PRIVATE, $method(static_cast<void(DOMNormalizer::*)($String*,$String*)>(&DOMNormalizer::processDTD))},
	...
	{"updateQName", "(Lorg/w3c/dom/Node;Lcom/sun/org/apache/xerces/internal/xni/QName;)V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(DOMNormalizer::*)($Node*,$QName*)>(&DOMNormalizer::updateQName))},
