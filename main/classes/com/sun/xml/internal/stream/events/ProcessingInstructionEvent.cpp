...
$MethodInfo _ProcessingInstructionEvent_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(ProcessingInstructionEvent::*)()>(&ProcessingInstructionEvent::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(ProcessingInstructionEvent::*)($String*,$String*)>(&ProcessingInstructionEvent::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/String;Ljavax/xml/stream/Location;)V", nullptr, $PUBLIC, $method(static_cast<void(ProcessingInstructionEvent::*)($String*,$String*,$Location*)>(&ProcessingInstructionEvent::init$))},
