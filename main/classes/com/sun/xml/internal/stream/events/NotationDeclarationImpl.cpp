...
$MethodInfo _NotationDeclarationImpl_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(NotationDeclarationImpl::*)()>(&NotationDeclarationImpl::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(NotationDeclarationImpl::*)($String*,$String*,$String*)>(&NotationDeclarationImpl::init$))},
	{"<init>", "(Lcom/sun/xml/internal/stream/dtd/nonvalidating/XMLNotationDecl;)V", nullptr, $PUBLIC, $method(static_cast<void(NotationDeclarationImpl::*)($XMLNotationDecl*)>(&NotationDeclarationImpl::init$))},
	...
	{"setPublicId", "(Ljava/lang/String;)V", nullptr, 0},
	{"setSystemId", "(Ljava/lang/String;)V", nullptr, 0},
