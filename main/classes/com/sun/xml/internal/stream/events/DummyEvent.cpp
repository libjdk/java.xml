...
$MethodInfo _DummyEvent_MethodInfo_[] = {
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(DummyEvent::*)()>(&DummyEvent::init$))},
	{"<init>", "(I)V", nullptr, $PUBLIC, $method(static_cast<void(DummyEvent::*)(int32_t)>(&DummyEvent::init$))},
	...
	{"charEncode", "(Ljava/io/Writer;Ljava/lang/String;)V", nullptr, $PROTECTED, nullptr, "java.io.IOException"},
	...
	{"isCharacterData", "()Z", nullptr, $PUBLIC},
	...
	{"setEventType", "(I)V", nullptr, $PROTECTED},
	{"setLocation", "(Ljavax/xml/stream/Location;)V", nullptr, 0},
	{"writeAsEncodedUnicode", "(Ljava/io/Writer;)V", nullptr, $PUBLIC, nullptr, "javax.xml.stream.XMLStreamException"},
	{"writeAsEncodedUnicodeEx", "(Ljava/io/Writer;)V", nullptr, $PROTECTED | $ABSTRACT, nullptr, "java.io.IOException,javax.xml.stream.XMLStreamException"},
	{}
};
