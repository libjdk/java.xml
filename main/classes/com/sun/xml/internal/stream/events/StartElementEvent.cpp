...
$MethodInfo _StartElementEvent_MethodInfo_[] = {
	...
	{"<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(StartElementEvent::*)($String*,$String*,$String*)>(&StartElementEvent::init$))},
	{"<init>", "(Ljavax/xml/namespace/QName;)V", nullptr, $PUBLIC, $method(static_cast<void(StartElementEvent::*)($QName*)>(&StartElementEvent::init$))},
	{"<init>", "(Ljavax/xml/stream/events/StartElement;)V", nullptr, $PUBLIC, $method(static_cast<void(StartElementEvent::*)($StartElement*)>(&StartElementEvent::init$))},
	{"addAttribute", "(Ljavax/xml/stream/events/Attribute;)V", nullptr, 0},
	{"addAttributes", "(Ljava/util/Iterator;)V", "(Ljava/util/Iterator<+Ljavax/xml/stream/events/Attribute;>;)V", $FINAL, $method(static_cast<void(StartElementEvent::*)($Iterator*)>(&StartElementEvent::addAttributes))},
	{"addNamespaceAttribute", "(Ljavax/xml/stream/events/Namespace;)V", nullptr, 0},
	{"addNamespaceAttributes", "(Ljava/util/Iterator;)V", "(Ljava/util/Iterator<+Ljavax/xml/stream/events/Namespace;>;)V", $FINAL, $method(static_cast<void(StartElementEvent::*)($Iterator*)>(&StartElementEvent::addNamespaceAttributes))},
	{"getAttributeByName", "(Ljavax/xml/namespace/QName;)Ljavax/xml/stream/events/Attribute;", nullptr, $PUBLIC},
	{"getAttributes", "()Ljava/util/Iterator;", "()Ljava/util/Iterator<Ljavax/xml/stream/events/Attribute;>;", $PUBLIC},
	...
	{"getNamespaces", "()Ljava/util/Iterator;", "()Ljava/util/Iterator<Ljavax/xml/stream/events/Namespace;>;", $PUBLIC},
	{"init", "()V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(StartElementEvent::*)()>(&StartElementEvent::init))},
