...
$MethodInfo _AttributeImpl_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(AttributeImpl::*)()>(&AttributeImpl::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(AttributeImpl::*)($String*,$String*)>(&AttributeImpl::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(AttributeImpl::*)($String*,$String*,$String*)>(&AttributeImpl::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(AttributeImpl::*)($String*,$String*,$String*,$String*,$String*)>(&AttributeImpl::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V", nullptr, $PUBLIC, $method(static_cast<void(AttributeImpl::*)($String*,$String*,$String*,$String*,$String*,$String*,bool)>(&AttributeImpl::init$))},
	{"<init>", "(Ljavax/xml/namespace/QName;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V", nullptr, $PUBLIC, $method(static_cast<void(AttributeImpl::*)($QName*,$String*,$String*,$String*,bool)>(&AttributeImpl::init$))},
	{"getDTDType", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getName", "()Ljavax/xml/namespace/QName;", nullptr, $PUBLIC},
	{"getNonNormalizedValue", "()Ljava/lang/String;", nullptr, $PUBLIC},
	...
	{"setAttributeType", "(Ljava/lang/String;)V", nullptr, $PUBLIC},
	{"setName", "(Ljavax/xml/namespace/QName;)V", nullptr, $PUBLIC},
	{"setNonNormalizedValue", "(Ljava/lang/String;)V", nullptr, $PUBLIC},
