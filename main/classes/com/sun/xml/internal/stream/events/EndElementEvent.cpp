...
$MethodInfo _EndElementEvent_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(EndElementEvent::*)()>(&EndElementEvent::init$))},
	{"<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(EndElementEvent::*)($String*,$String*,$String*)>(&EndElementEvent::init$))},
	{"<init>", "(Ljavax/xml/namespace/QName;)V", nullptr, $PUBLIC, $method(static_cast<void(EndElementEvent::*)($QName*)>(&EndElementEvent::init$))},
	{"addNamespace", "(Ljavax/xml/stream/events/Namespace;)V", nullptr, 0},
	...
	{"init", "()V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(EndElementEvent::*)()>(&EndElementEvent::init))},
