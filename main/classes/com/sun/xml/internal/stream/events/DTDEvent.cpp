...
$MethodInfo _DTDEvent_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(DTDEvent::*)()>(&DTDEvent::init$))},
	{"<init>", "(Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(DTDEvent::*)($String*)>(&DTDEvent::init$))},
	{"getDocumentTypeDeclaration", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"getEntities", "()Ljava/util/List;", "()Ljava/util/List<Ljavax/xml/stream/events/EntityDeclaration;>;", $PUBLIC},
	{"getNotations", "()Ljava/util/List;", "()Ljava/util/List<Ljavax/xml/stream/events/NotationDeclaration;>;", $PUBLIC},
	{"getProcessedDTD", "()Ljava/lang/Object;", nullptr, $PUBLIC},
	{"init", "()V", nullptr, $PROTECTED | $FINAL, $method(static_cast<void(DTDEvent::*)()>(&DTDEvent::init))},
	...
	{"setDocumentTypeDeclaration", "(Ljava/lang/String;)V", nullptr, $PUBLIC},
	{"setEntities", "(Ljava/util/List;)V", "(Ljava/util/List<Ljavax/xml/stream/events/EntityDeclaration;>;)V", $PUBLIC},
	{"setNotations", "(Ljava/util/List;)V", "(Ljava/util/List<Ljavax/xml/stream/events/NotationDeclaration;>;)V", $PUBLIC},
