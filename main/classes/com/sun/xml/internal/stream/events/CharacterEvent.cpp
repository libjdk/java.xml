...
$MethodInfo _CharacterEvent_MethodInfo_[] = {
	...
	{"<init>", "()V", nullptr, $PUBLIC, $method(static_cast<void(CharacterEvent::*)()>(&CharacterEvent::init$))},
	{"<init>", "(Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(CharacterEvent::*)($String*)>(&CharacterEvent::init$))},
	{"<init>", "(Ljava/lang/String;Z)V", nullptr, $PUBLIC, $method(static_cast<void(CharacterEvent::*)($String*,bool)>(&CharacterEvent::init$))},
	{"<init>", "(Ljava/lang/String;ZZ)V", nullptr, $PUBLIC, $method(static_cast<void(CharacterEvent::*)($String*,bool,bool)>(&CharacterEvent::init$))},
	{"checkWhiteSpace", "()V", nullptr, $PRIVATE, $method(static_cast<void(CharacterEvent::*)()>(&CharacterEvent::checkWhiteSpace))},
	{"getData", "()Ljava/lang/String;", nullptr, $PUBLIC},
	{"init", "()V", nullptr, $PROTECTED},
	{"*isAttribute", "()Z", nullptr, $PUBLIC},
	{"isCData", "()Z", nullptr, $PUBLIC},
