...
$MethodInfo FactoryFinder$$Lambda$lambda$find$4$4::methodInfos[3] = {
	{"<init>", "(Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(FactoryFinder$$Lambda$lambda$find$4$4::*)($String*)>(&FactoryFinder$$Lambda$lambda$find$4$4::init$))},
	{"get", "()Ljava/lang/Object;", nullptr, $PUBLIC},
	{}
};
...
$MethodInfo FactoryFinder$$Lambda$lambda$find$5$5::methodInfos[3] = {
	{"<init>", "(Ljava/lang/String;)V", nullptr, $PUBLIC, $method(static_cast<void(FactoryFinder$$Lambda$lambda$find$5$5::*)($String*)>(&FactoryFinder$$Lambda$lambda$find$5$5::init$))},
	{"get", "()Ljava/lang/Object;", nullptr, $PUBLIC},
	{}
};
...
$MethodInfo _FactoryFinder_MethodInfo_[] = {
	...
	{"find", "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;Ljava/lang/String;)TT;", $STATIC, $method(static_cast<$Object*(*)($Class*,$String*)>(&FactoryFinder::find)), "javax.xml.datatype.DatatypeConfigurationException"},
	{"findServiceProvider", "(Ljava/lang/Class;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;)TT;", $PRIVATE | $STATIC, $method(static_cast<$Object*(*)($Class*)>(&FactoryFinder::findServiceProvider)), "javax.xml.datatype.DatatypeConfigurationException"},
	...
	{"lambda$find$4", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<$String*(*)($String*)>(&FactoryFinder::lambda$find$4))},
	{"lambda$find$5", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC | $SYNTHETIC, $method(static_cast<$String*(*)($String*)>(&FactoryFinder::lambda$find$5))},
	...
	{"newInstance", "(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/ClassLoader;Z)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;Ljava/lang/String;Ljava/lang/ClassLoader;Z)TT;", $STATIC, $method(static_cast<$Object*(*)($Class*,$String*,$ClassLoader*,bool)>(&FactoryFinder::newInstance)), "javax.xml.datatype.DatatypeConfigurationException"},
	{"newInstance", "(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/ClassLoader;ZZ)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;Ljava/lang/String;Ljava/lang/ClassLoader;ZZ)TT;", $STATIC, $method(static_cast<$Object*(*)($Class*,$String*,$ClassLoader*,bool,bool)>(&FactoryFinder::newInstance)), "javax.xml.datatype.DatatypeConfigurationException"},
	{}
};
