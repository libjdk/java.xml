...
$MethodInfo _FactoryFinder_MethodInfo_[] = {
	...
	{"find", "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;Ljava/lang/String;)TT;", $STATIC, $method(static_cast<$Object*(*)($Class*,$String*)>(&FactoryFinder::find)), "javax.xml.transform.TransformerFactoryConfigurationError"},
	{"findServiceProvider", "(Ljava/lang/Class;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;)TT;", $PRIVATE | $STATIC, $method(static_cast<$Object*(*)($Class*)>(&FactoryFinder::findServiceProvider)), "javax.xml.transform.TransformerFactoryConfigurationError"},
	...
	{"newInstance", "(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/ClassLoader;Z)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;Ljava/lang/String;Ljava/lang/ClassLoader;Z)TT;", $STATIC, $method(static_cast<$Object*(*)($Class*,$String*,$ClassLoader*,bool)>(&FactoryFinder::newInstance)), "javax.xml.transform.TransformerFactoryConfigurationError"},
	{}
};
