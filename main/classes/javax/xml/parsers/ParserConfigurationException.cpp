...
ParserConfigurationException::ParserConfigurationException(const ParserConfigurationException& e) {
}

ParserConfigurationException ParserConfigurationException::wrapper$() {
	$pendingException(this);
	return *this;
}

void ParserConfigurationException::throwWrapper$() {
	$pendingException(this);
	throw *this;
}
